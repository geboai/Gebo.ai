...
wait_for 127.0.0.1 9200  120 OpenSearch || { echo "OpenSearch (http) not ready"; exit 1; }

exec java $JAVA_TOOL_OPTIONS -jar /opt/gebo.ai/gebo.ai.app-1.0.3.0-SNAPSHOT-bootable.jar