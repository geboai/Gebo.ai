...
package ai.gebo.ragsystem.content.fulltext.processor.config;
 ...
 */
@Configuration
@ConfigurationProperties(value = "ai.gebo.fulltext.config")
public class GeboFullTextProcessorConfig {
	 ...
	 */
	public GeboFullTextProcessorConfig() {
