 ...
 * 
 * Repository interface for managing OpenAI transcript model configurations in
...
public interface OpenAITranscriptModelConfigRepository extends IGBaseMongoDBRepository<GOpenAITranscriptModelConfig> {
	 ...
	 * 
	 * @return The GOpenAITranscriptModelConfig class type
	 */
	@Override
	default Class<GOpenAITranscriptModelConfig> getManagedType() {

		return GOpenAITranscriptModelConfig.class;
	}
}
