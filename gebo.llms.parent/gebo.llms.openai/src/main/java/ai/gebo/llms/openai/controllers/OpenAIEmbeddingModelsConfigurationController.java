...
@RequestMapping("api/admin/OpenAIEmbeddingModelsConfigurationController")
public class OpenAIEmbeddingModelsConfigurationController extends
	...
	public OperationStatus<GOpenAIEmbeddingModelConfig> insertOpenAIEmbeddingModelConfig(
			@RequestBody GOpenAIEmbeddingModelConfig config) {
	...
	public OperationStatus<Boolean> deleteOpenAIEmbeddingModelConfig(@RequestBody GOpenAIEmbeddingModelConfig config) {
