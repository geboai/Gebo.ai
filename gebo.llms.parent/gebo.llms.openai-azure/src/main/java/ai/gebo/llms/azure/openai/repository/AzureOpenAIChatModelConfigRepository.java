...
public interface AzureOpenAIChatModelConfigRepository extends IGBaseMongoDBRepository<GAzureOpenAIChatModelConfig> {
	/**
	 ...
	 */
	@Override
	default Class<GAzureOpenAIChatModelConfig> getManagedType() {
		
		return GAzureOpenAIChatModelConfig.class;
	}
}