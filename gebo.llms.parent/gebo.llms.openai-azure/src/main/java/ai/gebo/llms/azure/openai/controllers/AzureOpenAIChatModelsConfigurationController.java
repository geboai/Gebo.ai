...
public class AzureOpenAIChatModelsConfigurationController extends
	...
	public AzureOpenAIChatModelsConfigurationController(IGPersistentObjectManager persistentObjectManager,
			IGChatModelRuntimeConfigurationDao modelRuntimeConfigurationDao,
			AzureOpenAIChatModelConfigurationSupportService ifaceType) {
		super(persistentObjectManager, modelRuntimeConfigurationDao, GAzureOpenAIChatModelConfig.class, ifaceType);
	...
	public OperationStatus<List<GAzureOpenAIChatModelChoice>> getAzureOpenAIChatModels(
			@RequestBody GAzureOpenAIChatModelConfig config) {
