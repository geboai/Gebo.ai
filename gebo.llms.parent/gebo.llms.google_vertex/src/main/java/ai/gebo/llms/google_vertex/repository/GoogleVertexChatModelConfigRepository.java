...
public interface GoogleVertexChatModelConfigRepository extends IGBaseMongoDBRepository<GGoogleVertexChatModelConfig> {
	 ...
	 * This method is required by the IGBaseMongoDBRepository interface.
	 * 
	 * @return The GGoogleVertexChatModelConfig class
	 */
	@Override
	default Class<GGoogleVertexChatModelConfig> getManagedType() {
		
		return GGoogleVertexChatModelConfig.class;
	}
}