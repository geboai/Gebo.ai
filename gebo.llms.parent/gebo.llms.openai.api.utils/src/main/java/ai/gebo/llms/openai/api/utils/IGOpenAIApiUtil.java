 ...
 * 
 * Interface for OpenAI API utilities that provides methods to retrieve various
 * models from the OpenAI API. This includes raw model listings, chat models,
 * and embedding models with appropriate configurations.
 */
public interface IGOpenAIApiUtil {

	/**
	 * Retrieves a list of all available OpenAI models using the provided
	 * configuration.
	 * 
	 * @param config The OpenAI API configuration
	 * @return A list of OpenAI models
	 * @throws OpenAIApiException           If there's an error specific to the
	 *                                      OpenAI API
	 * @throws GeboRestIntegrationException If there's an error in the REST
	 *                                      integration layer
	 */
	public List<OpenAIModel> getModels(OpenAIApiConfig config) throws OpenAIApiException, GeboRestIntegrationException;

	/**
	 * Retrieves a list of chat models of the specified type using the provided
	 * configuration.
	 * 
	 ...
	 * @param defaultMetainfoFactory Function to create default model meta
	 *                               information
	...
	/**
	 * Retrieves a list of embedding models of the specified type using the provided
	 * configuration.
	 * 
	 * @param <EmbeddingModelChoiceType> The type of embedding model choice
	 * @param type                       The class of the embedding model choice
	 *                                   type
	 * @param config                     The OpenAI API configuration
	 ...
	 *                                   information
	 * @param modelType                  TODO
	 * @return An operation status containing a list of embedding models if
	 *         successful
	 */
