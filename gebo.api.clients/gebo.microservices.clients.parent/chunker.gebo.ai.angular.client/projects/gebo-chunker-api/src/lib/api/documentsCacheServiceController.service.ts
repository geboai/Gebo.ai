...
import { StreamDocumentRequest } from '../model/streamDocumentRequest';
...
@Injectable()
export class DocumentsCacheServiceControllerService {
    ...
    public streamDocument(body: StreamDocumentRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling streamDocument.');
        }
