...
@Injectable()
export class LlmsUsageUserLevelControllerService {
    ...
    public userDrillDown(body: LLMUsageDrillDownLevel, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<LLMUsageDrillDownResult>('post',`${this.basePath}/api/users/LLMSUsageUserLevelController/drillDown`,
            {
                body: body,
