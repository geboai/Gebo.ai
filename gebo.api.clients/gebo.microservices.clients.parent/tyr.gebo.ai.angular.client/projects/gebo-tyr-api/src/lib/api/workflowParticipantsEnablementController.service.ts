...
@Injectable()
export class WorkflowParticipantsEnablementControllerService {
    ...
    public enabledSteps(workflowType: any, workflowId: any, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (workflowId === null || workflowId === undefined) {
            throw new Error('Required parameter workflowId was null or undefined when calling enabledSteps.');
        }

        let queryParameters = new HttpParams({encoder: new CustomHttpUrlEncodingCodec()});
        if (workflowType !== undefined && workflowType !== null) {
            queryParameters = queryParameters.set('workflowType', <any>workflowType);
        }
