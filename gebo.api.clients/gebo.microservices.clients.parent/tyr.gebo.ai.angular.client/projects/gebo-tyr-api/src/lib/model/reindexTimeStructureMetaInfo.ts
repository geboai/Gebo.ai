...
export interface ReindexTimeStructureMetaInfo { 
    frequency?: ReindexTimeStructureMetaInfo.FrequencyEnum;
    periodComponents?: Array<ReindexTimeComponentMetaInfo>;
}
export namespace ReindexTimeStructureMetaInfo {
