...
public class ConfluenceBrowsingControllerApi {
    private ApiClient apiClient;
     ...
     public ConfluenceBrowsingControllerApi() {
        this(new ApiClient());
    }
    public ConfluenceBrowsingControllerApi(ApiClient apiClient) {
    ...
    public ResponseEntity<OperationStatusListPathInfo> browseConfluencePathWithHttpInfo(BrowseParam body, String systemCode) throws RestClientException {
        ...
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling browseConfluencePath");
        }
        // verify the required parameter 'systemCode' is set
        if (systemCode == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'systemCode' when calling browseConfluencePath");
        }
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/ConfluenceBrowsingController/browseConfluencePath").build().toUriString();
    ...
    public ResponseEntity<OperationStatusListVirtualFilesystemNavigationTreeStatus> getConfluenceNavigationStatusWithHttpInfo(List<VFilesystemReference> body, String systemCode) throws RestClientException {
        ...
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling getConfluenceNavigationStatus");
        }
        // verify the required parameter 'systemCode' is set
        if (systemCode == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'systemCode' when calling getConfluenceNavigationStatus");
        }
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/ConfluenceBrowsingController/getConfluenceNavigationStatus").build().toUriString();
    ...
    public ResponseEntity<OperationStatusListGVirtualFilesystemRoot> getConfluenceRootsWithHttpInfo(String systemCode) throws RestClientException {
        ...
        // verify the required parameter 'systemCode' is set
        if (systemCode == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'systemCode' when calling getConfluenceRoots");
        }
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/ConfluenceBrowsingController/getConfluenceRoots").build().toUriString();
