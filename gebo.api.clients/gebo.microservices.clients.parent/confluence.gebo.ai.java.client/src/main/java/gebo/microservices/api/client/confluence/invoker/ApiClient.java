package gebo.microservices.api.client.confluence.invoker;
...
import gebo.microservices.api.client.confluence.invoker.auth.Authentication;
import gebo.microservices.api.client.confluence.invoker.auth.HttpBasicAuth;
import gebo.microservices.api.client.confluence.invoker.auth.ApiKeyAuth;
import gebo.microservices.api.client.confluence.invoker.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "http://localhost:13010/confluence";
