...
import gebo.microservices.api.client.vectorizator.model.GeboMongoVectorStoreConfig;
import gebo.microservices.api.client.vectorizator.model.OperationStatusGeboMongoVectorStoreConfig;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2026-09-21T14:45:44.800638338+02:00[Europe/Rome]")
...
public class GeboVectorStoreConfigurationControllerApi {
    ...
    public ResponseEntity<GeboMongoVectorStoreConfig> getActualVectorStoreConfigurationWithHttpInfo() throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/GeboVectorStoreConfigurationController/getActualVectorStoreConfiguration").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGeboMongoVectorStoreConfig> vectorStoreConfigurationApplyAndSaveWithHttpInfo(GeboMongoVectorStoreConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/GeboVectorStoreConfigurationController/vectorStoreConfigurationApplyAndSave").build().toUriString();
