...
export const APIS = [ContentsResetControllerService, DocumentContentStreamerControllerService, GenericalPublisherControllerService, IngestionFileTypesLibraryControllerService, JobLauncherControllerService, JobStatusControllerService, SecretsControllerService, UserspaceControllerService, UserspaceUploadControllerService, WorkflowStatsAdminLevelControllerService];
