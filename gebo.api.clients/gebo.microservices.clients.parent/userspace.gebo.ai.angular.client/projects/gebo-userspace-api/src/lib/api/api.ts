...
export const APIS = [ContentsResetControllerService, DocumentContentStreamerControllerService, GenericalPublisherControllerService, IngestionFileTypesLibraryControllerService, JobLauncherControllerService, JobStatusControllerService, UserspaceControllerService, UserspaceUploadControllerService, WorkflowStatsAdminLevelControllerService];
