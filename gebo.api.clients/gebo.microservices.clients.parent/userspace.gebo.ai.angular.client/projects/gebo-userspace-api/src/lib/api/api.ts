...
export const APIS = [ContentsResetControllerService, DocumentContentStreamerControllerService, GeboAngularFormGroupMetaInfoControllerService, GenericalPublisherControllerService, InternalMessagingTopologyControllerService, JobLauncherControllerService, UserspaceControllerService, UserspaceUploadControllerService];
