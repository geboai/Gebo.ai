...
public class JiraSearchServiceControllerApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public SearchResultAnalisysOutcome restExtractRelatedAnalisysReferences(JiraResultsExtractionData body, Object systemId) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<SearchResultAnalisysOutcome> restExtractRelatedAnalisysReferencesWithHttpInfo(JiraResultsExtractionData body, Object systemId) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Object restNativeSearch(JiraIssuesSearchFilter body, Object systemId, Object nEntryLimit) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Object> restNativeSearchWithHttpInfo(JiraIssuesSearchFilter body, Object systemId, Object nEntryLimit) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
