...
@Injectable()
export class WebdavBrowsingControllerService {
    ...
    public browseWebdavPath(body: BrowseParam, systemCode: any, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (systemCode === null || systemCode === undefined) {
            throw new Error('Required parameter systemCode was null or undefined when calling browseWebdavPath.');
        }
        ...
        return this.httpClient.request<OperationStatusListPathInfo>('post',`${this.basePath}/api/admin/WebdavBrowsingController/browseWebdavPath`,
            {
                body: body,
    ...
    public getWebdavNavigationStatus(body: any, systemCode: any, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (systemCode === null || systemCode === undefined) {
            throw new Error('Required parameter systemCode was null or undefined when calling getWebdavNavigationStatus.');
        }
        ...
        return this.httpClient.request<OperationStatusListVirtualFilesystemNavigationTreeStatus>('post',`${this.basePath}/api/admin/WebdavBrowsingController/getWebdavNavigationStatus`,
            {
                body: body,
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
    ...
    public getWebdavRoots(systemCode: any, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<OperationStatusListGVirtualFilesystemRoot>('get',`${this.basePath}/api/admin/WebdavBrowsingController/getWebdavRoots`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
