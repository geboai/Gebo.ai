...
public class UiTextResourcesControllerApi {
    ...
    public ResponseEntity<File> getI18nWithHttpInfo() throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/public/UITextResourcesController").build().toUriString();
    ...
    public ResponseEntity<UiTextResourcesModule> getUiTextResourcesModuleWithHttpInfo() throws RestClientException {
        Object postBody = null;
        String localVarPath = UriComponentsBuilder.fromPath("/public/UITextResourcesController/getUiTextResourcesModule").build().toUriString();
    ...
    public ResponseEntity<Void> updateUIExistingTextsWithHttpInfo(List<UIExistingText> body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/public/UITextResourcesController/updateUIExistingTexts").build().toUriString();
