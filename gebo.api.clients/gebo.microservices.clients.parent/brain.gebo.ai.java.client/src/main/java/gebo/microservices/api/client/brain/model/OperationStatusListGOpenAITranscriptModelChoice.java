...
public class OperationStatusListGOpenAITranscriptModelChoice {
  @JsonProperty("result")
  private List<GOpenAITranscriptModelChoice> result = null;
  ...
  public OperationStatusListGOpenAITranscriptModelChoice addResultItem(GOpenAITranscriptModelChoice resultItem) {
    if (this.result == null) {
  ...
  **/
  @Schema(description = "")
  public List<GOpenAITranscriptModelChoice> getResult() {
    return result;
  }

  public void setResult(List<GOpenAITranscriptModelChoice> result) {
    this.result = result;
  }

  public OperationStatusListGOpenAITranscriptModelChoice messages(List<GUserMessage> messages) {
    this.messages = messages;
    return this;
  }

  public OperationStatusListGOpenAITranscriptModelChoice addMessagesItem(GUserMessage messagesItem) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class OperationStatusListGOpenAITranscriptModelChoice {\n");
