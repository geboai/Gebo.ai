...
import gebo.microservices.api.client.brain.model.GBedrockImageModelConfig;
import gebo.microservices.api.client.brain.model.OperationStatusBoolean;
import gebo.microservices.api.client.brain.model.OperationStatusGBedrockImageModelConfig;
import gebo.microservices.api.client.brain.model.OperationStatusListGBedrockImageModelChoice;
...
public class BedrockImageModelsConfigurationControllerApi {
    ...
    public ResponseEntity<OperationStatusBoolean> deleteBedrockImageModelConfigWithHttpInfo(GBedrockImageModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockImageModelsConfigurationController/deleteBedrockImageModelConfig").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GBedrockImageModelConfig findBedrockImageModelConfigByCode(Object code) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GBedrockImageModelConfig> findBedrockImageModelConfigByCodeWithHttpInfo(Object code) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockImageModelsConfigurationController/findBedrockImageModelConfigByCode").build().toUriString();
    ...
    public ResponseEntity<OperationStatusListGBedrockImageModelChoice> getBedrockImageModelsWithHttpInfo(GBedrockImageModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockImageModelsConfigurationController/getBedrockImageModels").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGBedrockImageModelConfig> insertBedrockImageModelConfigWithHttpInfo(GBedrockImageModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockImageModelsConfigurationController/insertBedrockImageModelConfig").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGBedrockImageModelConfig> updateBedrockImageModelConfigWithHttpInfo(GBedrockImageModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockImageModelsConfigurationController/updateBedrockImageModelConfig").build().toUriString();
