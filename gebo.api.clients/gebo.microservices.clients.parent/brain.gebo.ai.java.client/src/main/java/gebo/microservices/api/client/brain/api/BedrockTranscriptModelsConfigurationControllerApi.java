...
public class BedrockTranscriptModelsConfigurationControllerApi {
    ...
    public ResponseEntity<OperationStatusBoolean> deleteBedrockTranscriptModelConfigWithHttpInfo(GBedrockTranscriptModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockTranscriptModelsConfigurationController/deleteBedrockTranscriptModelConfig").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GBedrockTranscriptModelConfig findBedrockTranscriptModelConfigByCode(Object code) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GBedrockTranscriptModelConfig> findBedrockTranscriptModelConfigByCodeWithHttpInfo(Object code) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockTranscriptModelsConfigurationController/findBedrockTranscriptModelConfigByCode").build().toUriString();
    ...
    public ResponseEntity<OperationStatusListGBedrockTranscriptModelChoice> getBedrockTranscriptModelsWithHttpInfo(GBedrockTranscriptModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockTranscriptModelsConfigurationController/getBedrockTranscriptModels").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGBedrockTranscriptModelConfig> insertBedrockTranscriptModelConfigWithHttpInfo(GBedrockTranscriptModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockTranscriptModelsConfigurationController/insertBedrockTranscriptModelConfig").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGBedrockTranscriptModelConfig> updateBedrockTranscriptModelConfigWithHttpInfo(GBedrockTranscriptModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockTranscriptModelsConfigurationController/updateBedrockTranscriptModelConfig").build().toUriString();
