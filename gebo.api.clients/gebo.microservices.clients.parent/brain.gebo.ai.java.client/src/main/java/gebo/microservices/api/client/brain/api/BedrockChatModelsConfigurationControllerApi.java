...
import gebo.microservices.api.client.brain.model.GBedrockChatModelConfig;
import gebo.microservices.api.client.brain.model.OperationStatusBoolean;
import gebo.microservices.api.client.brain.model.OperationStatusGBedrockChatModelConfig;
import gebo.microservices.api.client.brain.model.OperationStatusListGBedrockChatModelChoice;
...
public class BedrockChatModelsConfigurationControllerApi {
    ...
    public ResponseEntity<OperationStatusBoolean> deleteBedrockChatModelConfigWithHttpInfo(GBedrockChatModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockChatModelsConfigurationController/deleteBedrockChatModelConfig").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GBedrockChatModelConfig findBedrockChatModelConfigByCode(Object code) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GBedrockChatModelConfig> findBedrockChatModelConfigByCodeWithHttpInfo(Object code) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockChatModelsConfigurationController/findBedrockChatModelConfigByCode").build().toUriString();
    ...
    public ResponseEntity<OperationStatusListGBedrockChatModelChoice> getBedrockChatModelsWithHttpInfo(GBedrockChatModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockChatModelsConfigurationController/getBedrockChatModels").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGBedrockChatModelConfig> insertBedrockChatModelConfigWithHttpInfo(GBedrockChatModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockChatModelsConfigurationController/insertBedrockChatModelConfig").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGBedrockChatModelConfig> updateBedrockChatModelConfigWithHttpInfo(GBedrockChatModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockChatModelsConfigurationController/updateBedrockChatModelConfig").build().toUriString();
