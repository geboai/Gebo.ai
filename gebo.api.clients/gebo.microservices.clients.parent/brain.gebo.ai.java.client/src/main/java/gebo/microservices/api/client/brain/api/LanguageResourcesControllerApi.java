...
import gebo.microservices.api.client.brain.model.UIComponent;
...
public class LanguageResourcesControllerApi {
    ...
    public ResponseEntity<List<UIComponent>> getAllResourcesByLanguageWithHttpInfo(String langCode) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/users/LanguageResourcesController").build().toUriString();
    ...
    public ResponseEntity<UIComponent> getUIComponentLabelsWithHttpInfo(String id, String langCode) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/users/LanguageResourcesController/getUIComponentLabels").build().toUriString();
    ...
    public ResponseEntity<UIComponent> updateWithHttpInfo(UIComponent body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/users/LanguageResourcesController/update").build().toUriString();
