...
public class OperationStatusListGenericOpenAIAPIEmbeddingModelChoice {
  @JsonProperty("result")
  private List<GenericOpenAIAPIEmbeddingModelChoice> result = null;
  ...
  public OperationStatusListGenericOpenAIAPIEmbeddingModelChoice addResultItem(GenericOpenAIAPIEmbeddingModelChoice resultItem) {
    if (this.result == null) {
  ...
  **/
  @Schema(description = "")
  public List<GenericOpenAIAPIEmbeddingModelChoice> getResult() {
    return result;
  }

  public void setResult(List<GenericOpenAIAPIEmbeddingModelChoice> result) {
    this.result = result;
  }

  public OperationStatusListGenericOpenAIAPIEmbeddingModelChoice messages(List<GUserMessage> messages) {
    this.messages = messages;
    return this;
  }

  public OperationStatusListGenericOpenAIAPIEmbeddingModelChoice addMessagesItem(GUserMessage messagesItem) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class OperationStatusListGenericOpenAIAPIEmbeddingModelChoice {\n");
