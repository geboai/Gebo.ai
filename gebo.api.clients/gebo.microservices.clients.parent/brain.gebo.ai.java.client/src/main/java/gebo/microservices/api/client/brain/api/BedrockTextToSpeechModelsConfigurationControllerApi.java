...
public class BedrockTextToSpeechModelsConfigurationControllerApi {
    ...
    public ResponseEntity<OperationStatusBoolean> deleteBedrockTextToSpeechModelConfigWithHttpInfo(GBedrockTextToSpeechModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockTextToSpeechModelsConfigurationController/deleteBedrockTextToSpeechModelConfig").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GBedrockTextToSpeechModelConfig findBedrockTextToSpeechModelConfigByCode(Object code) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GBedrockTextToSpeechModelConfig> findBedrockTextToSpeechModelConfigByCodeWithHttpInfo(Object code) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockTextToSpeechModelsConfigurationController/findBedrockTextToSpeechModelConfigByCode").build().toUriString();
    ...
    public ResponseEntity<OperationStatusListGBedrockTextToSpeechModelChoice> getBedrockTextToSpeechModelsWithHttpInfo(GBedrockTextToSpeechModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockTextToSpeechModelsConfigurationController/getBedrockTextToSpeechModels").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGBedrockTextToSpeechModelConfig> insertBedrockTextToSpeechModelConfigWithHttpInfo(GBedrockTextToSpeechModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockTextToSpeechModelsConfigurationController/insertBedrockTextToSpeechModelConfig").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGBedrockTextToSpeechModelConfig> updateBedrockTextToSpeechModelConfigWithHttpInfo(GBedrockTextToSpeechModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/BedrockTextToSpeechModelsConfigurationController/updateBedrockTextToSpeechModelConfig").build().toUriString();
