...
public class OpenAiTranscriptModelsConfigurationControllerApi {
    ...
    public ResponseEntity<OperationStatusBoolean> deleteOpenAITranscriptModelConfigWithHttpInfo(GOpenAITranscriptModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OpenAITranscriptModelsConfigurationController/deleteOpenAITranscriptModelConfig").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GOpenAITranscriptModelConfig findOpenAITranscriptModelConfigByCode(Object code) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GOpenAITranscriptModelConfig> findOpenAITranscriptModelConfigByCodeWithHttpInfo(Object code) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OpenAITranscriptModelsConfigurationController/findOpenAITranscriptModelConfigByCode").build().toUriString();
    ...
    public ResponseEntity<OperationStatusListGOpenAITranscriptModelChoice> getOpenAITranscriptModelsWithHttpInfo(GOpenAITranscriptModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OpenAITranscriptModelsConfigurationController/getOpenAITranscriptModels").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGOpenAITranscriptModelConfig> insertOpenAITranscriptModelConfigWithHttpInfo(GOpenAITranscriptModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OpenAITranscriptModelsConfigurationController/insertOpenAITranscriptModelConfig").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGOpenAITranscriptModelConfig> updateOpenAITranscriptModelConfigWithHttpInfo(GOpenAITranscriptModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OpenAITranscriptModelsConfigurationController/updateOpenAITranscriptModelConfig").build().toUriString();
