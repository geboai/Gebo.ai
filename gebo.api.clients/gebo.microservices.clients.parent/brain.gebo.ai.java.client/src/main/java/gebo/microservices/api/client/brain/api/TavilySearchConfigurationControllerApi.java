...
import gebo.microservices.api.client.brain.model.GTavilySearchApiCredentials;
import gebo.microservices.api.client.brain.model.TavilySearchConfig;
...
public class TavilySearchConfigurationControllerApi {
    ...
    public ResponseEntity<Void> deleteGTavilySearchApiCredentialsWithHttpInfo(GTavilySearchApiCredentials body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/TavilySearchConfigurationController/deleteGTavilySearchApiCredentials").build().toUriString();
    ...
    public ResponseEntity<GTavilySearchApiCredentials> fastInsertTavilySearchApiCredentialsWithHttpInfo(TavilySearchConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/TavilySearchConfigurationController/fastInsertTavilySearchApiCredentials").build().toUriString();
    ...
    public ResponseEntity<ComponentSetupStatus> getTavilySearchStatusWithHttpInfo() throws RestClientException {
        Object postBody = null;
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/TavilySearchConfigurationController/getTavilySearchStatus").build().toUriString();
    ...
    public ResponseEntity<GTavilySearchApiCredentials> insertGTavilySearchApiCredentialsWithHttpInfo(GTavilySearchApiCredentials body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/TavilySearchConfigurationController/insertGTavilySearchApiCredentials").build().toUriString();
    ...
    public ResponseEntity<GTavilySearchApiCredentials> searchGTavilySearchApiCredentialsByCodeWithHttpInfo(Object code) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/TavilySearchConfigurationController/searchGTavilySearchApiCredentialsByCode").build().toUriString();
    ...
    public ResponseEntity<GTavilySearchApiCredentials> updateGTavilySearchApiCredentialsWithHttpInfo(GTavilySearchApiCredentials body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/TavilySearchConfigurationController/updateGTavilySearchApiCredentials").build().toUriString();
