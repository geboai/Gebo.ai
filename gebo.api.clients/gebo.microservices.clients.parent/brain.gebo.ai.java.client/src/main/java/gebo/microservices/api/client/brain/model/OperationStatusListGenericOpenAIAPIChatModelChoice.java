...
public class OperationStatusListGenericOpenAIAPIChatModelChoice {
  @JsonProperty("result")
  private List<GenericOpenAIAPIChatModelChoice> result = null;
  ...
  public OperationStatusListGenericOpenAIAPIChatModelChoice addResultItem(GenericOpenAIAPIChatModelChoice resultItem) {
    if (this.result == null) {
  ...
  **/
  @Schema(description = "")
  public List<GenericOpenAIAPIChatModelChoice> getResult() {
    return result;
  }

  public void setResult(List<GenericOpenAIAPIChatModelChoice> result) {
    this.result = result;
  }

  public OperationStatusListGenericOpenAIAPIChatModelChoice messages(List<GUserMessage> messages) {
    this.messages = messages;
    return this;
  }

  public OperationStatusListGenericOpenAIAPIChatModelChoice addMessagesItem(GUserMessage messagesItem) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class OperationStatusListGenericOpenAIAPIChatModelChoice {\n");
