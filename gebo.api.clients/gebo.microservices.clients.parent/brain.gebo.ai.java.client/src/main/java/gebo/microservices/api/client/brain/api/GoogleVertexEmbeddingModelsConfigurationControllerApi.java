...
public class GoogleVertexEmbeddingModelsConfigurationControllerApi {
    ...
    public ResponseEntity<OperationStatusBoolean> deleteGoogleVertexEmbeddingModelConfigWithHttpInfo(GGoogleVertexEmbeddingModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/GoogleVertexEmbeddingModelsConfigurationController/deleteGoogleVertexEmbeddingModelConfig").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GGoogleVertexEmbeddingModelConfig findGoogleVertexEmbeddingModelConfigByCode(Object code) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GGoogleVertexEmbeddingModelConfig> findGoogleVertexEmbeddingModelConfigByCodeWithHttpInfo(Object code) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/GoogleVertexEmbeddingModelsConfigurationController/findGoogleVertexEmbeddingModelConfigByCode").build().toUriString();
    ...
    public ResponseEntity<OperationStatusListGGoogleVertexEmbeddingModelChoice> getGoogleVertexEmbeddingModelsWithHttpInfo(GGoogleVertexEmbeddingModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/GoogleVertexEmbeddingModelsConfigurationController/getGoogleVertexEmbeddingModels").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGGoogleVertexEmbeddingModelConfig> insertGoogleVertexEmbeddingModelConfigWithHttpInfo(GGoogleVertexEmbeddingModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/GoogleVertexEmbeddingModelsConfigurationController/insertGoogleVertexEmbeddingModelConfig").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGGoogleVertexEmbeddingModelConfig> updateGoogleVertexEmbeddingModelConfigWithHttpInfo(GGoogleVertexEmbeddingModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/GoogleVertexEmbeddingModelsConfigurationController/updateGoogleVertexEmbeddingModelConfig").build().toUriString();
