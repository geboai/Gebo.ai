...
public class GeboTranscriptControllerApi {
    private ApiClient apiClient;
     ...
     public GeboTranscriptControllerApi() {
        this(new ApiClient());
    }
    public GeboTranscriptControllerApi(ApiClient apiClient) {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public TranscriptResponse transcriptText() throws RestClientException {
        return transcriptTextWithHttpInfo().getBody();
    }
