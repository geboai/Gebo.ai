...
import gebo.microservices.api.client.brain.model.GOpenAIChatModelConfig;
import gebo.microservices.api.client.brain.model.OperationStatusBoolean;
import gebo.microservices.api.client.brain.model.OperationStatusGOpenAIChatModelConfig;
import gebo.microservices.api.client.brain.model.OperationStatusListGOpenAIChatModelChoice;
...
public class OpenAiChatModelsConfigurationControllerApi {
    ...
    public ResponseEntity<OperationStatusBoolean> deleteOpenAIChatModelConfigWithHttpInfo(GOpenAIChatModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OpenAIModelsConfigurationController/deleteOpenAIChatModelConfig").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GOpenAIChatModelConfig findOpenAIChatModelConfigByCode(Object code) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GOpenAIChatModelConfig> findOpenAIChatModelConfigByCodeWithHttpInfo(Object code) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OpenAIModelsConfigurationController/findOpenAIChatModelConfigByCode").build().toUriString();
    ...
    public ResponseEntity<OperationStatusListGOpenAIChatModelChoice> getOpenAIChatModelsWithHttpInfo(GOpenAIChatModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OpenAIModelsConfigurationController/getOpenAIChatModels").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGOpenAIChatModelConfig> insertOpenAIChatModelConfigWithHttpInfo(GOpenAIChatModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OpenAIModelsConfigurationController/insertOpenAIChatModelConfig").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGOpenAIChatModelConfig> updateOpenAIChatModelConfigWithHttpInfo(GOpenAIChatModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OpenAIModelsConfigurationController/updateOpenAIChatModelConfig").build().toUriString();
