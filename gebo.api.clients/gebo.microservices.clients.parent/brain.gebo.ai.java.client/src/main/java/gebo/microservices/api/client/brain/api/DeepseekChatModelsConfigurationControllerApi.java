...
import gebo.microservices.api.client.brain.model.GDeepseekChatModelConfig;
import gebo.microservices.api.client.brain.model.OperationStatusBoolean;
import gebo.microservices.api.client.brain.model.OperationStatusGDeepseekChatModelConfig;
import gebo.microservices.api.client.brain.model.OperationStatusListGDeepseekChatModelChoice;
...
public class DeepseekChatModelsConfigurationControllerApi {
    ...
    public ResponseEntity<OperationStatusBoolean> deleteDeepseekChatModelConfigWithHttpInfo(GDeepseekChatModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/DeepseekChatModelsConfigurationController/deleteDeepseekChatModelConfig").build().toUriString();
    ...
    public ResponseEntity<GDeepseekChatModelConfig> findDeepseekChatModelConfigByCodeWithHttpInfo(Object code) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/DeepseekChatModelsConfigurationController/findDeepseekChatModelConfigByCode").build().toUriString();
    ...
    public ResponseEntity<OperationStatusListGDeepseekChatModelChoice> getDeepseekChatModelsWithHttpInfo(GDeepseekChatModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/DeepseekChatModelsConfigurationController/getDeepseekModels").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGDeepseekChatModelConfig> insertDeepseekChatModelConfigWithHttpInfo(GDeepseekChatModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/DeepseekChatModelsConfigurationController/insertDeepseekChatModelConfig").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGDeepseekChatModelConfig> updateDeepseekChatModelConfigWithHttpInfo(GDeepseekChatModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/DeepseekChatModelsConfigurationController/updateDeepseekChatModelConfig").build().toUriString();
