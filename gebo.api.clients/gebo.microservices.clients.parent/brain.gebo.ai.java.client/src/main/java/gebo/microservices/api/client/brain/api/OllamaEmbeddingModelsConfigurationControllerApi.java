...
import gebo.microservices.api.client.brain.model.GOllamaEmbeddingModelConfig;
import gebo.microservices.api.client.brain.model.OperationStatusBoolean;
import gebo.microservices.api.client.brain.model.OperationStatusGOllamaEmbeddingModelConfig;
import gebo.microservices.api.client.brain.model.OperationStatusListGOllamaEmbeddingModelChoice;
...
public class OllamaEmbeddingModelsConfigurationControllerApi {
    ...
    public ResponseEntity<OperationStatusBoolean> deleteOllamaEmbeddingModelConfigWithHttpInfo(GOllamaEmbeddingModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OllamaEmbeddingModelsConfigurationController/deleteOllamaEmbeddingModelConfig").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GOllamaEmbeddingModelConfig findOllamaEmbeddingModelConfigByCode(Object code) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GOllamaEmbeddingModelConfig> findOllamaEmbeddingModelConfigByCodeWithHttpInfo(Object code) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OllamaEmbeddingModelsConfigurationController/findOllamaEmbeddingModelConfigByCode").build().toUriString();
    ...
    public ResponseEntity<OperationStatusListGOllamaEmbeddingModelChoice> getOllamaEmbeddingModelsWithHttpInfo(GOllamaEmbeddingModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OllamaEmbeddingModelsConfigurationController/getOllamaEmbeddingModels").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGOllamaEmbeddingModelConfig> insertOllamaEmbeddingModelConfigWithHttpInfo(GOllamaEmbeddingModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OllamaEmbeddingModelsConfigurationController/insertOllamaEmbeddingModelConfig").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGOllamaEmbeddingModelConfig> updateOllamaEmbeddingModelConfigWithHttpInfo(GOllamaEmbeddingModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OllamaEmbeddingModelsConfigurationController/updateOllamaEmbeddingModelConfig").build().toUriString();
