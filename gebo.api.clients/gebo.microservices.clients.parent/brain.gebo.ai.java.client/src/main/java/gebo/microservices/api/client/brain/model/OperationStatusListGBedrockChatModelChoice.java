...
public class OperationStatusListGBedrockChatModelChoice {
  @JsonProperty("result")
  private List<GBedrockChatModelChoice> result = null;
  ...
  public OperationStatusListGBedrockChatModelChoice addResultItem(GBedrockChatModelChoice resultItem) {
    if (this.result == null) {
  ...
  **/
  @Schema(description = "")
  public List<GBedrockChatModelChoice> getResult() {
    return result;
  }

  public void setResult(List<GBedrockChatModelChoice> result) {
    this.result = result;
  }

  public OperationStatusListGBedrockChatModelChoice messages(List<GUserMessage> messages) {
    this.messages = messages;
    return this;
  }

  public OperationStatusListGBedrockChatModelChoice addMessagesItem(GUserMessage messagesItem) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class OperationStatusListGBedrockChatModelChoice {\n");
