...
import gebo.microservices.api.client.brain.model.GBedrockChatModelChoice;
...
public class GBedrockChatModelConfig {
  @JsonProperty("code")
  ...
  private GBedrockChatModelChoice choosedModel = null;
  ...
  public GBedrockChatModelConfig code(String code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public GBedrockChatModelConfig description(String description) {
  ...
  **/
  ...
  public GBedrockChatModelConfig userModified(String userModified) {
  ...
  **/
  ...
  public GBedrockChatModelConfig userCreated(String userCreated) {
  ...
  **/
  ...
  public GBedrockChatModelConfig dateModified(Date dateModified) {
  ...
  **/
  ...
  public GBedrockChatModelConfig dateCreated(Date dateCreated) {
  ...
  **/
  ...
  public GBedrockChatModelConfig modelTypeCode(String modelTypeCode) {
  ...
  **/
  ...
  public GBedrockChatModelConfig defaultModel(Boolean defaultModel) {
  ...
  **/
  ...
  public GBedrockChatModelConfig apiSecretCode(String apiSecretCode) {
  ...
  **/
  ...
  public GBedrockChatModelConfig choosedModel(GBedrockChatModelChoice choosedModel) {
  ...
  **/
  @Schema(description = "")
  public GBedrockChatModelChoice getChoosedModel() {
    return choosedModel;
  }

  public void setChoosedModel(GBedrockChatModelChoice choosedModel) {
    this.choosedModel = choosedModel;
  }

  public GBedrockChatModelConfig baseUrl(String baseUrl) {
  ...
  **/
  ...
  public GBedrockChatModelConfig contextLength(Integer contextLength) {
  ...
  **/
  ...
  public GBedrockChatModelConfig topP(Double topP) {
    this.topP = topP;
    return this;
  }
  ...
  **/
  ...
  public GBedrockChatModelConfig accessibleGroups(List<String> accessibleGroups) {
    this.accessibleGroups = accessibleGroups;
    return this;
  }

  public GBedrockChatModelConfig addAccessibleGroupsItem(String accessibleGroupsItem) {
  ...
  **/
  ...
  public GBedrockChatModelConfig accessibleUsers(List<String> accessibleUsers) {
    this.accessibleUsers = accessibleUsers;
    return this;
  }

  public GBedrockChatModelConfig addAccessibleUsersItem(String accessibleUsersItem) {
  ...
  **/
  ...
  public GBedrockChatModelConfig accessibleToAll(Boolean accessibleToAll) {
  ...
  **/
  ...
  public GBedrockChatModelConfig enabledFunctions(List<String> enabledFunctions) {
    this.enabledFunctions = enabledFunctions;
    return this;
  }

  public GBedrockChatModelConfig addEnabledFunctionsItem(String enabledFunctionsItem) {
  ...
  **/
  ...
  public GBedrockChatModelConfig temperature(Double temperature) {
  ...
  **/
  ...
  public GBedrockChatModelConfig forUses(List<ForUsesEnum> forUses) {
    this.forUses = forUses;
    return this;
  }

  public GBedrockChatModelConfig addForUsesItem(ForUsesEnum forUsesItem) {
  ...
  **/
  ...
  public GBedrockChatModelConfig features(List<FeaturesEnum> features) {
    this.features = features;
    return this;
  }

  public GBedrockChatModelConfig addFeaturesItem(FeaturesEnum featuresItem) {
  ...
  **/
  ...
  public GBedrockChatModelConfig thinking(ThinkingEnum thinking) {
  ...
  **/
  ...
  public GBedrockChatModelConfig maxGeneratedTokens(Integer maxGeneratedTokens) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GBedrockChatModelConfig gbedrockChatModelConfig = (GBedrockChatModelConfig) o;
    return Objects.equals(this.code, gbedrockChatModelConfig.code) &&
        Objects.equals(this.description, gbedrockChatModelConfig.description) &&
        Objects.equals(this.userModified, gbedrockChatModelConfig.userModified) &&
        Objects.equals(this.userCreated, gbedrockChatModelConfig.userCreated) &&
        Objects.equals(this.dateModified, gbedrockChatModelConfig.dateModified) &&
        Objects.equals(this.dateCreated, gbedrockChatModelConfig.dateCreated) &&
        Objects.equals(this.modelTypeCode, gbedrockChatModelConfig.modelTypeCode) &&
        Objects.equals(this.defaultModel, gbedrockChatModelConfig.defaultModel) &&
        Objects.equals(this.apiSecretCode, gbedrockChatModelConfig.apiSecretCode) &&
        Objects.equals(this.choosedModel, gbedrockChatModelConfig.choosedModel) &&
        Objects.equals(this.baseUrl, gbedrockChatModelConfig.baseUrl) &&
        Objects.equals(this.contextLength, gbedrockChatModelConfig.contextLength) &&
        Objects.equals(this.topP, gbedrockChatModelConfig.topP) &&
        Objects.equals(this.accessibleGroups, gbedrockChatModelConfig.accessibleGroups) &&
        Objects.equals(this.accessibleUsers, gbedrockChatModelConfig.accessibleUsers) &&
        Objects.equals(this.accessibleToAll, gbedrockChatModelConfig.accessibleToAll) &&
        Objects.equals(this.enabledFunctions, gbedrockChatModelConfig.enabledFunctions) &&
        Objects.equals(this.temperature, gbedrockChatModelConfig.temperature) &&
        Objects.equals(this.forUses, gbedrockChatModelConfig.forUses) &&
        Objects.equals(this.features, gbedrockChatModelConfig.features) &&
        Objects.equals(this.thinking, gbedrockChatModelConfig.thinking) &&
        Objects.equals(this.maxGeneratedTokens, gbedrockChatModelConfig.maxGeneratedTokens);
  }
  ...
  public String toString() {
    ...
    sb.append("class GBedrockChatModelConfig {\n");
