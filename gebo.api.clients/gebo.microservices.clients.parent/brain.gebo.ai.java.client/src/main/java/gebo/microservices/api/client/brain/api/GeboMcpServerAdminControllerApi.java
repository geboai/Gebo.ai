...
public class GeboMcpServerAdminControllerApi {
     ...
     * <p><b>200</b> - OK
     * @param body  (required)
     * @return PageGeboMCPServerConfig
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public PageGeboMCPServerConfig getMcpServerPagedList(DataPage body) throws RestClientException {
     ...
     * <p><b>200</b> - OK
     * @param body  (required)
     * @return ResponseEntity&lt;PageGeboMCPServerConfig&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<PageGeboMCPServerConfig> getMcpServerPagedListWithHttpInfo(DataPage body) throws RestClientException {
