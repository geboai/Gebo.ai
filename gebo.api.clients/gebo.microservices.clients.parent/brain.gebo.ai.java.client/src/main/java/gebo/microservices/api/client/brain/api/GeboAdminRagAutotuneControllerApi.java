...
public class GeboAdminRagAutotuneControllerApi {
     ...
     */
    public Object getLatestComputedVectorStores() throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Object> getLatestComputedVectorStoresWithHttpInfo() throws RestClientException {
