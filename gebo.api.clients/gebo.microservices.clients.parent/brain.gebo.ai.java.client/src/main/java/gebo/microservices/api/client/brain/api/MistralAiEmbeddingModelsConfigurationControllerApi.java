...
public class MistralAiEmbeddingModelsConfigurationControllerApi {
    ...
    public ResponseEntity<OperationStatusBoolean> deleteMistralAIEmbeddingModelConfigWithHttpInfo(GMistralEmbeddingModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MistralAIEmbeddingModelsConfigurationController/deleteMistralAIEmbeddingModelConfig").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GMistralEmbeddingModelConfig findMistralAIEmbeddingModelConfigByCode(Object code) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GMistralEmbeddingModelConfig> findMistralAIEmbeddingModelConfigByCodeWithHttpInfo(Object code) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MistralAIEmbeddingModelsConfigurationController/findMistralAIEmbeddingModelConfigByCode").build().toUriString();
    ...
    public ResponseEntity<OperationStatusListGMistralEmbeddingModelChoice> getMistralAIEmbeddingModelsWithHttpInfo(GMistralEmbeddingModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MistralAIEmbeddingModelsConfigurationController/getMistralAIEmbeddingModels").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGMistralEmbeddingModelConfig> insertMistralAIEmbeddingModelConfigWithHttpInfo(GMistralEmbeddingModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MistralAIEmbeddingModelsConfigurationController/insertMistralAIEmbeddingModelConfig").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGMistralEmbeddingModelConfig> updateMistralAIEmbeddingModelConfigWithHttpInfo(GMistralEmbeddingModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MistralAIEmbeddingModelsConfigurationController/updateMistralAIEmbeddingModelConfig").build().toUriString();
