...
public class MistralAiChatModelsConfigurationControllerApi {
    ...
    public ResponseEntity<OperationStatusBoolean> deleteMistralAIChatModelConfigWithHttpInfo(GMistralChatModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MistralAIChatModelsConfigurationController/deleteMistralAIChatModelConfig").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GMistralChatModelConfig findMistralAIChatModelConfigByCode(Object code) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GMistralChatModelConfig> findMistralAIChatModelConfigByCodeWithHttpInfo(Object code) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MistralAIChatModelsConfigurationController/findMistralAIChatModelConfigByCode").build().toUriString();
    ...
    public ResponseEntity<OperationStatusListGMistralChatModelChoice> getMistralAIChatModelsWithHttpInfo(GMistralChatModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MistralAIChatModelsConfigurationController/getMistralAIChatModels").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGMistralChatModelConfig> insertMistralAIChatModelConfigWithHttpInfo(GMistralChatModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MistralAIChatModelsConfigurationController/insertMistralAIChatModelConfig").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGMistralChatModelConfig> updateMistralAIChatModelConfigWithHttpInfo(GMistralChatModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MistralAIChatModelsConfigurationController/updateMistralAIChatModelConfig").build().toUriString();
