...
import gebo.microservices.api.client.brain.model.GeboNeo4jModuleConfigDto;
...
public class GeboNeo4jModuleSetupControllerApi {
    ...
    public ResponseEntity<GeboNeo4jModuleConfigDto> getNeo4jModuleSetupConfigWithHttpInfo() throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/GeboNeo4jModuleSetupController").build().toUriString();
