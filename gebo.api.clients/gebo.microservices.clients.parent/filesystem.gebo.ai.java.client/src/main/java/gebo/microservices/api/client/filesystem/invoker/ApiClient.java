package gebo.microservices.api.client.filesystem.invoker;
...
import gebo.microservices.api.client.filesystem.invoker.auth.Authentication;
import gebo.microservices.api.client.filesystem.invoker.auth.HttpBasicAuth;
import gebo.microservices.api.client.filesystem.invoker.auth.ApiKeyAuth;
import gebo.microservices.api.client.filesystem.invoker.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "http://localhost:13006/filesystem";
