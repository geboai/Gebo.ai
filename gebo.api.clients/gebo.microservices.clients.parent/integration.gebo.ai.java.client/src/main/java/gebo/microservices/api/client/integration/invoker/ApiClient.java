package gebo.microservices.api.client.integration.invoker;
...
import gebo.microservices.api.client.integration.invoker.auth.Authentication;
import gebo.microservices.api.client.integration.invoker.auth.HttpBasicAuth;
import gebo.microservices.api.client.integration.invoker.auth.ApiKeyAuth;
import gebo.microservices.api.client.integration.invoker.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "http://localhost:13015/integration";
