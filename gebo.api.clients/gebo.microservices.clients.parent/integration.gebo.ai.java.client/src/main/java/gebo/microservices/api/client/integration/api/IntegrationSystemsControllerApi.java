...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2026-09-23T07:17:19.314728403+02:00[Europe/Rome]")
...
public class IntegrationSystemsControllerApi {
    ...
    public ResponseEntity<Void> deleteIntegrationProjectEndpointWithHttpInfo(GIntegrationProjectEndpoint body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/IntegrationSystemsController/deleteIntegrationProjectEndpoint").build().toUriString();
    ...
    public ResponseEntity<List<GIntegrationProjectEndpoint>> findIntegrationEndpointsByProjectWithHttpInfo(String parentProjectCode) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/IntegrationSystemsController/findIntegrationEndpointsByProject").build().toUriString();
    ...
    public ResponseEntity<GIntegrationProjectEndpoint> insertIntegrationProjectEndpointWithHttpInfo(GIntegrationProjectEndpoint body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/IntegrationSystemsController/insertIntegrationProjectEndpoint").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public OperationStatusGJobStatus publishIntegrationProjectEndpoint(GIntegrationProjectEndpoint body) throws RestClientException {
        return publishIntegrationProjectEndpointWithHttpInfo(body).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<OperationStatusGJobStatus> publishIntegrationProjectEndpointWithHttpInfo(GIntegrationProjectEndpoint body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling publishIntegrationProjectEndpoint");
        }
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/IntegrationSystemsController/publishIntegrationProjectEndpoint").build().toUriString();
    ...
    public ResponseEntity<GIntegrationProjectEndpoint> updateIntegrationProjectEndpointWithHttpInfo(GIntegrationProjectEndpoint body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/IntegrationSystemsController/updateIntegrationProjectEndpoint").build().toUriString();
