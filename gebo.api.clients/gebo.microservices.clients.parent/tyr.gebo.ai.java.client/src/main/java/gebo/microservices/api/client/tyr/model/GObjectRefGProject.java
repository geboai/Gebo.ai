...
public class GObjectRefGProject {
  ...
  public GObjectRefGProject className(String className) {
  ...
  **/
  ...
  public GObjectRefGProject code(String code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public GObjectRefGProject description(String description) {
