package gebo.microservices.api.client.fulltextor.invoker;
...
import gebo.microservices.api.client.fulltextor.invoker.auth.Authentication;
import gebo.microservices.api.client.fulltextor.invoker.auth.HttpBasicAuth;
import gebo.microservices.api.client.fulltextor.invoker.auth.ApiKeyAuth;
import gebo.microservices.api.client.fulltextor.invoker.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2026-07-20T23:48:55.213558753+02:00[Europe/Rome]")
...
public class ApiClient {
    ...
    private String basePath = "http://localhost:13016/fulltextor";
