...
import gebo.microservices.api.client.fulltextor.model.GModuleMetaInfo;
...
public class InternalMessagingTopologyControllerApi {
    private ApiClient apiClient;
     ...
     public InternalMessagingTopologyControllerApi() {
        this(new ApiClient());
    }
    public InternalMessagingTopologyControllerApi(ApiClient apiClient) {
