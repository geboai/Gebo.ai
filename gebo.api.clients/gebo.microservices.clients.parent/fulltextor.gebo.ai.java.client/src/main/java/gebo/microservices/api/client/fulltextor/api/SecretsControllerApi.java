package gebo.microservices.api.client.fulltextor.api;

import gebo.microservices.api.client.fulltextor.invoker.ApiClient;

import gebo.microservices.api.client.fulltextor.model.SecretInfo;
import gebo.microservices.api.client.fulltextor.model.SecretWrapperGeboAwsConnectionCredentials;
import gebo.microservices.api.client.fulltextor.model.SecretWrapperGeboCustomSecretContent;
import gebo.microservices.api.client.fulltextor.model.SecretWrapperGeboGoogleJsonSecretContent;
import gebo.microservices.api.client.fulltextor.model.SecretWrapperGeboGoogleOauth2SecretContent;
import gebo.microservices.api.client.fulltextor.model.SecretWrapperGeboOauth2SecretContent;
import gebo.microservices.api.client.fulltextor.model.SecretWrapperGeboSshKeySecretContent;
import gebo.microservices.api.client.fulltextor.model.SecretWrapperGeboTokenContent;
import gebo.microservices.api.client.fulltextor.model.SecretWrapperGeboUsernamePasswordContent;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2026-07-13T14:56:05.301238900+02:00[Europe/Rome]")
...
public class SecretsControllerApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Object getSecretsByContextCode(Object context) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Object> getSecretsByContextCodeWithHttpInfo(Object context) throws RestClientException {
