...
//import gebo.microservices.api.client.mcpclient.api.McpClientConfigControllerApi;
...
try {
    PageMCPClientConfig result = apiInstance.findMCPClientConfigByQbe(body);
    System.out.println(result);
} catch (ApiException e) {
...
try {
    PageMCPClientConfig result = apiInstance.listMCPClientConfig(body);
    System.out.println(result);
} catch (ApiException e) {
