...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2026-07-20T23:48:53.856149352+02:00[Europe/Rome]")
...
public class McpClientConfigControllerApi {
     ...
     * <p><b>200</b> - OK
     * @param body  (required)
     * @return PageMCPClientConfig
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public PageMCPClientConfig findMCPClientConfigByQbe(FindByMCPClientConfigQbeParam body) throws RestClientException {
     ...
     * <p><b>200</b> - OK
     * @param body  (required)
     * @return ResponseEntity&lt;PageMCPClientConfig&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<PageMCPClientConfig> findMCPClientConfigByQbeWithHttpInfo(FindByMCPClientConfigQbeParam body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
        ...
        ParameterizedTypeReference<PageMCPClientConfig> returnType = new ParameterizedTypeReference<PageMCPClientConfig>() {};
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public PageMCPClientConfig listMCPClientConfig(DataPage body) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<PageMCPClientConfig> listMCPClientConfigWithHttpInfo(DataPage body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
