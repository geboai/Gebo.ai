...
import gebo.microservices.api.client.mcpclient.model.GContentManagementSystemType;
import gebo.microservices.api.client.mcpclient.model.MCPClientProjectEndpoint;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2026-09-23T10:53:51.521937409+02:00[Europe/Rome]")
...
public class McpClientSystemsControllerApi {
    ...
    public ResponseEntity<Void> deleteMCPClientEndpointWithHttpInfo(MCPClientProjectEndpoint body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MCPClientSystemsController/deleteMCPClientEndpoint").build().toUriString();
    ...
    public ResponseEntity<MCPClientProjectEndpoint> findMCPClientEndpointsByCodeWithHttpInfo(String code) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MCPClientSystemsController/findMCPClientEndpointsByCode").build().toUriString();
    ...
    public ResponseEntity<List<MCPClientProjectEndpoint>> findMCPClientEndpointsByProjectWithHttpInfo(String parentProjectCode) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MCPClientSystemsController/findMCPClientEndpointsByProject").build().toUriString();
    ...
    public ResponseEntity<List<MCPClientProjectEndpoint>> findMCPClientEndpointsByQbeWithHttpInfo(MCPClientProjectEndpoint body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MCPClientSystemsController/findMCPClientEndpointsByQbe").build().toUriString();
    ...
    public ResponseEntity<GContentManagementSystemType> getMCPClientSystemTypeWithHttpInfo() throws RestClientException {
        Object postBody = null;
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MCPClientSystemsController/getMCPClientSystemType").build().toUriString();
    ...
    public ResponseEntity<MCPClientProjectEndpoint> insertMCPClientEndpointWithHttpInfo(MCPClientProjectEndpoint body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MCPClientSystemsController/insertMCPClientEndpoint").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public OperationStatusGJobStatus publishMCPClientEndpoint(MCPClientProjectEndpoint body) throws RestClientException {
        return publishMCPClientEndpointWithHttpInfo(body).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<OperationStatusGJobStatus> publishMCPClientEndpointWithHttpInfo(MCPClientProjectEndpoint body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling publishMCPClientEndpoint");
        }
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MCPClientSystemsController/publishMCPClientEndpoint").build().toUriString();
    ...
    public ResponseEntity<MCPClientProjectEndpoint> updateMCPClientEndpointWithHttpInfo(MCPClientProjectEndpoint body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/MCPClientSystemsController/updateMCPClientEndpoint").build().toUriString();
