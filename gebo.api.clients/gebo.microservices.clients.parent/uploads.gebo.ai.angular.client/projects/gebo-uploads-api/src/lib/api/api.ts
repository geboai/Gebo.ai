...
export const APIS = [ContentsResetControllerService, DocumentContentStreamerControllerService, FileUploadControllerService, FileUploadsControllerService, GeboAngularFormGroupMetaInfoControllerService, GenericalPublisherControllerService, InternalMessagingTopologyControllerService, JobLauncherControllerService, UploadsBrowsingControllerService];
