package gebo.microservices.api.client.graphicator.invoker;
...
import gebo.microservices.api.client.graphicator.invoker.auth.Authentication;
import gebo.microservices.api.client.graphicator.invoker.auth.HttpBasicAuth;
import gebo.microservices.api.client.graphicator.invoker.auth.ApiKeyAuth;
import gebo.microservices.api.client.graphicator.invoker.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2026-07-28T15:05:01.848617034+02:00[Europe/Rome]")
...
public class ApiClient {
    ...
    private String basePath = "http://localhost:13003/graphicator";
    ...
    authentications.put("key-in-header", new ApiKeyAuth("header","Authorization"));
