package gebo.microservices.api.client.userspace.invoker;
...
import gebo.microservices.api.client.userspace.invoker.auth.Authentication;
import gebo.microservices.api.client.userspace.invoker.auth.HttpBasicAuth;
import gebo.microservices.api.client.userspace.invoker.auth.ApiKeyAuth;
import gebo.microservices.api.client.userspace.invoker.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "http://localhost:13008/userspace";
