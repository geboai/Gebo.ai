package gebo.microservices.api.client.git.invoker;
...
import gebo.microservices.api.client.git.invoker.auth.Authentication;
import gebo.microservices.api.client.git.invoker.auth.HttpBasicAuth;
import gebo.microservices.api.client.git.invoker.auth.ApiKeyAuth;
import gebo.microservices.api.client.git.invoker.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "http://localhost:13005/git";
