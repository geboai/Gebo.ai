...
import java.io.File;
import gebo.microservices.api.client.chunker.model.GDocumentReferenceStreamRequest;
import gebo.microservices.api.client.chunker.model.SearchResultStreamRequest;
...
public class DocumentContentStreamerWithCacheControllerApi {
    private ApiClient apiClient;

     public DocumentContentStreamerWithCacheControllerApi() {
        this(new ApiClient());
    }
    public DocumentContentStreamerWithCacheControllerApi(ApiClient apiClient) {
    ...
    public ResponseEntity<File> streamDocumentReferenceWithHttpInfo(GDocumentReferenceStreamRequest body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/DocumentContentStreamerWithCacheController/streamDocumentReference").build().toUriString();
    ...
    public ResponseEntity<File> streamSearchResultWithHttpInfo(SearchResultStreamRequest body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/DocumentContentStreamerWithCacheController/streamSearchResult").build().toUriString();
