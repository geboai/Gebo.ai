...
import gebo.microservices.api.client.heimdall.model.ComponentSetupStatus;
...
public class GeboAdvancedSetupStatusControllerApi {
    ...
    public ResponseEntity<ComponentSetupStatus> getFirstKnowledgeBaseSetupStatusWithHttpInfo() throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/GeboAdvancedSetupStatusController/getFirstKnowledgeBaseSetupStatus").build().toUriString();
    ...
    public ResponseEntity<ComponentSetupStatus> getMinimalContentsSetupStatusWithHttpInfo() throws RestClientException {
        Object postBody = null;
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/GeboAdvancedSetupStatusController/getMinimalContentsSetupStatus").build().toUriString();
