...
public class GeneratedAdminApiKeyControllerApi {
     ...
     */
    public void deleteAdminGeneratedApiKey(Object code) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Void> deleteAdminGeneratedApiKeyWithHttpInfo(Object code) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/GeneratedAdminApiKeyController/deleteAdminGeneratedApiKey").build().toUriString();
    ...
    public ResponseEntity<GeneratedApiKey> generateAdminGeneratedApiKeyWithHttpInfo(GenerateAdminGeneratedApiKeyParam body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/GeneratedAdminApiKeyController/generateAdminGeneratedApiKey").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public PageGeneratedApiKeyInfo getAdminGeneratedApiKeyPagedList(DataPage body) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<PageGeneratedApiKeyInfo> getAdminGeneratedApiKeyPagedListWithHttpInfo(DataPage body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/GeneratedAdminApiKeyController/getAdminGeneratedApiKeyPagedList").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Object isAdminGeneratedApiKeyGenerationAllowed() throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Object> isAdminGeneratedApiKeyGenerationAllowedWithHttpInfo() throws RestClientException {
        Object postBody = null;
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/GeneratedAdminApiKeyController/isAdminGeneratedApiKeyGenerationAllowed").build().toUriString();
