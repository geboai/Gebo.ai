...
public class AwsS3BrowsingControllerApi {
    private ApiClient apiClient;
     ...
     public AwsS3BrowsingControllerApi() {
        this(new ApiClient());
    }
    public AwsS3BrowsingControllerApi(ApiClient apiClient) {
    ...
    public ResponseEntity<OperationStatusListPathInfo> browseAwsS3PathWithHttpInfo(BrowseParam body, Object s3SystemCode) throws RestClientException {
        ...
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling browseAwsS3Path");
        }
        ...
        queryParams.putAll(apiClient.parameterToMultiValueMap(null, "s3SystemCode", s3SystemCode));
