...
import gebo.microservices.api.client.awss3.model.ResetContentRequest;
import gebo.microservices.api.client.awss3.model.ResetContentResponse;
...
public class ContentsResetControllerApi {
    ...
    public ResponseEntity<ResetContentResponse> resetContentsIngestionWithHttpInfo(ResetContentRequest body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/ContentsResetController/resetContentsIngestion").build().toUriString();
