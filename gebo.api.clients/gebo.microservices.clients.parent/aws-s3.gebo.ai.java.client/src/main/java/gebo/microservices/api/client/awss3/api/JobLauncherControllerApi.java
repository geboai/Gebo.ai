...
import gebo.microservices.api.client.awss3.model.GObjectRefGProjectEndpoint;
import gebo.microservices.api.client.awss3.model.HasRunningJobs;
...
public class JobLauncherControllerApi {
    ...
    public ResponseEntity<Void> abortJobWithHttpInfo(String jobCode) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/JobLauncherController/abortJob").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGJobStatus> createJobWithHttpInfo(GObjectRefGProjectEndpoint body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/JobLauncherController/createJob").build().toUriString();
    ...
    public ResponseEntity<HasRunningJobs> getHasRunningJobsWithHttpInfo(GObjectRefGProjectEndpoint body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/JobLauncherController/getHasRunningJobs").build().toUriString();
