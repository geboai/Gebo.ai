...
export const APIS = [ContentsResetControllerService, DocumentContentStreamerControllerService, GenericalPublisherControllerService, IngestionFileTypesLibraryControllerService, IntegrationInputControllerService, IntegrationSystemsControllerService, JobLauncherControllerService, JobStatusControllerService, SecretsControllerService, WorkflowStatsAdminLevelControllerService];
