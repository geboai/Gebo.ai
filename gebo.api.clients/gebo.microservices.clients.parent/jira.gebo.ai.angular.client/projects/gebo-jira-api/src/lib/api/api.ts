...
export const APIS = [ContentsResetControllerService, DocumentContentStreamerControllerService, GenericalPublisherControllerService, InternalMessagingTopologyControllerService, JiraBrowsingControllerService, JiraSearchServiceControllerService, JiraSystemsControllerService, JobLauncherControllerService];
