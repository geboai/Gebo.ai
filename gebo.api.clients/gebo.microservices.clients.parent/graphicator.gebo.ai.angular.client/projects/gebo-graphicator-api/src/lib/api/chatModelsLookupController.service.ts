...
@Injectable()
export class ChatModelsLookupControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getDefaultChatModel(observe?: 'body', reportProgress?: boolean): Observable<GLookupEntryRefGBaseChatModelConfig>;
    public getDefaultChatModel(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GLookupEntryRefGBaseChatModelConfig>>;
    public getDefaultChatModel(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GLookupEntryRefGBaseChatModelConfig>>;
    public getDefaultChatModel(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<GLookupEntryRefGBaseChatModelConfig>('get',`${this.basePath}/api/users/ChatModelsLookupController/getDefaultChatModel`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
