...
@Injectable()
export class GeboAngularFormGroupMetaInfoControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getFormGroupsMetaInfos(observe?: 'body', reportProgress?: boolean): Observable<Array<FormGroupMetaInfo>>;
    public getFormGroupsMetaInfos(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<FormGroupMetaInfo>>>;
    public getFormGroupsMetaInfos(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<FormGroupMetaInfo>>>;
    public getFormGroupsMetaInfos(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<FormGroupMetaInfo>>('get',`${this.basePath}/api/admin/AngularFormGroupController/getFormGroupsMetaInfos`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
