...
export const APIS = [ContentsResetControllerService, DocumentContentStreamerControllerService, FileSystemSharesSettingControllerService, FileSystemsBrowsingControllerService, FileSystemsControllerService, GenericalPublisherControllerService, IngestionFileTypesLibraryControllerService, JobLauncherControllerService, JobStatusControllerService, WorkflowStatsAdminLevelControllerService];
