...
import ai.gebo.monolithic.api.client.model.RichResponse;
...
public class GeboTemplatedChatResponseRichResponse {
  @JsonProperty("id")
  ...
  private RichResponse queryResponse = null;
  ...
  public GeboTemplatedChatResponseRichResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public GeboTemplatedChatResponseRichResponse userChatContextCode(String userChatContextCode) {
  ...
  **/
  ...
  public GeboTemplatedChatResponseRichResponse usedChatModelCode(String usedChatModelCode) {
  ...
  **/
  ...
  public GeboTemplatedChatResponseRichResponse usedChatModelProvider(String usedChatModelProvider) {
  ...
  **/
  ...
  public GeboTemplatedChatResponseRichResponse queryResponse(RichResponse queryResponse) {
  ...
  **/
  @Schema(description = "")
  public RichResponse getQueryResponse() {
    return queryResponse;
  }

  public void setQueryResponse(RichResponse queryResponse) {
    this.queryResponse = queryResponse;
  }

  public GeboTemplatedChatResponseRichResponse windowOccupation(GeboWorkingMemoryWindowOccupation windowOccupation) {
  ...
  **/
  ...
  public GeboTemplatedChatResponseRichResponse query(String query) {
    this.query = query;
    return this;
  }
  ...
  **/
  ...
  public GeboTemplatedChatResponseRichResponse thinkingOutputs(List<String> thinkingOutputs) {
    this.thinkingOutputs = thinkingOutputs;
    return this;
  }

  public GeboTemplatedChatResponseRichResponse addThinkingOutputsItem(String thinkingOutputsItem) {
  ...
  **/
  ...
  public GeboTemplatedChatResponseRichResponse backendMessages(List<GUserMessage> backendMessages) {
    this.backendMessages = backendMessages;
    return this;
  }

  public GeboTemplatedChatResponseRichResponse addBackendMessagesItem(GUserMessage backendMessagesItem) {
  ...
  **/
  ...
  public GeboTemplatedChatResponseRichResponse forcedDocumentsRef(List<GResponseDocumentRef> forcedDocumentsRef) {
    this.forcedDocumentsRef = forcedDocumentsRef;
    return this;
  }

  public GeboTemplatedChatResponseRichResponse addForcedDocumentsRefItem(GResponseDocumentRef forcedDocumentsRefItem) {
  ...
  **/
  ...
  public GeboTemplatedChatResponseRichResponse documentsRef(List<GResponseDocumentRef> documentsRef) {
    this.documentsRef = documentsRef;
    return this;
  }

  public GeboTemplatedChatResponseRichResponse addDocumentsRefItem(GResponseDocumentRef documentsRefItem) {
  ...
  **/
  ...
  public GeboTemplatedChatResponseRichResponse calledFunctions(List<CalledFunction> calledFunctions) {
    this.calledFunctions = calledFunctions;
    return this;
  }

  public GeboTemplatedChatResponseRichResponse addCalledFunctionsItem(CalledFunction calledFunctionsItem) {
  ...
  **/
  ...
  public GeboTemplatedChatResponseRichResponse contextWindowStats(ChatModelRequestContextWindowStats contextWindowStats) {
  ...
  **/
  ...
  public GeboTemplatedChatResponseRichResponse generatedResources(List<LLMGeneratedResource> generatedResources) {
    this.generatedResources = generatedResources;
    return this;
  }

  public GeboTemplatedChatResponseRichResponse addGeneratedResourcesItem(LLMGeneratedResource generatedResourcesItem) {
  ...
  **/
  ...
  public GeboTemplatedChatResponseRichResponse pipelineRouterDecisionCode(String pipelineRouterDecisionCode) {
  ...
  **/
  ...
  public GeboTemplatedChatResponseRichResponse deepSearchRequestId(String deepSearchRequestId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GeboTemplatedChatResponseRichResponse geboTemplatedChatResponseRichResponse = (GeboTemplatedChatResponseRichResponse) o;
    return Objects.equals(this.id, geboTemplatedChatResponseRichResponse.id) &&
        Objects.equals(this.userChatContextCode, geboTemplatedChatResponseRichResponse.userChatContextCode) &&
        Objects.equals(this.usedChatModelCode, geboTemplatedChatResponseRichResponse.usedChatModelCode) &&
        Objects.equals(this.usedChatModelProvider, geboTemplatedChatResponseRichResponse.usedChatModelProvider) &&
        Objects.equals(this.queryResponse, geboTemplatedChatResponseRichResponse.queryResponse) &&
        Objects.equals(this.windowOccupation, geboTemplatedChatResponseRichResponse.windowOccupation) &&
        Objects.equals(this.query, geboTemplatedChatResponseRichResponse.query) &&
        Objects.equals(this.thinkingOutputs, geboTemplatedChatResponseRichResponse.thinkingOutputs) &&
        Objects.equals(this.backendMessages, geboTemplatedChatResponseRichResponse.backendMessages) &&
        Objects.equals(this.forcedDocumentsRef, geboTemplatedChatResponseRichResponse.forcedDocumentsRef) &&
        Objects.equals(this.documentsRef, geboTemplatedChatResponseRichResponse.documentsRef) &&
        Objects.equals(this.calledFunctions, geboTemplatedChatResponseRichResponse.calledFunctions) &&
        Objects.equals(this.contextWindowStats, geboTemplatedChatResponseRichResponse.contextWindowStats) &&
        Objects.equals(this.generatedResources, geboTemplatedChatResponseRichResponse.generatedResources) &&
        Objects.equals(this.pipelineRouterDecisionCode, geboTemplatedChatResponseRichResponse.pipelineRouterDecisionCode) &&
        Objects.equals(this.deepSearchRequestId, geboTemplatedChatResponseRichResponse.deepSearchRequestId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GeboTemplatedChatResponseRichResponse {\n");
