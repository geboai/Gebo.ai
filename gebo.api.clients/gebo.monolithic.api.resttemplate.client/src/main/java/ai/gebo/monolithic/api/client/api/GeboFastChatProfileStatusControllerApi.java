...
@Component("ai.gebo.monolithic.api.client.api.GeboFastChatProfileStatusControllerApi")
public class GeboFastChatProfileStatusControllerApi {
    private ApiClient apiClient;

    public GeboFastChatProfileStatusControllerApi() {
        this(new ApiClient());
    }

    @Autowired
    public GeboFastChatProfileStatusControllerApi(ApiClient apiClient) {
     ...
     */
    public ComponentSetupStatus getChatProfilesSetupStatus() throws RestClientException {
        return getChatProfilesSetupStatusWithHttpInfo().getBody();
    }
