...
public class GBaseChatModelConfig {
  ...
  private GBaseChatModelChoice choosedModel = null;
  ...
  public GBaseChatModelConfig code(String code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public GBaseChatModelConfig description(String description) {
  ...
  **/
  ...
  public GBaseChatModelConfig userModified(String userModified) {
  ...
  **/
  ...
  public GBaseChatModelConfig userCreated(String userCreated) {
  ...
  **/
  ...
  public GBaseChatModelConfig dateModified(Date dateModified) {
  ...
  **/
  ...
  public GBaseChatModelConfig dateCreated(Date dateCreated) {
  ...
  **/
  ...
  public GBaseChatModelConfig modelTypeCode(String modelTypeCode) {
  ...
  **/
  ...
  public GBaseChatModelConfig defaultModel(Boolean defaultModel) {
  ...
  **/
  ...
  public GBaseChatModelConfig apiSecretCode(String apiSecretCode) {
  ...
  **/
  ...
  public GBaseChatModelConfig choosedModel(GBaseChatModelChoice choosedModel) {
  ...
  **/
  @Schema(description = "")
  public GBaseChatModelChoice getChoosedModel() {
    return choosedModel;
  }

  public void setChoosedModel(GBaseChatModelChoice choosedModel) {
    this.choosedModel = choosedModel;
  }

  public GBaseChatModelConfig baseUrl(String baseUrl) {
  ...
  **/
  ...
  public GBaseChatModelConfig contextLength(Integer contextLength) {
  ...
  **/
  ...
  public GBaseChatModelConfig topP(Double topP) {
    this.topP = topP;
    return this;
  }
  ...
  **/
  ...
  public GBaseChatModelConfig accessibleGroups(List<String> accessibleGroups) {
    this.accessibleGroups = accessibleGroups;
    return this;
  }

  public GBaseChatModelConfig addAccessibleGroupsItem(String accessibleGroupsItem) {
  ...
  **/
  ...
  public GBaseChatModelConfig accessibleUsers(List<String> accessibleUsers) {
    this.accessibleUsers = accessibleUsers;
    return this;
  }

  public GBaseChatModelConfig addAccessibleUsersItem(String accessibleUsersItem) {
  ...
  **/
  ...
  public GBaseChatModelConfig accessibleToAll(Boolean accessibleToAll) {
  ...
  **/
  ...
  public GBaseChatModelConfig addEnabledFunctionsItem(String enabledFunctionsItem) {
  ...
  **/
  ...
  public GBaseChatModelConfig temperature(Double temperature) {
  ...
  **/
  ...
  public GBaseChatModelConfig forUses(List<ForUsesEnum> forUses) {
    this.forUses = forUses;
    return this;
  }

  public GBaseChatModelConfig addForUsesItem(ForUsesEnum forUsesItem) {
  ...
  **/
  ...
  public GBaseChatModelConfig features(List<FeaturesEnum> features) {
    this.features = features;
    return this;
  }

  public GBaseChatModelConfig addFeaturesItem(FeaturesEnum featuresItem) {
  ...
  **/
  ...
  public GBaseChatModelConfig thinking(ThinkingEnum thinking) {
  ...
  **/
  ...
  public GBaseChatModelConfig maxGeneratedTokens(Integer maxGeneratedTokens) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GBaseChatModelConfig gbaseChatModelConfig = (GBaseChatModelConfig) o;
    return Objects.equals(this.code, gbaseChatModelConfig.code) &&
        Objects.equals(this.description, gbaseChatModelConfig.description) &&
        Objects.equals(this.userModified, gbaseChatModelConfig.userModified) &&
        Objects.equals(this.userCreated, gbaseChatModelConfig.userCreated) &&
        Objects.equals(this.dateModified, gbaseChatModelConfig.dateModified) &&
        Objects.equals(this.dateCreated, gbaseChatModelConfig.dateCreated) &&
        Objects.equals(this.modelTypeCode, gbaseChatModelConfig.modelTypeCode) &&
        Objects.equals(this.defaultModel, gbaseChatModelConfig.defaultModel) &&
        Objects.equals(this.apiSecretCode, gbaseChatModelConfig.apiSecretCode) &&
        Objects.equals(this.choosedModel, gbaseChatModelConfig.choosedModel) &&
        Objects.equals(this.baseUrl, gbaseChatModelConfig.baseUrl) &&
        Objects.equals(this.contextLength, gbaseChatModelConfig.contextLength) &&
        Objects.equals(this.topP, gbaseChatModelConfig.topP) &&
        ...
        Objects.equals(this.features, gbaseChatModelConfig.features) &&
        Objects.equals(this.thinking, gbaseChatModelConfig.thinking) &&
        Objects.equals(this.maxGeneratedTokens, gbaseChatModelConfig.maxGeneratedTokens);
  }
  ...
  public String toString() {
    ...
    sb.append("class GBaseChatModelConfig {\n");
