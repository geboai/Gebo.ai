...
public class GOpenAIChatModelConfig {
  @JsonProperty("code")
  ...
  private GOpenAIChatModelChoice choosedModel = null;
  ...
  public GOpenAIChatModelConfig code(String code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public GOpenAIChatModelConfig description(String description) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig userModified(String userModified) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig userCreated(String userCreated) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig dateModified(Date dateModified) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig dateCreated(Date dateCreated) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig modelTypeCode(String modelTypeCode) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig defaultModel(Boolean defaultModel) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig apiSecretCode(String apiSecretCode) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig choosedModel(GOpenAIChatModelChoice choosedModel) {
  ...
  **/
  @Schema(description = "")
  public GOpenAIChatModelChoice getChoosedModel() {
    return choosedModel;
  }

  public void setChoosedModel(GOpenAIChatModelChoice choosedModel) {
    this.choosedModel = choosedModel;
  }

  public GOpenAIChatModelConfig baseUrl(String baseUrl) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig contextLength(Integer contextLength) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig topP(Double topP) {
    this.topP = topP;
    return this;
  }
  ...
  **/
  ...
  public GOpenAIChatModelConfig accessibleGroups(List<String> accessibleGroups) {
    this.accessibleGroups = accessibleGroups;
    return this;
  }

  public GOpenAIChatModelConfig addAccessibleGroupsItem(String accessibleGroupsItem) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig accessibleUsers(List<String> accessibleUsers) {
    this.accessibleUsers = accessibleUsers;
    return this;
  }

  public GOpenAIChatModelConfig addAccessibleUsersItem(String accessibleUsersItem) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig accessibleToAll(Boolean accessibleToAll) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig aclAliases(List<Integer> aclAliases) {
    this.aclAliases = aclAliases;
    return this;
  }

  public GOpenAIChatModelConfig addAclAliasesItem(Integer aclAliasesItem) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig enabledFunctions(List<String> enabledFunctions) {
    this.enabledFunctions = enabledFunctions;
    return this;
  }

  public GOpenAIChatModelConfig addEnabledFunctionsItem(String enabledFunctionsItem) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig temperature(Double temperature) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig forUses(List<ForUsesEnum> forUses) {
    this.forUses = forUses;
    return this;
  }

  public GOpenAIChatModelConfig addForUsesItem(ForUsesEnum forUsesItem) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig features(List<FeaturesEnum> features) {
    this.features = features;
    return this;
  }

  public GOpenAIChatModelConfig addFeaturesItem(FeaturesEnum featuresItem) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig thinking(ThinkingEnum thinking) {
  ...
  **/
  ...
  public GOpenAIChatModelConfig maxGeneratedTokens(Integer maxGeneratedTokens) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GOpenAIChatModelConfig gopenAIChatModelConfig = (GOpenAIChatModelConfig) o;
    return Objects.equals(this.code, gopenAIChatModelConfig.code) &&
        Objects.equals(this.description, gopenAIChatModelConfig.description) &&
        Objects.equals(this.userModified, gopenAIChatModelConfig.userModified) &&
        Objects.equals(this.userCreated, gopenAIChatModelConfig.userCreated) &&
        Objects.equals(this.dateModified, gopenAIChatModelConfig.dateModified) &&
        Objects.equals(this.dateCreated, gopenAIChatModelConfig.dateCreated) &&
        Objects.equals(this.modelTypeCode, gopenAIChatModelConfig.modelTypeCode) &&
        Objects.equals(this.defaultModel, gopenAIChatModelConfig.defaultModel) &&
        Objects.equals(this.apiSecretCode, gopenAIChatModelConfig.apiSecretCode) &&
        Objects.equals(this.choosedModel, gopenAIChatModelConfig.choosedModel) &&
        Objects.equals(this.baseUrl, gopenAIChatModelConfig.baseUrl) &&
        Objects.equals(this.contextLength, gopenAIChatModelConfig.contextLength) &&
        Objects.equals(this.topP, gopenAIChatModelConfig.topP) &&
        Objects.equals(this.accessibleGroups, gopenAIChatModelConfig.accessibleGroups) &&
        Objects.equals(this.accessibleUsers, gopenAIChatModelConfig.accessibleUsers) &&
        Objects.equals(this.accessibleToAll, gopenAIChatModelConfig.accessibleToAll) &&
        Objects.equals(this.aclAliases, gopenAIChatModelConfig.aclAliases) &&
        Objects.equals(this.enabledFunctions, gopenAIChatModelConfig.enabledFunctions) &&
        Objects.equals(this.temperature, gopenAIChatModelConfig.temperature) &&
        Objects.equals(this.forUses, gopenAIChatModelConfig.forUses) &&
        Objects.equals(this.features, gopenAIChatModelConfig.features) &&
        Objects.equals(this.thinking, gopenAIChatModelConfig.thinking) &&
        Objects.equals(this.maxGeneratedTokens, gopenAIChatModelConfig.maxGeneratedTokens);
  }
  ...
  public String toString() {
    ...
    sb.append("class GOpenAIChatModelConfig {\n");
