...
@Component("ai.gebo.monolithic.api.client.api.PromptTemplateWizardControllerApi")
public class PromptTemplateWizardControllerApi {
    private ApiClient apiClient;

    public PromptTemplateWizardControllerApi() {
        this(new ApiClient());
    }

    @Autowired
    public PromptTemplateWizardControllerApi(ApiClient apiClient) {
     ...
     * <p><b>200</b> - OK
     * @param body  (required)
     * @return OperationStatusPromptTemplateResponse
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public OperationStatusPromptTemplateResponse generatePromptTemplate(PromptTemplateParam body) throws RestClientException {
        return generatePromptTemplateWithHttpInfo(body).getBody();
    }
     ...
     * <p><b>200</b> - OK
     * @param body  (required)
     * @return ResponseEntity&lt;OperationStatusPromptTemplateResponse&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<OperationStatusPromptTemplateResponse> generatePromptTemplateWithHttpInfo(PromptTemplateParam body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling generatePromptTemplate");
        }
        String path = UriComponentsBuilder.fromPath("/api/users/PromptTemplateWizardController/generatePromptTemplate").build().toUriString();
