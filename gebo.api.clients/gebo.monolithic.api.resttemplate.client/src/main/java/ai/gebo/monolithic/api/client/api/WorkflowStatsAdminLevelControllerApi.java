...
import ai.gebo.monolithic.api.client.model.WorkflowStatsDrillDownLevel;
import ai.gebo.monolithic.api.client.model.WorkflowStatsDrillDownResult;
...
public class WorkflowStatsAdminLevelControllerApi {
    ...
    public ResponseEntity<WorkflowStatsDrillDownResult> workflowDrillDownWithHttpInfo(WorkflowStatsDrillDownLevel body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/WorkflowStatsAdminLevelController/drillDown").build().toUriString();
