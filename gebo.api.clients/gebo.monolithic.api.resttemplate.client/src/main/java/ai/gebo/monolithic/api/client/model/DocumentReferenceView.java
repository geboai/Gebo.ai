...
public class DocumentReferenceView {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(contentType, name, extension, description, creationDate, messagingModuleId, deleted, code, parentVirtualFolderCode, relativePath, parentProjectCode, rootKnowledgebaseCode, modificationDate);
  }
