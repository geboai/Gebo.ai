...
public class DocumentReferenceView {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(contentType, name, extension, rootKnowledgebaseCode, parentVirtualFolderCode, parentProjectCode, creationDate, description, messagingModuleId, code, modificationDate, deleted, relativePath);
  }
