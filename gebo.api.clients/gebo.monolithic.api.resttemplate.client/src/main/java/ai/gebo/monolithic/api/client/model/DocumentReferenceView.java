...
public class DocumentReferenceView {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, extension, contentType, code, description, deleted, messagingModuleId, relativePath, parentVirtualFolderCode, creationDate, rootKnowledgebaseCode, parentProjectCode, modificationDate);
  }
