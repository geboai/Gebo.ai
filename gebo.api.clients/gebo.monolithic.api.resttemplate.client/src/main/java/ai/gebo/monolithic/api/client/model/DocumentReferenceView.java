...
public class DocumentReferenceView {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, code, rootKnowledgebaseCode, parentProjectCode, creationDate, deleted, modificationDate, name, extension, contentType, parentVirtualFolderCode, relativePath, messagingModuleId);
  }
