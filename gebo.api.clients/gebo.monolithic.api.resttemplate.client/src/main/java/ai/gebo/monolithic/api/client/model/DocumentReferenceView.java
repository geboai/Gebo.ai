...
public class DocumentReferenceView {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, extension, contentType, description, code, creationDate, modificationDate, messagingModuleId, deleted, parentVirtualFolderCode, parentProjectCode, relativePath, rootKnowledgebaseCode);
  }
