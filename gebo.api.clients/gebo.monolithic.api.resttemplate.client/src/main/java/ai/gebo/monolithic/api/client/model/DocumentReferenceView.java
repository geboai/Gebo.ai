...
public class DocumentReferenceView {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, extension, contentType, code, description, messagingModuleId, parentProjectCode, rootKnowledgebaseCode, parentVirtualFolderCode, relativePath, deleted, modificationDate, creationDate);
  }
