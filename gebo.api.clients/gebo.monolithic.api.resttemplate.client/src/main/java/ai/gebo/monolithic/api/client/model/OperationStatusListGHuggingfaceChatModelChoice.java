...
public class OperationStatusListGHuggingfaceChatModelChoice {
  @JsonProperty("result")
  private List<GHuggingfaceChatModelChoice> result = null;
  ...
  public OperationStatusListGHuggingfaceChatModelChoice addResultItem(GHuggingfaceChatModelChoice resultItem) {
    if (this.result == null) {
  ...
  **/
  @Schema(description = "")
  public List<GHuggingfaceChatModelChoice> getResult() {
    return result;
  }

  public void setResult(List<GHuggingfaceChatModelChoice> result) {
    this.result = result;
  }

  public OperationStatusListGHuggingfaceChatModelChoice messages(List<GUserMessage> messages) {
    this.messages = messages;
    return this;
  }

  public OperationStatusListGHuggingfaceChatModelChoice addMessagesItem(GUserMessage messagesItem) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class OperationStatusListGHuggingfaceChatModelChoice {\n");
