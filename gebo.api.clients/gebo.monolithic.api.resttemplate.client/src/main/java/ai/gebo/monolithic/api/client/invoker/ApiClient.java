...
import ai.gebo.monolithic.api.client.invoker.auth.Authentication;
import ai.gebo.monolithic.api.client.invoker.auth.HttpBasicAuth;
...
@Component("ai.gebo.monolithic.api.client.invoker.ApiClient")
public class ApiClient {
	...
	private String basePath = "http://localhost:12999";
