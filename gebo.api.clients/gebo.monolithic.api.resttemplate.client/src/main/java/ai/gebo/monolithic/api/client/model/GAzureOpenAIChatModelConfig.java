...
public class GAzureOpenAIChatModelConfig {
  @JsonProperty("code")
  ...
  private GAzureOpenAIChatModelChoice choosedModel = null;
  ...
  public GAzureOpenAIChatModelConfig code(String code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig description(String description) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig userModified(String userModified) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig userCreated(String userCreated) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig dateModified(Date dateModified) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig dateCreated(Date dateCreated) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig modelTypeCode(String modelTypeCode) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig defaultModel(Boolean defaultModel) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig apiSecretCode(String apiSecretCode) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig choosedModel(GAzureOpenAIChatModelChoice choosedModel) {
  ...
  **/
  @Schema(description = "")
  public GAzureOpenAIChatModelChoice getChoosedModel() {
    return choosedModel;
  }

  public void setChoosedModel(GAzureOpenAIChatModelChoice choosedModel) {
    this.choosedModel = choosedModel;
  }

  public GAzureOpenAIChatModelConfig baseUrl(String baseUrl) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig contextLength(Integer contextLength) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig topP(Double topP) {
    this.topP = topP;
    return this;
  }
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig accessibleGroups(List<String> accessibleGroups) {
    this.accessibleGroups = accessibleGroups;
    return this;
  }

  public GAzureOpenAIChatModelConfig addAccessibleGroupsItem(String accessibleGroupsItem) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig accessibleUsers(List<String> accessibleUsers) {
    this.accessibleUsers = accessibleUsers;
    return this;
  }

  public GAzureOpenAIChatModelConfig addAccessibleUsersItem(String accessibleUsersItem) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig accessibleToAll(Boolean accessibleToAll) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig enabledFunctions(List<String> enabledFunctions) {
    this.enabledFunctions = enabledFunctions;
    return this;
  }

  public GAzureOpenAIChatModelConfig addEnabledFunctionsItem(String enabledFunctionsItem) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig temperature(Double temperature) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig forUses(List<ForUsesEnum> forUses) {
    this.forUses = forUses;
    return this;
  }

  public GAzureOpenAIChatModelConfig addForUsesItem(ForUsesEnum forUsesItem) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig features(List<FeaturesEnum> features) {
    this.features = features;
    return this;
  }

  public GAzureOpenAIChatModelConfig addFeaturesItem(FeaturesEnum featuresItem) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig thinking(ThinkingEnum thinking) {
  ...
  **/
  ...
  public GAzureOpenAIChatModelConfig maxGeneratedTokens(Integer maxGeneratedTokens) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GAzureOpenAIChatModelConfig gazureOpenAIChatModelConfig = (GAzureOpenAIChatModelConfig) o;
    return Objects.equals(this.code, gazureOpenAIChatModelConfig.code) &&
        Objects.equals(this.description, gazureOpenAIChatModelConfig.description) &&
        Objects.equals(this.userModified, gazureOpenAIChatModelConfig.userModified) &&
        Objects.equals(this.userCreated, gazureOpenAIChatModelConfig.userCreated) &&
        Objects.equals(this.dateModified, gazureOpenAIChatModelConfig.dateModified) &&
        Objects.equals(this.dateCreated, gazureOpenAIChatModelConfig.dateCreated) &&
        Objects.equals(this.modelTypeCode, gazureOpenAIChatModelConfig.modelTypeCode) &&
        Objects.equals(this.defaultModel, gazureOpenAIChatModelConfig.defaultModel) &&
        Objects.equals(this.apiSecretCode, gazureOpenAIChatModelConfig.apiSecretCode) &&
        Objects.equals(this.choosedModel, gazureOpenAIChatModelConfig.choosedModel) &&
        Objects.equals(this.baseUrl, gazureOpenAIChatModelConfig.baseUrl) &&
        Objects.equals(this.contextLength, gazureOpenAIChatModelConfig.contextLength) &&
        Objects.equals(this.topP, gazureOpenAIChatModelConfig.topP) &&
        Objects.equals(this.accessibleGroups, gazureOpenAIChatModelConfig.accessibleGroups) &&
        Objects.equals(this.accessibleUsers, gazureOpenAIChatModelConfig.accessibleUsers) &&
        Objects.equals(this.accessibleToAll, gazureOpenAIChatModelConfig.accessibleToAll) &&
        Objects.equals(this.enabledFunctions, gazureOpenAIChatModelConfig.enabledFunctions) &&
        Objects.equals(this.temperature, gazureOpenAIChatModelConfig.temperature) &&
        Objects.equals(this.forUses, gazureOpenAIChatModelConfig.forUses) &&
        Objects.equals(this.features, gazureOpenAIChatModelConfig.features) &&
        Objects.equals(this.thinking, gazureOpenAIChatModelConfig.thinking) &&
        Objects.equals(this.maxGeneratedTokens, gazureOpenAIChatModelConfig.maxGeneratedTokens);
  }
  ...
  public String toString() {
    ...
    sb.append("class GAzureOpenAIChatModelConfig {\n");
