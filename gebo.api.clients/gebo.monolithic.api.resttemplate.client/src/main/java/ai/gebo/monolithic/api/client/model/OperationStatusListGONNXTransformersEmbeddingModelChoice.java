...
public class OperationStatusListGONNXTransformersEmbeddingModelChoice {
  @JsonProperty("result")
  private List<GONNXTransformersEmbeddingModelChoice> result = null;
  ...
  public OperationStatusListGONNXTransformersEmbeddingModelChoice addResultItem(GONNXTransformersEmbeddingModelChoice resultItem) {
    if (this.result == null) {
  ...
  **/
  @Schema(description = "")
  public List<GONNXTransformersEmbeddingModelChoice> getResult() {
    return result;
  }

  public void setResult(List<GONNXTransformersEmbeddingModelChoice> result) {
    this.result = result;
  }

  public OperationStatusListGONNXTransformersEmbeddingModelChoice messages(List<GUserMessage> messages) {
    this.messages = messages;
    return this;
  }

  public OperationStatusListGONNXTransformersEmbeddingModelChoice addMessagesItem(GUserMessage messagesItem) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class OperationStatusListGONNXTransformersEmbeddingModelChoice {\n");
