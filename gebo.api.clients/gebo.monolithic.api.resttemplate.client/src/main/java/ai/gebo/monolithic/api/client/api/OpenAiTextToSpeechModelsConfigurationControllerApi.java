...
public class OpenAiTextToSpeechModelsConfigurationControllerApi {
    ...
    public ResponseEntity<OperationStatusBoolean> deleteOpenAITextToSpeechModelConfigWithHttpInfo(GOpenAITextToSpeechModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OpenAITextToSpeechModelsConfigurationController/deleteOpenAITextToSpeechModelConfig").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GOpenAITextToSpeechModelConfig findOpenAITextToSpeechModelConfigByCode(String code) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GOpenAITextToSpeechModelConfig> findOpenAITextToSpeechModelConfigByCodeWithHttpInfo(String code) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OpenAITextToSpeechModelsConfigurationController/findOpenAITextToSpeechModelConfigByCode").build().toUriString();
    ...
    public ResponseEntity<OperationStatusListGOpenAITextToSpeechModelChoice> getOpenAITextToSpeechModelsWithHttpInfo(GOpenAITextToSpeechModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OpenAITextToSpeechModelsConfigurationController/getOpenAITextToSpeechModels").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGOpenAITextToSpeechModelConfig> insertOpenAITextToSpeechModelConfigWithHttpInfo(GOpenAITextToSpeechModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OpenAITextToSpeechModelsConfigurationController/insertOpenAITextToSpeechModelConfig").build().toUriString();
    ...
    public ResponseEntity<OperationStatusGOpenAITextToSpeechModelConfig> updateOpenAITextToSpeechModelConfigWithHttpInfo(GOpenAITextToSpeechModelConfig body) throws RestClientException {
        ...
        String localVarPath = UriComponentsBuilder.fromPath("/api/admin/OpenAITextToSpeechModelsConfigurationController/updateOpenAITextToSpeechModelConfig").build().toUriString();
