...
import { GeboAIViewTableComponent } from "./view-table.component";
/**
...
@NgModule({
  ...
  declarations:[GeboAIViewTableComponent],
  exports:[GeboAIViewTableComponent]
})
export class GeboAIViewTableModule{}