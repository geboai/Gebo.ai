...
@Component({
    ...
    standalone: false,
    // Give each gebo-ai-field label the weight of a compact section header. Scoped with :host so
    // it only affects fields rendered inside this wizard (and its step components), never
    // gebo-ai-field elsewhere. Whitespace provides separation without repeated decorative rules.
    styles: [`
        :host ::ng-deep gebo-ai-field > div > label {
            ...
            font-size: var(--gebo-font-size-lg, 1rem);
