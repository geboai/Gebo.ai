...
import { GJiraSystem, JiraSystemsControllerService } from '@Gebo.ai/jira';
...
@Component({
  ...
  standalone: false,
  providers: [{ provide: GEBO_AI_FIELD_HOST, multi: false, useValue: fieldHostComponentName("JiraWizardComponent") }]
})
