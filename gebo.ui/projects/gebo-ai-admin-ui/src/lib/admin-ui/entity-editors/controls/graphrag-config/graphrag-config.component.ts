...
@Component({
    ...
    standalone: false,
    providers: [
        { provide: GEBO_AI_FIELD_HOST, multi: false, useValue: fieldHostComponentName("GeboAIGraphragConfigComponent") }, 
        { provide: GEBO_AI_MODULE, useValue: "GeboAIGraphRagConfigModule", multi: false }]
})
