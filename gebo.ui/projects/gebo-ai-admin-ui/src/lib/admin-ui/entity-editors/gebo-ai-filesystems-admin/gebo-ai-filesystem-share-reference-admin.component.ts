...
import { BrowseParam, FileSystemSharesSettingControllerService, GFileSystemShareReference } from '@Gebo.ai/filesystem';
import { BaseEntityEditingComponent, browsePathObservableCallback, GEBO_AI_FIELD_HOST, GEBO_AI_MODULE, GeboFormGroupsService, GeboUIActionRoutingService, GeboUIOutputForwardingService, loadRootsObservableCallback, reconstructNavigationObservableCallback, VFilesystemReference } from "@Gebo.ai/reusable-ui";
...
@Component({
    ...
    standalone: false, providers: [
        ...
        {  provide: GEBO_AI_FIELD_HOST, useExisting: forwardRef(() => GeboAIGFileSystemShareReferenceAdminComponent),
           multi: false   }]
})
