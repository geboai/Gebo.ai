...
import { BaseEntityEditingComponent, EnrichedChild, GEBO_AI_FIELD_HOST, GeboAIPluggableKnowledgeAdminBaseTreeSearchService, GeboFormGroupsService, GeboUIActionRoutingService, GeboUIOutputForwardingService } from "@Gebo.ai/reusable-ui";
...
@Component({
    ...
    provide: GEBO_AI_FIELD_HOST, useExisting: forwardRef(() => GeboAiProjectAdminComponent),
    multi: true
  }]
})
