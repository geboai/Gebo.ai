...
@NgModule({
  ...
  exports: [GeboAiAdminComponent, GeboAiEntityEditingLauncherComponent, GeboAIUsersManagementComponent, GeboAIConfluenceSystemFastComponent, GeboAISharepointSystemFastComponent, GeboAIGoogleDriveFastComponent, GeboAIJiraSystemFastComponent, GeboAIGenericOpenaAIAPiRankerAdminComponent],
