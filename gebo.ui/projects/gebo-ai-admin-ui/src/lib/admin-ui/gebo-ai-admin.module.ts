...
import { PromptsPanelComponent } from "./main-panels/prompts-panel/prompts-panel.component";
...
import { PromptEditingModule } from "@Gebo.ai/reusable-ui";
...
import { GeboAIWebdavAdminComponent } from "./entity-editors/gebo-ai-webdav-client-admin/gebo-ai-webdav-system-admin.component";
import { GeboAIWebdavEndpointComponent } from "./entity-editors/gebo-ai-webdav-client-admin/gebo-ai-webdav-endpoint.component";
import { GeboAIWebdavSystemFastComponent } from "./entity-editors/gebo-ai-webdav-client-admin/gebo-ai-webdav-system-fast.component";
...
import { GeboAIA2AClientAdminComponent } from "./entity-editors/gebo-ai-a2a-client-admin/gebo-ai-a2a-client-admin.component";
import { GeboAIA2AServerAdminComponent } from "./entity-editors/gebo-ai-a2a-server-admin/gebo-ai-a2a-server-admin.component";
...
import { ComplianceComponent } from "./main-panels/compliance/compliance.component";
import { DataEndpointNodeComponent } from "./main-panels/compliance/data-endpoint-node.component";
import { DataTransformationNodeComponent } from "./main-panels/compliance/data-transformation-node.component";
    ...
    return {
      ...
      providers: [
        ...
        [
          ...
          { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GPromptConfig', entityAliases: ['ai.gebo.architecture.ai.model.GPromptTemplateConfig', 'ai.gebo.architecture.ai.model.GPromptConfig'], entityUI: GeboAIPromptAdminComponent } as GeboUIEntityFormConfig, multi: true },
          ...
          { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GWebdavProjectEndpoint', entityAliases: ['ai.gebo.webdavcms.handler.GWebdavProjectEndpoint'], entityUI: GeboAIWebdavEndpointComponent } as GeboUIEntityFormConfig, multi: true },
          { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GWebdavContentManagementSystem', entityAliases: ['ai.gebo.webdavcms.handler.GWebdavContentManagementSystem'], entityUI: GeboAIWebdavAdminComponent } as GeboUIEntityFormConfig, multi: true },
          ...
          { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: "A2ARemoteAgentConfig", entityUI: GeboAIA2AClientAdminComponent } as GeboUIEntityFormConfig, multi: true },
          { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: "A2AServerConfig", entityUI: GeboAIA2AServerAdminComponent } as GeboUIEntityFormConfig, multi: true },
