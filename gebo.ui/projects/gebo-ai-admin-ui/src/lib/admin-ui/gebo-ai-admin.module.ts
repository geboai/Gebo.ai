...
import { GeboAIAzureOpenAIEmbedModelAdminComponent } from "./entity-editors/gebo-ai-models-admin/gebo-ai-azure-openai-embedmodel-admin.component";
import { GeboAIAzureOpenAIChatModelAdminComponent } from "./entity-editors/gebo-ai-models-admin/gebo-ai-azure-openai-chatmodel-admin.component";
...
@NgModule({
  ...
  exports: [GeboAiAdminComponent, GeboAiEntityEditingLauncherComponent, GeboAIUsersManagementComponent, GeboAIConfluenceSystemFastComponent, GeboAISharepointSystemFastComponent, GeboAIGoogleDriveFastComponent, GeboAIJiraSystemFastComponent, GeboAIGenericOpenaAIAPiRankerAdminComponent, GeboAIConfluenceAdminComponent, GeboAiGitSystemAdminComponent, GeboAIGraphRagExtractionConfigComponent, GeboAiGitEndpointAdminComponent, GeboAIJiraEndpointComponent, GeboAIConfluenceEndpointComponent, GeboAIJiraAdminComponent, GeboAIDeepSearchConfigAdminComponent, GeboAiSecretsAdminEditComponent, GeboAISharepointEndpointComponent, GeboAIUploadsEndpointComponent, GeboAIGroupComponent, GeboAIPromptAdminComponent, GeboAIAnthropicChatModelAdminComponent, GeboAISharepointAdminComponent, GeboAIAzureOpenAIChatModelAdminComponent, GeboAIAzureOpenAIEmbedModelAdminComponent, GeboAIDeepseekChatModelAdminComponent, GeboAIGenericOpenAIAPIChatModelAdminComponent, GeboAIGenericOpenAIAPIEmbedModelAdminComponent, GeboAIGoogleVertexChatModelAdminComponent, GeboAIGoogleVertexEmbedModelAdminComponent, GeboAIOauth2RegistrationComponent, GeboAiKnowledgeBaseAdminComponent, GeboAIOllamaChatModelAdminComponent, GeboAIOllamaEmbedModelAdminComponent, GeboAiProjectAdminComponent, GeboAIOpenAIChatModelAdminComponent, GeboAIOpenAIEmbedModelAdminComponent, GeboAIJobStatusViewerComponent, GeboAIMistralAIEmbedModelAdminComponent, GeboAIMistralAIChatModelAdminComponent, GeboAiGoogleDriveProjectEndpointAdminComponent, GeboAIFileSystemEndpointComponent, GeboAIGFileSystemShareReferenceAdminComponent, GeboAIGoogleSearchAccountComponent, GeboAIChatProfileAdminComponent, GeboAiGoogleDriveSystemAdminComponent],
  providers: [GeboAIPluggableKnowledgeAdminBaseTreeSearchService, { provide: GEBO_AI_MODULE, useValue: "GeboAIAdminModule", multi: false }]
})
  ...
  static forRoot(): ModuleWithProviders<GeboAiAdminModule> {
    return {
      ...
      providers: [
        ...
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GConfluenceProjectEndpoint', entityUI: GeboAIConfluenceEndpointComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GJiraSystem', entityUI: GeboAIJiraAdminComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'DeepSearchConfig', entityUI: GeboAIDeepSearchConfigAdminComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'SecretWrapper', entityUI: GeboAiSecretsAdminEditComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GSharepointProjectEndpoint', entityUI: GeboAISharepointEndpointComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GUploadsProjectEndpoint', entityUI: GeboAIUploadsEndpointComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'UsersGroup', entityUI: GeboAIGroupComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GPromptConfig', entityUI: GeboAIPromptAdminComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GAnthropicChatModelConfig', entityUI: GeboAIAnthropicChatModelAdminComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GSharepointContentManagementSystem', entityUI: GeboAISharepointAdminComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GAzureOpenAIChatModelConfig', entityUI: GeboAIAzureOpenAIChatModelAdminComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GAzureOpenAIEmbeddingModelConfig', entityUI: GeboAIAzureOpenAIEmbedModelAdminComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GDeepseekChatModelConfig', entityUI: GeboAIDeepseekChatModelAdminComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GenericOpenAIAPIChatModelConfig', entityUI: GeboAIGenericOpenAIAPIChatModelAdminComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GenericOpenAIAPIEmbeddingModelConfig', entityUI: GeboAIGenericOpenAIAPIEmbedModelAdminComponent } as GeboUIEntityFormConfig, multi: true },
        ...
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GProject', entityUI: GeboAiProjectAdminComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GOpenAIChatModelConfig', entityUI: GeboAIOpenAIChatModelAdminComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GOpenAIEmbeddingModelConfig', entityUI: GeboAIOpenAIEmbedModelAdminComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GJobStatus', entityUI: GeboAIJobStatusViewerComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GMistralEmbeddingModelConfig', entityUI: GeboAIMistralAIEmbedModelAdminComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GMistralChatModelConfig', entityUI: GeboAIMistralAIChatModelAdminComponent } as GeboUIEntityFormConfig, multi: true },
        { provide: GEBO_UI_ENTITY_FORM_TOKEN, useValue: { entityName: 'GGoogleDriveProjectEndpoint', entityUI: GeboAiGoogleDriveProjectEndpointAdminComponent } as GeboUIEntityFormConfig, multi: true },
