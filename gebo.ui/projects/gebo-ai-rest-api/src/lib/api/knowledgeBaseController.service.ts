...
@Injectable()
export class KnowledgeBaseControllerService {
     ...
     */
    public deleteKnowledgeBase(body: GKnowledgeBase, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public deleteKnowledgeBase(body: GKnowledgeBase, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public deleteKnowledgeBase(body: GKnowledgeBase, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public deleteKnowledgeBase(body: GKnowledgeBase, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling deleteKnowledgeBase.');
        }
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/api/admin/KnowledgeBaseController/deleteKnowledgeBase`,
            {
                body: body,
    ...
    public findKnowledgeBaseByCode(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<GKnowledgeBase>('get',`${this.basePath}/api/admin/KnowledgeBaseController/findKnowledgeBaseByCode`,
            {
    ...
    public findKnowledgeBasesByQbe(body: GKnowledgeBase, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling findKnowledgeBasesByQbe.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public insertKnowledgeBase(body: GKnowledgeBase, observe?: 'body', reportProgress?: boolean): Observable<GKnowledgeBase>;
    public insertKnowledgeBase(body: GKnowledgeBase, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GKnowledgeBase>>;
    public insertKnowledgeBase(body: GKnowledgeBase, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GKnowledgeBase>>;
    public insertKnowledgeBase(body: GKnowledgeBase, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling insertKnowledgeBase.');
        }
        ...
        return this.httpClient.request<GKnowledgeBase>('post',`${this.basePath}/api/admin/KnowledgeBaseController/insertKnowledgeBase`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateKnowledgeBase(body: GKnowledgeBase, observe?: 'body', reportProgress?: boolean): Observable<GKnowledgeBase>;
    public updateKnowledgeBase(body: GKnowledgeBase, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GKnowledgeBase>>;
    public updateKnowledgeBase(body: GKnowledgeBase, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GKnowledgeBase>>;
    public updateKnowledgeBase(body: GKnowledgeBase, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling updateKnowledgeBase.');
        }
        ...
        return this.httpClient.request<GKnowledgeBase>('post',`${this.basePath}/api/admin/KnowledgeBaseController/updateKnowledgeBase`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
