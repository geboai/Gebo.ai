...
export class ContentMetaInfosControllerService {
    ...
    public getContentMetaInfos(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<ContentMetaInfo>('get',`${this.basePath}/api/users/ContentMetaInfosController/getContentMetaInfos`,
            {
    ...
    public getContentObject(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<ContentObject>('get',`${this.basePath}/api/users/ContentMetaInfosController/getContentObject`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public searchByDocumentName(body: SearchDocumentByNameParam, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling searchByDocumentName.');
        }
    ...
    public searchByDocumentNamePaged(body: SearchDocumentByNamePagedParam, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling searchByDocumentNamePaged.');
        }
