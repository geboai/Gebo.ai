...
@Injectable()
export class GeboLlmGeneratedResourceControllerService {
    ...
    public serveLLMGeneratedContent(userSessionCode: string, generatedResourceCode: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (generatedResourceCode === null || generatedResourceCode === undefined) {
            throw new Error('Required parameter generatedResourceCode was null or undefined when calling serveLLMGeneratedContent.');
        }
        ...
        return this.httpClient.request<any>('get',`${this.basePath}/api/users/GeboLLMGeneratedResourceController/serveLLMGeneratedContent/${encodeURIComponent(String(userSessionCode))}/${encodeURIComponent(String(generatedResourceCode))}`,
            {
