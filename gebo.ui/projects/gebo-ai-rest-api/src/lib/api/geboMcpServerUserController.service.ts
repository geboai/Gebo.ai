...
@Injectable()
export class GeboMcpServerUserControllerService {
    ...
    public findAccessibleMcpServerByCode(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<UserAccessibleMcpServerView>('get',`${this.basePath}/api/user/GeboMCPServerUserController/findAccessibleMcpServerByCode`,
            {
