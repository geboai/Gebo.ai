...
@Injectable()
export class GeboUserKnowledgeBaseSemanticSearchControllerService {
    ...
    public semanticSearch(body: SemanticQueryParam, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling semanticSearch.');
        }
