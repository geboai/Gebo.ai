...
@Injectable()
export class JiraBrowsingControllerService {
    ...
    public browseJiraPath(body: BrowseParam, systemCode: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (systemCode === null || systemCode === undefined) {
            throw new Error('Required parameter systemCode was null or undefined when calling browseJiraPath.');
        }
        ...
        return this.httpClient.request<OperationStatusListPathInfo>('post',`${this.basePath}/api/admin/JiraBrowsingController/browseJiraPath`,
            {
                body: body,
    ...
    public getJiraNavigationStatus(body: Array<VFilesystemReference>, systemCode: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (systemCode === null || systemCode === undefined) {
            throw new Error('Required parameter systemCode was null or undefined when calling getJiraNavigationStatus.');
        }
        ...
        return this.httpClient.request<OperationStatusListVirtualFilesystemNavigationTreeStatus>('post',`${this.basePath}/api/admin/JiraBrowsingController/getJiraNavigationStatus`,
            {
                body: body,
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
    ...
    public getJiraRoots(systemCode: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<OperationStatusListGVirtualFilesystemRoot>('get',`${this.basePath}/api/admin/JiraBrowsingController/getJiraRoots`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
