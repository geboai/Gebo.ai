...
export class UserControllerService {
     ...
     */
    public changePassword(body: ChangePasswordParam, observe?: 'body', reportProgress?: boolean): Observable<ChangePasswordResponse>;
    public changePassword(body: ChangePasswordParam, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ChangePasswordResponse>>;
    public changePassword(body: ChangePasswordParam, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ChangePasswordResponse>>;
    public changePassword(body: ChangePasswordParam, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<ChangePasswordResponse>('post',`${this.basePath}/api/users/ActualUserController/changePassword`,
            {
                body: body,
    ...
    public getCurrentUser(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<UserInfo>('get',`${this.basePath}/api/users/ActualUserController/me`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
