...
export class GeboTranscriptControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public transcriptText(observe?: 'body', reportProgress?: boolean): Observable<TranscriptResponse>;
    public transcriptText(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<TranscriptResponse>>;
    public transcriptText(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<TranscriptResponse>>;
    public transcriptText(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<TranscriptResponse>('post',`${this.basePath}/api/users/GeboTranscriptController/transcriptText`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
