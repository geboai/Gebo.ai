...
export class GeboCoreAnalisysControllerService {
     ...
     */
    public drillDown(body: GStatsHolder, observe?: 'body', reportProgress?: boolean): Observable<Array<GStatsHolder>>;
    public drillDown(body: GStatsHolder, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<GStatsHolder>>>;
    public drillDown(body: GStatsHolder, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<GStatsHolder>>>;
    public drillDown(body: GStatsHolder, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
