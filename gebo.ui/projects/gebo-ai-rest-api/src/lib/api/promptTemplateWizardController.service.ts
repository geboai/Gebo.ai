...
@Injectable()
export class PromptTemplateWizardControllerService {
     ...
     */
    public generatePromptTemplate(body: PromptTemplateParam, observe?: 'body', reportProgress?: boolean): Observable<OperationStatusPromptTemplateResponse>;
    public generatePromptTemplate(body: PromptTemplateParam, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<OperationStatusPromptTemplateResponse>>;
    public generatePromptTemplate(body: PromptTemplateParam, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<OperationStatusPromptTemplateResponse>>;
    public generatePromptTemplate(body: PromptTemplateParam, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling generatePromptTemplate.');
        }
