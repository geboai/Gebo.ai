...
@Injectable()
export class GeboAdminPromptUseInfoControllerService {
    ...
    public findByCode(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<GPromptUseInfo>('get',`${this.basePath}/api/admin/GeboAdminPromptUseController/findByCode`,
            {
