...
public interface DocumentReferenceRepository extends IGAbstractVirtualFilesystemObjectRepository<GDocumentReference> {
	...
	/**
	 * Finds a stream of GDocumentReference by matching a specific file archetype ID.
	 *
	...
	/**
	 * Finds a stream of GDocumentReference by matching both a file archetype ID and a list of root knowledgebase codes.
	 *
	 * @param fileArchetypeId The ID of the file archetype to match.
	 ...
	 */
	public Stream<GDocumentReference> findByGeboFileArchetypeIdAndRootKnowledgebaseCodeIn(
			String fileArchetypeId, List<String> rootKnowledgebaseCode);

	/**
	 * Finds a stream of GDocumentReference by matching a list of file archetype IDs and a list of root knowledgebase codes.
	 *
	...
	/**
	 * Counts GDocumentReference by matching the project endpoint's reference class name and code.
	 *
	...
	/**
	 * Finds a pageable result of DocumentReferenceView by matching root knowledgebase codes and a text criteria for name.
	 *
	 * @param rootKnowledgeBaseCode A list of root knowledgebase codes to match.
	 * @param textCriteria Text criteria to match against the name.
	 * @param pageable Pageable object to determine the pagination of results.
	...
	/**
	 * Finds a pageable result of DocumentReferenceView by matching root knowledgebase codes and if the name contains a specific text.
	 *
	 * @param rootKnowledgeBaseCode A list of root knowledgebase codes to match.
	 * @param name Name text fragment to match.
	 * @param pageable Pageable object to determine the pagination of results.
	 * @return A page of DocumentReferenceView with names containing the specified text.
	 */
	...
	/**
	 * Finds DocumentReferenceView by matching root knowledgebase codes and a text criteria for name.
	 *
	...
	/**
	 * Finds DocumentReferenceView by matching root knowledgebase codes and if the name contains a specific text.
	 *
	 * @param knowledgeBaseCodes A list of root knowledgebase codes to match.
	 * @param name Name text fragment to match.
	 * @return List of DocumentReferenceView with names containing the specified text.
	 */
	...
	/**
	 * Finds a stream of GDocumentReference by matching a parent virtual folder code and list of names.
	 *
