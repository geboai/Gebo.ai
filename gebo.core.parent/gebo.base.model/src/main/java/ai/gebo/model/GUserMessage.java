 ...
 * 
 * Represents a user message entity that can be stored in MongoDB.
 * This class provides functionality for creating and managing user messages 
 * with different severity levels, and includes factory methods for common message types.
 */
@Document
public class GUserMessage implements Serializable {
    ...
    @NotNull
    @Id
    private String id = null; // The unique identifier for the message
     ...
     */
    public GUserMessage(String id, String key, String summary, String detail, MsgServerity severity) {
        this.id = id;
        this.key = key;
    ...
    public static GUserMessage successMessage(String summary, String detail) {
        return new GUserMessage(UUID.randomUUID().toString(), "GUserMessage", summary, detail, MsgServerity.success);
    }
    ...
    public static GUserMessage errorMessage(String summary, String detail) {
        return new GUserMessage(UUID.randomUUID().toString(), "GUserMessage", summary, detail, MsgServerity.error);
    }
    ...
    public static GUserMessage errorMessage(String summary, Throwable th) {
        ...
        return new GUserMessage(UUID.randomUUID().toString(), "GUserMessage", summary,
                "Server error: " + th.getMessage(), MsgServerity.error);
    }
    ...
    public static GUserMessage infoMessage(String summary, String detail) {
        return new GUserMessage(UUID.randomUUID().toString(), "GUserMessage", summary, detail, MsgServerity.info);
    }
    ...
    public static GUserMessage warnMessage(String summary, String detail) {
        return new GUserMessage(UUID.randomUUID().toString(), "GUserMessage", summary, detail, MsgServerity.warn);
    }
