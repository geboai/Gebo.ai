 ...
 *
 * Represents the metadata of an extracted document within the system.
 * This class holds various properties related to the document's metadata such as code,
 * extension, original URL, project codes, content type, and more.
 */
public class ExtractedDocumentMetaData {
    ...
    /**
     * Constructs an instance of {@code ExtractedDocumentMetaData} with the specified attributes.
     *
     ...
     * @param parentProjectCode     the code of the parent project associated with the document
    ...
    /**
     * Retrieves a string value associated with the specified constant from the metadata map.
     *
     * @param constant the key to look up in the metadata
     * @param metadata the map containing metadata values
     * @return the value associated with the constant, or null if not found or metadata is null
     */
    ...
    /**
     * Retrieves a numeric value associated with the specified constant from the metadata map.
     *
     * @param constant the key to look up in the metadata
     * @param metadata the map containing metadata values
     * @return the numeric value associated with the constant, or null if not found, not a number, or metadata is null
     */
    ...
    /**
     * Creates an instance of {@code ExtractedDocumentMetaData} based on the provided metadata map.
     *
     * @param metadata a map containing metadata attributes for document creation
     * @return an instance of {@code ExtractedDocumentMetaData} or null if the metadata is null
     */
    ...
    /** @return the file extension of the document */
    public String getExtension() {
        return extension;
    }

    /** @return the original URL of the document */
    public String getOriginalUrl() {
        return originalUrl;
    }

    /** @return the parent project's code */
    ...
    /** @return the content type (MIME type) of the document */
    ...
    /** @return the token length of the document content */
    ...
    /** @return additional metadata header information */
    public String getMetaInfoHeader() {
        return metaInfoHeader;
    }

    /**
     * Determines if the document is enriched with additional metadata header information.
     *
     * @return true if the meta-info header is not null and contains characters, false otherwise
     */
