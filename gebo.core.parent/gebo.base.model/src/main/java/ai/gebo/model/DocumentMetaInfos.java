...
/**
 * AI generated comments The {@code DocumentMetaInfos} class contains a
 * collection of constant string values that represent various metadata keys
 * associated with documents. These keys are utilized to manage and organize
 * document attributes effectively.
 */
public class DocumentMetaInfos {
	 ...
	 */
	public static final List<String> ALL_ATTRIBUTES = List.of(CONTENT_CODE, CONTENT_PAGE, CONTENT_EXTENSION,
			...
			GEBO_EXTERNAL_SEARCH_RESULT_JSON, CATEGORIES);
