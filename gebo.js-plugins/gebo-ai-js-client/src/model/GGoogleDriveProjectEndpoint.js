...
/**
 * The GGoogleDriveProjectEndpoint model module.
 * @module model/GGoogleDriveProjectEndpoint
 * @version v0
 */
export default class GGoogleDriveProjectEndpoint {
  /**
   * Constructs a new <code>GGoogleDriveProjectEndpoint</code>.
   * @alias module:model/GGoogleDriveProjectEndpoint
   * @class
   * @param driveSystemCode {String} 
   */
  constructor(driveSystemCode) {
    this.driveSystemCode = driveSystemCode;
  }

  /**
   * Constructs a <code>GGoogleDriveProjectEndpoint</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GGoogleDriveProjectEndpoint} obj Optional instance to populate.
   * @return {module:model/GGoogleDriveProjectEndpoint} The populated <code>GGoogleDriveProjectEndpoint</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new GGoogleDriveProjectEndpoint();
      ...
      if (data.hasOwnProperty('driveSystemCode'))
        obj.driveSystemCode = ApiClient.convertToType(data['driveSystemCode'], 'String');
    }
    return obj;
  }
}
 ...
 * @member {String} code
 */
GGoogleDriveProjectEndpoint.prototype.code = undefined;

/**
 * @member {String} description
 */
GGoogleDriveProjectEndpoint.prototype.description = undefined;

/**
 * @member {String} userModified
 */
GGoogleDriveProjectEndpoint.prototype.userModified = undefined;

/**
 * @member {String} userCreated
 */
GGoogleDriveProjectEndpoint.prototype.userCreated = undefined;

/**
 * @member {Date} dateModified
 */
GGoogleDriveProjectEndpoint.prototype.dateModified = undefined;

/**
 * @member {Date} dateCreated
 */
GGoogleDriveProjectEndpoint.prototype.dateCreated = undefined;

/**
 * @member {String} parentProjectCode
 */
GGoogleDriveProjectEndpoint.prototype.parentProjectCode = undefined;

/**
 * @member {Boolean} readonly
 */
GGoogleDriveProjectEndpoint.prototype.readonly = undefined;

/**
 * @member {Boolean} published
 */
GGoogleDriveProjectEndpoint.prototype.published = undefined;

/**
 * @member {Boolean} synchPeriodically
 */
GGoogleDriveProjectEndpoint.prototype.synchPeriodically = undefined;

/**
 * @member {Boolean} openZips
 */
GGoogleDriveProjectEndpoint.prototype.openZips = undefined;

/**
 * @member {Array.<module:model/BuildSystemRef>} buildSystemsRefs
 */
GGoogleDriveProjectEndpoint.prototype.buildSystemsRefs = undefined;

/**
 * @member {String} catalogingCriteria
 */
GGoogleDriveProjectEndpoint.prototype.catalogingCriteria = undefined;

/**
 * @member {Array.<module:model/ReindexingProgrammedTable>} programmedTables
 */
GGoogleDriveProjectEndpoint.prototype.programmedTables = undefined;

/**
 * @member {Array.<String>} vectorizeOnlyExtensions
 */
GGoogleDriveProjectEndpoint.prototype.vectorizeOnlyExtensions = undefined;
 ...
 * @readonly
 */
GGoogleDriveProjectEndpoint.SynchroStrategyEnum = {
  /**
...
/**
 * @member {module:model/GGoogleDriveProjectEndpoint.SynchroStrategyEnum} synchroStrategy
 */
GGoogleDriveProjectEndpoint.prototype.synchroStrategy = undefined;
 ...
 * @readonly
 */
GGoogleDriveProjectEndpoint.ObjectSpaceTypeEnum = {
  /**
   * value: "COMPANY"
   * @const
   */
...
/**
 * @member {module:model/GGoogleDriveProjectEndpoint.ObjectSpaceTypeEnum} objectSpaceType
 */
GGoogleDriveProjectEndpoint.prototype.objectSpaceType = undefined;
 ...
 */
GGoogleDriveProjectEndpoint.prototype.paths = undefined;

/**
 * @member {String} driveSystemCode
 */
GGoogleDriveProjectEndpoint.prototype.driveSystemCode = undefined;
