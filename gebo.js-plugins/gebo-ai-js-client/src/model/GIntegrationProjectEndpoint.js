...
/**
 * The GIntegrationProjectEndpoint model module.
 * @module model/GIntegrationProjectEndpoint
 * @version v0
 */
export default class GIntegrationProjectEndpoint {
  /**
   * Constructs a new <code>GIntegrationProjectEndpoint</code>.
   * @alias module:model/GIntegrationProjectEndpoint
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>GIntegrationProjectEndpoint</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GIntegrationProjectEndpoint} obj Optional instance to populate.
   * @return {module:model/GIntegrationProjectEndpoint} The populated <code>GIntegrationProjectEndpoint</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new GIntegrationProjectEndpoint();
 ...
 * @member {String} code
 */
GIntegrationProjectEndpoint.prototype.code = undefined;

/**
 * @member {String} description
 */
GIntegrationProjectEndpoint.prototype.description = undefined;

/**
 * @member {String} userModified
 */
GIntegrationProjectEndpoint.prototype.userModified = undefined;

/**
 * @member {String} userCreated
 */
GIntegrationProjectEndpoint.prototype.userCreated = undefined;

/**
 * @member {Date} dateModified
 */
GIntegrationProjectEndpoint.prototype.dateModified = undefined;

/**
 * @member {Date} dateCreated
 */
GIntegrationProjectEndpoint.prototype.dateCreated = undefined;

/**
 * @member {String} parentProjectCode
 */
GIntegrationProjectEndpoint.prototype.parentProjectCode = undefined;

/**
 * @member {Boolean} readonly
 */
GIntegrationProjectEndpoint.prototype.readonly = undefined;

/**
 * @member {Boolean} published
 */
GIntegrationProjectEndpoint.prototype.published = undefined;

/**
 * @member {Boolean} synchPeriodically
 */
GIntegrationProjectEndpoint.prototype.synchPeriodically = undefined;

/**
 * @member {Boolean} openZips
 */
GIntegrationProjectEndpoint.prototype.openZips = undefined;

/**
 * @member {Array.<module:model/BuildSystemRef>} buildSystemsRefs
 */
GIntegrationProjectEndpoint.prototype.buildSystemsRefs = undefined;

/**
 * @member {String} catalogingCriteria
 */
GIntegrationProjectEndpoint.prototype.catalogingCriteria = undefined;

/**
 * @member {Array.<module:model/ReindexingProgrammedTable>} programmedTables
 */
GIntegrationProjectEndpoint.prototype.programmedTables = undefined;

/**
 * @member {Array.<String>} vectorizeOnlyExtensions
 */
GIntegrationProjectEndpoint.prototype.vectorizeOnlyExtensions = undefined;
 ...
 * @readonly
 */
GIntegrationProjectEndpoint.SynchroStrategyEnum = {
  /**
...
/**
 * @member {module:model/GIntegrationProjectEndpoint.SynchroStrategyEnum} synchroStrategy
 */
GIntegrationProjectEndpoint.prototype.synchroStrategy = undefined;
 ...
 * @readonly
 */
GIntegrationProjectEndpoint.ObjectSpaceTypeEnum = {
  /**
   * value: "COMPANY"
   * @const
   */
...
/**
 * @member {module:model/GIntegrationProjectEndpoint.ObjectSpaceTypeEnum} objectSpaceType
 */
GIntegrationProjectEndpoint.prototype.objectSpaceType = undefined;
 ...
 */
GIntegrationProjectEndpoint.prototype.allowedApplicationUsers = undefined;
