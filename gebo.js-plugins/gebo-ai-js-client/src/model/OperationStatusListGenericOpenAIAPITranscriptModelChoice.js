 ...
 * @module model/OperationStatusListGenericOpenAIAPITranscriptModelChoice
 * @version v0
 */
export default class OperationStatusListGenericOpenAIAPITranscriptModelChoice {
  /**
   * Constructs a new <code>OperationStatusListGenericOpenAIAPITranscriptModelChoice</code>.
   * @alias module:model/OperationStatusListGenericOpenAIAPITranscriptModelChoice
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>OperationStatusListGenericOpenAIAPITranscriptModelChoice</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OperationStatusListGenericOpenAIAPITranscriptModelChoice} obj Optional instance to populate.
   * @return {module:model/OperationStatusListGenericOpenAIAPITranscriptModelChoice} The populated <code>OperationStatusListGenericOpenAIAPITranscriptModelChoice</code> instance.
   */
