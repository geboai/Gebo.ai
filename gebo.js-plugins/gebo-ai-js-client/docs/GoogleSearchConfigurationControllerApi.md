# GeboAiClient.GoogleSearchConfigurationControllerApi
...
let apiInstance = new GeboAiClient.GoogleSearchConfigurationControllerApi();
let body = new GeboAiClient.GGoogleSearchApiCredentials(); // GGoogleSearchApiCredentials | 
...
let apiInstance = new GeboAiClient.GoogleSearchConfigurationControllerApi();
let body = new GeboAiClient.GoogleSearchConfig(); // GoogleSearchConfig | 
