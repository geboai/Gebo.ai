# GeboAiClient.McpClientConfigControllerApi
...
let apiInstance = new GeboAiClient.McpClientConfigControllerApi();
let body = new GeboAiClient.MCPClientConfig(); // MCPClientConfig | 
...
let apiInstance = new GeboAiClient.McpClientConfigControllerApi();
let body = new GeboAiClient.FindByMCPClientConfigQbeParam(); // FindByMCPClientConfigQbeParam | 
