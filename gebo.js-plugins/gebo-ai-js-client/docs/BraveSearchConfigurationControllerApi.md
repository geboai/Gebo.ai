# GeboAiClient.BraveSearchConfigurationControllerApi
...
let apiInstance = new GeboAiClient.BraveSearchConfigurationControllerApi();
let body = new GeboAiClient.GBraveSearchApiCredentials(); // GBraveSearchApiCredentials | 
...
let apiInstance = new GeboAiClient.BraveSearchConfigurationControllerApi();
let body = new GeboAiClient.BraveSearchConfig(); // BraveSearchConfig | 
