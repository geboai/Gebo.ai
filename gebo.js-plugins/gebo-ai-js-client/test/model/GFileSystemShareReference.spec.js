...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GFileSystemShareReference', function() {
      beforeEach(function() {
        instance = new GeboAiClient.GFileSystemShareReference();
      });

      it('should create an instance of GFileSystemShareReference', function() {
        // TODO: update the code to test GFileSystemShareReference
        expect(instance).to.be.a(GeboAiClient.GFileSystemShareReference);
      });
      ...
      it('should have the property mongoConfigured (base name: "mongoConfigured")', function() {
        // TODO: update the code to test the property mongoConfigured
        expect(instance).to.have.property('mongoConfigured');
        // expect(instance.mongoConfigured).to.be(expectedValueLiteral);
      });
