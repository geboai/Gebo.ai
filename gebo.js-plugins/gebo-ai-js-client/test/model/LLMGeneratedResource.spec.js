...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LLMGeneratedResource', function() {
      beforeEach(function() {
        instance = new GeboAiClient.LLMGeneratedResource();
      });

      it('should create an instance of LLMGeneratedResource', function() {
        // TODO: update the code to test LLMGeneratedResource
        expect(instance).to.be.a(GeboAiClient.LLMGeneratedResource);
      });
      ...
      it('should have the property tokensCount (base name: "tokensCount")', function() {
        // TODO: update the code to test the property tokensCount
        expect(instance).to.have.property('tokensCount');
        // expect(instance.tokensCount).to.be(expectedValueLiteral);
      });

      it('should have the property userContextCode (base name: "userContextCode")', function() {
        // TODO: update the code to test the property userContextCode
        expect(instance).to.have.property('userContextCode');
        // expect(instance.userContextCode).to.be(expectedValueLiteral);
      });
