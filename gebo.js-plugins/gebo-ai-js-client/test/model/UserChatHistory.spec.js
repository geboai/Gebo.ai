...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserChatHistory', function() {
      beforeEach(function() {
        instance = new GeboAiClient.UserChatHistory();
      });

      it('should create an instance of UserChatHistory', function() {
        // TODO: update the code to test UserChatHistory
        expect(instance).to.be.a(GeboAiClient.UserChatHistory);
      });
