...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GLookupEntry', function() {
      beforeEach(function() {
        instance = new GeboAiClient.GLookupEntry();
      });

      it('should create an instance of GLookupEntry', function() {
        // TODO: update the code to test GLookupEntry
        expect(instance).to.be.a(GeboAiClient.GLookupEntry);
      });
