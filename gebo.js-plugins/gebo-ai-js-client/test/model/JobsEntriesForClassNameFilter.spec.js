...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JobsEntriesForClassNameFilter', function() {
      beforeEach(function() {
        instance = new GeboAiClient.JobsEntriesForClassNameFilter();
      });

      it('should create an instance of JobsEntriesForClassNameFilter', function() {
        // TODO: update the code to test JobsEntriesForClassNameFilter
        expect(instance).to.be.a(GeboAiClient.JobsEntriesForClassNameFilter);
      });
