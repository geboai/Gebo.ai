...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GBaseObject', function() {
      beforeEach(function() {
        instance = new GeboAiClient.GBaseObject();
      });

      it('should create an instance of GBaseObject', function() {
        // TODO: update the code to test GBaseObject
        expect(instance).to.be.a(GeboAiClient.GBaseObject);
      });
