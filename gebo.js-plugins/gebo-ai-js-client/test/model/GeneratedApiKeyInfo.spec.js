...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GeneratedApiKeyInfo', function() {
      beforeEach(function() {
        instance = new GeboAiClient.GeneratedApiKeyInfo();
      });

      it('should create an instance of GeneratedApiKeyInfo', function() {
        // TODO: update the code to test GeneratedApiKeyInfo
        expect(instance).to.be.a(GeboAiClient.GeneratedApiKeyInfo);
      });
