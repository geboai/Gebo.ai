...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GBuildSystemType', function() {
      beforeEach(function() {
        instance = new GeboAiClient.GBuildSystemType();
      });

      it('should create an instance of GBuildSystemType', function() {
        // TODO: update the code to test GBuildSystemType
        expect(instance).to.be.a(GeboAiClient.GBuildSystemType);
      });
