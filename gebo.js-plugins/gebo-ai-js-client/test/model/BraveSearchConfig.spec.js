...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BraveSearchConfig', function() {
      beforeEach(function() {
        instance = new GeboAiClient.BraveSearchConfig();
      });

      it('should create an instance of BraveSearchConfig', function() {
        // TODO: update the code to test BraveSearchConfig
        expect(instance).to.be.a(GeboAiClient.BraveSearchConfig);
      });
