...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MongoConfig', function() {
      beforeEach(function() {
        instance = new GeboAiClient.MongoConfig();
      });

      it('should create an instance of MongoConfig', function() {
        // TODO: update the code to test MongoConfig
        expect(instance).to.be.a(GeboAiClient.MongoConfig);
      });
