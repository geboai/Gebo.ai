...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserUploadedContent', function() {
      beforeEach(function() {
        instance = new GeboAiClient.UserUploadedContent();
      });

      it('should create an instance of UserUploadedContent', function() {
        // TODO: update the code to test UserUploadedContent
        expect(instance).to.be.a(GeboAiClient.UserUploadedContent);
      });
