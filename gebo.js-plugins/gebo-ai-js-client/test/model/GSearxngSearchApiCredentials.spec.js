...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GSearxngSearchApiCredentials', function() {
      beforeEach(function() {
        instance = new GeboAiClient.GSearxngSearchApiCredentials();
      });

      it('should create an instance of GSearxngSearchApiCredentials', function() {
        // TODO: update the code to test GSearxngSearchApiCredentials
        expect(instance).to.be.a(GeboAiClient.GSearxngSearchApiCredentials);
      });
