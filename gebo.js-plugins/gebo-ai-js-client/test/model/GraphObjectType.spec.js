...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GraphObjectType', function() {
      beforeEach(function() {
        instance = new GeboAiClient.GraphObjectType();
      });

      it('should create an instance of GraphObjectType', function() {
        // TODO: update the code to test GraphObjectType
        expect(instance).to.be.a(GeboAiClient.GraphObjectType);
      });
