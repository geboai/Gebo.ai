...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JobsEntriesForJobType', function() {
      beforeEach(function() {
        instance = new GeboAiClient.JobsEntriesForJobType();
      });

      it('should create an instance of JobsEntriesForJobType', function() {
        // TODO: update the code to test JobsEntriesForJobType
        expect(instance).to.be.a(GeboAiClient.JobsEntriesForJobType);
      });
