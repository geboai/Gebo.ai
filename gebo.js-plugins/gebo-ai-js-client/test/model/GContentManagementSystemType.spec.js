...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GContentManagementSystemType', function() {
      beforeEach(function() {
        instance = new GeboAiClient.GContentManagementSystemType();
      });

      it('should create an instance of GContentManagementSystemType', function() {
        // TODO: update the code to test GContentManagementSystemType
        expect(instance).to.be.a(GeboAiClient.GContentManagementSystemType);
      });
