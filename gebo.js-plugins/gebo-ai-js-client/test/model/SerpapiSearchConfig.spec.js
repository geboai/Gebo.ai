...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SerpapiSearchConfig', function() {
      beforeEach(function() {
        instance = new GeboAiClient.SerpapiSearchConfig();
      });

      it('should create an instance of SerpapiSearchConfig', function() {
        // TODO: update the code to test SerpapiSearchConfig
        expect(instance).to.be.a(GeboAiClient.SerpapiSearchConfig);
      });
