...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BrowseParam', function() {
      beforeEach(function() {
        instance = new GeboAiClient.BrowseParam();
      });

      it('should create an instance of BrowseParam', function() {
        // TODO: update the code to test BrowseParam
        expect(instance).to.be.a(GeboAiClient.BrowseParam);
      });
