...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TavilySearchConfig', function() {
      beforeEach(function() {
        instance = new GeboAiClient.TavilySearchConfig();
      });

      it('should create an instance of TavilySearchConfig', function() {
        // TODO: update the code to test TavilySearchConfig
        expect(instance).to.be.a(GeboAiClient.TavilySearchConfig);
      });
