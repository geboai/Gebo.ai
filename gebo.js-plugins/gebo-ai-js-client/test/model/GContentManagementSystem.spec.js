...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GContentManagementSystem', function() {
      beforeEach(function() {
        instance = new GeboAiClient.GContentManagementSystem();
      });

      it('should create an instance of GContentManagementSystem', function() {
        // TODO: update the code to test GContentManagementSystem
        expect(instance).to.be.a(GeboAiClient.GContentManagementSystem);
      });
