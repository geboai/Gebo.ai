# BrainClient.MistralAiEmbeddingModelsConfigurationControllerApi
...
let apiInstance = new BrainClient.MistralAiEmbeddingModelsConfigurationControllerApi();
let body = new BrainClient.GMistralEmbeddingModelConfig(); // GMistralEmbeddingModelConfig | 
