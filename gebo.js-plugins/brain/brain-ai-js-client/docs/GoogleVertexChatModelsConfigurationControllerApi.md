# BrainClient.GoogleVertexChatModelsConfigurationControllerApi
...
let apiInstance = new BrainClient.GoogleVertexChatModelsConfigurationControllerApi();
let body = new BrainClient.GGoogleVertexChatModelConfig(); // GGoogleVertexChatModelConfig | 
