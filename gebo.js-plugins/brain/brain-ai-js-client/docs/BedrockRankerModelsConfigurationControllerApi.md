# BrainClient.BedrockRankerModelsConfigurationControllerApi
...
let apiInstance = new BrainClient.BedrockRankerModelsConfigurationControllerApi();
let body = new BrainClient.GBedrockRankerModelConfig(); // GBedrockRankerModelConfig | 
