# BrainClient.OpenAiEmbeddingModelsConfigurationControllerApi
...
let apiInstance = new BrainClient.OpenAiEmbeddingModelsConfigurationControllerApi();
let body = new BrainClient.GOpenAIEmbeddingModelConfig(); // GOpenAIEmbeddingModelConfig | 
