# BrainClient.OllamaEmbeddingModelsConfigurationControllerApi
...
let apiInstance = new BrainClient.OllamaEmbeddingModelsConfigurationControllerApi();
let body = new BrainClient.GOllamaEmbeddingModelConfig(); // GOllamaEmbeddingModelConfig | 
