# BrainClient.GeboAdminPromptsControllerApi
...
let body = new BrainClient.GPromptTemplateConfig(); // GPromptTemplateConfig | 
...
let apiInstance = new BrainClient.GeboAdminPromptsControllerApi();
let body = new BrainClient.PromptFilter(); // PromptFilter | 
