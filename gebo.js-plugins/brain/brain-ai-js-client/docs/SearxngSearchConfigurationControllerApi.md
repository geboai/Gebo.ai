# BrainClient.SearxngSearchConfigurationControllerApi
...
let apiInstance = new BrainClient.SearxngSearchConfigurationControllerApi();
let body = new BrainClient.GSearxngSearchApiCredentials(); // GSearxngSearchApiCredentials | 
...
let apiInstance = new BrainClient.SearxngSearchConfigurationControllerApi();
let body = new BrainClient.SearxngSearchConfig(); // SearxngSearchConfig | 
