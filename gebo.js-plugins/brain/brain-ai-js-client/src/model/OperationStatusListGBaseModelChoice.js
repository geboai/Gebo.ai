 ...
 * @module model/OperationStatusListGBaseModelChoice
 * @version v0
 */
export default class OperationStatusListGBaseModelChoice {
  /**
   * Constructs a new <code>OperationStatusListGBaseModelChoice</code>.
   * @alias module:model/OperationStatusListGBaseModelChoice
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>OperationStatusListGBaseModelChoice</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OperationStatusListGBaseModelChoice} obj Optional instance to populate.
   * @return {module:model/OperationStatusListGBaseModelChoice} The populated <code>OperationStatusListGBaseModelChoice</code> instance.
   */
