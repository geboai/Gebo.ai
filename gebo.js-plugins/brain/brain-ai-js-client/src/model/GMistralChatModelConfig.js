...
/**
 * The GMistralChatModelConfig model module.
 * @module model/GMistralChatModelConfig
 * @version v0
 */
export default class GMistralChatModelConfig {
  /**
   * Constructs a new <code>GMistralChatModelConfig</code>.
   * @alias module:model/GMistralChatModelConfig
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>GMistralChatModelConfig</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GMistralChatModelConfig} obj Optional instance to populate.
   * @return {module:model/GMistralChatModelConfig} The populated <code>GMistralChatModelConfig</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new GMistralChatModelConfig();
      ...
      if (data.hasOwnProperty('choosedModel'))
        obj.choosedModel = GMistralChatModelChoice.constructFromObject(data['choosedModel']);
 ...
 * @member {String} code
 */
GMistralChatModelConfig.prototype.code = undefined;

/**
 * @member {String} description
 */
GMistralChatModelConfig.prototype.description = undefined;

/**
 * @member {String} userModified
 */
GMistralChatModelConfig.prototype.userModified = undefined;

/**
 * @member {String} userCreated
 */
GMistralChatModelConfig.prototype.userCreated = undefined;

/**
 * @member {Date} dateModified
 */
GMistralChatModelConfig.prototype.dateModified = undefined;

/**
 * @member {Date} dateCreated
 */
GMistralChatModelConfig.prototype.dateCreated = undefined;

/**
 * @member {String} modelTypeCode
 */
GMistralChatModelConfig.prototype.modelTypeCode = undefined;

/**
 * @member {Boolean} defaultModel
 */
GMistralChatModelConfig.prototype.defaultModel = undefined;

/**
 * @member {String} apiSecretCode
 */
GMistralChatModelConfig.prototype.apiSecretCode = undefined;

/**
 * @member {module:model/GMistralChatModelChoice} choosedModel
 */
GMistralChatModelConfig.prototype.choosedModel = undefined;

/**
 * @member {String} baseUrl
 */
GMistralChatModelConfig.prototype.baseUrl = undefined;

/**
 * @member {Number} contextLength
 */
GMistralChatModelConfig.prototype.contextLength = undefined;

/**
 * @member {Number} topP
 */
GMistralChatModelConfig.prototype.topP = undefined;

/**
 * @member {Array.<String>} accessibleGroups
 */
GMistralChatModelConfig.prototype.accessibleGroups = undefined;

/**
 * @member {Array.<String>} accessibleUsers
 */
GMistralChatModelConfig.prototype.accessibleUsers = undefined;

/**
 * @member {Boolean} accessibleToAll
 */
GMistralChatModelConfig.prototype.accessibleToAll = undefined;

/**
 * @member {Array.<String>} enabledFunctions
 */
GMistralChatModelConfig.prototype.enabledFunctions = undefined;

/**
 * @member {Number} temperature
 */
GMistralChatModelConfig.prototype.temperature = undefined;
 ...
 * @readonly
 */
GMistralChatModelConfig.ForUsesEnum = {
  /**
   * value: "CHAT"
   * @const
   */
...
/**
 * @member {Array.<module:model/GMistralChatModelConfig.ForUsesEnum>} forUses
 */
GMistralChatModelConfig.prototype.forUses = undefined;
 ...
 * @readonly
 */
GMistralChatModelConfig.FeaturesEnum = {
  /**
   * value: "CHAT"
   * @const
   */
...
/**
 * @member {Array.<module:model/GMistralChatModelConfig.FeaturesEnum>} features
 */
GMistralChatModelConfig.prototype.features = undefined;
 ...
 * @readonly
 */
GMistralChatModelConfig.ThinkingEnum = {
  /**
   * value: "NO_THINKING"
   * @const
   */
...
/**
 * @member {module:model/GMistralChatModelConfig.ThinkingEnum} thinking
 */
GMistralChatModelConfig.prototype.thinking = undefined;

/**
 * @member {Number} maxGeneratedTokens
 */
GMistralChatModelConfig.prototype.maxGeneratedTokens = undefined;
