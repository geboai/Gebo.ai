...
* @module api/GeboDeepSearchControllerApi
* @version v0
*/
export default class GeboDeepSearchControllerApi {

    /**
    * Constructs a new GeboDeepSearchControllerApi. 
    * @alias module:api/GeboDeepSearchControllerApi
    * @class
