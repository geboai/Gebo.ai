...
* @module api/ImageModelsControllerApi
* @version v0
*/
export default class ImageModelsControllerApi {

    /**
    * Constructs a new ImageModelsControllerApi. 
    * @alias module:api/ImageModelsControllerApi
    * @class
