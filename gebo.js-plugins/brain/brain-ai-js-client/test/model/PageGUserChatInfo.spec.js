...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageGUserChatInfo', function() {
      beforeEach(function() {
        instance = new BrainClient.PageGUserChatInfo();
      });

      it('should create an instance of PageGUserChatInfo', function() {
        // TODO: update the code to test PageGUserChatInfo
        expect(instance).to.be.a(BrainClient.PageGUserChatInfo);
      });
