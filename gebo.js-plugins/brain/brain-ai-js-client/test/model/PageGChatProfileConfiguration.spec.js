...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageGChatProfileConfiguration', function() {
      beforeEach(function() {
        instance = new BrainClient.PageGChatProfileConfiguration();
      });

      it('should create an instance of PageGChatProfileConfiguration', function() {
        // TODO: update the code to test PageGChatProfileConfiguration
        expect(instance).to.be.a(BrainClient.PageGChatProfileConfiguration);
      });
