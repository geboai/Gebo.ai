...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageA2ARemoteAgentConfig', function() {
      beforeEach(function() {
        instance = new BrainClient.PageA2ARemoteAgentConfig();
      });

      it('should create an instance of PageA2ARemoteAgentConfig', function() {
        // TODO: update the code to test PageA2ARemoteAgentConfig
        expect(instance).to.be.a(BrainClient.PageA2ARemoteAgentConfig);
      });
