...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageGJobStatusItem', function() {
      beforeEach(function() {
        instance = new BrainClient.PageGJobStatusItem();
      });

      it('should create an instance of PageGJobStatusItem', function() {
        // TODO: update the code to test PageGJobStatusItem
        expect(instance).to.be.a(BrainClient.PageGJobStatusItem);
      });
