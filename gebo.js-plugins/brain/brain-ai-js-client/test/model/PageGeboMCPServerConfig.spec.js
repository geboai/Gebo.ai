...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageGeboMCPServerConfig', function() {
      beforeEach(function() {
        instance = new BrainClient.PageGeboMCPServerConfig();
      });

      it('should create an instance of PageGeboMCPServerConfig', function() {
        // TODO: update the code to test PageGeboMCPServerConfig
        expect(instance).to.be.a(BrainClient.PageGeboMCPServerConfig);
      });
