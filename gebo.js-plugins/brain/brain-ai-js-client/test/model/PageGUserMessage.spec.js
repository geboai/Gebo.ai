...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageGUserMessage', function() {
      beforeEach(function() {
        instance = new BrainClient.PageGUserMessage();
      });

      it('should create an instance of PageGUserMessage', function() {
        // TODO: update the code to test PageGUserMessage
        expect(instance).to.be.a(BrainClient.PageGUserMessage);
      });
