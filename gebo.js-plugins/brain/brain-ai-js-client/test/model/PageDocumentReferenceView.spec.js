...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageDocumentReferenceView', function() {
      beforeEach(function() {
        instance = new BrainClient.PageDocumentReferenceView();
      });

      it('should create an instance of PageDocumentReferenceView', function() {
        // TODO: update the code to test PageDocumentReferenceView
        expect(instance).to.be.a(BrainClient.PageDocumentReferenceView);
      });
