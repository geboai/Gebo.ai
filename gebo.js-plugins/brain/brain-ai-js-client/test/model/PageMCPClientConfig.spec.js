...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageMCPClientConfig', function() {
      beforeEach(function() {
        instance = new BrainClient.PageMCPClientConfig();
      });

      it('should create an instance of PageMCPClientConfig', function() {
        // TODO: update the code to test PageMCPClientConfig
        expect(instance).to.be.a(BrainClient.PageMCPClientConfig);
      });
