...
/**
 * AvatarsApi class provides methods to interact with Avatars related operations
 * in Jira. AI generated comments
 */
...
public class AvatarsApi {
	...
	/**
	 * Delete avatar Deletes an avatar from a project, issue type or priority.
	 ...
	 * </p>
	 * <p>
	 * <b>403</b> - Returned if the user does not have permission to delete the
	 * avatar, the avatar is not deletable.
	 * </p>
	 * <p>
	 * <b>404</b> - Returned if the avatar type, associated item ID, or avatar ID is
	 * invalid.
	 * </p>
	 * 
	 ...
	 *                             API
	 */
	public ResponseEntity<Void> deleteAvatarWithHttpInfo(String type, String owningObjectId, Long id)
		...
		if (owningObjectId == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'owningObjectId' when calling deleteAvatar");
		}
		...
		String path = UriComponentsBuilder
				.fromPath("/rest/api/3/universal_avatar/type/{type}/owner/{owningObjectId}/avatar/{id}")
	...
	/**
	 * Get system avatars by type Returns a list of system avatar details by owner
	 * type, where the owner types are issue type, project, user or priority. This
	 ...
	 * </p>
	 * <p>
	 * <b>500</b> - Returned if an error occurs while retrieving the list of
	 * avatars.
	 * </p>
	 * 
	 * @param type The avatar type. (required)
	...
	public ResponseEntity<SystemAvatars> getAllSystemAvatarsWithHttpInfo(String type) throws RestClientException {
		...
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("type", type);
		String path = UriComponentsBuilder.fromPath("/rest/api/3/avatar/{type}/system").buildAndExpand(uriVariables)
				.toUriString();
	...
	/**
	 * Get avatar image by ID Returns a project, issue type or priority avatar image
	 * by ID. This operation can be accessed anonymously.
	 * **[Permissions](#permissions) required:** * For system avatars, none. * For
	 * custom project avatars, *Browse projects* [project
	 ...
	 * one project the issue type is used in. * For priority avatars, none.
	 * <p>
	 * <b>200</b> - Returned if the request is successful.
	 * </p>
	 * <p>
	 * <b>400</b> - Returned if the request is not valid.
	 * </p>
	 * <p>
	 ...
	 * </p>
	 * <p>
	 * <b>404</b> - Returned if an avatar is not found or an avatar matching the
	 ...
	 *                             API
	 */
	public ResponseEntity<Void> getAvatarImageByIDWithHttpInfo(String type, Long id, String size, String format)
			throws RestClientException {
		Object postBody = null;
		// verify the required parameter 'type' is set
		if (type == null) {
		...
		uriVariables.put("type", type);
		uriVariables.put("id", id);
		String path = UriComponentsBuilder.fromPath("/rest/api/3/universal_avatar/view/type/{type}/avatar/{id}")
				.buildAndExpand(uriVariables).toUriString();
		...
		final String[] accepts = { "*/*", "application/json", "image/png", "image/svg+xml" };
		final List<MediaType> accept = apiClient.selectHeaderAccept(accepts);
		final String[] contentTypes = {};
		final MediaType contentType = apiClient.selectHeaderContentType(contentTypes);
	...
	/**
	 * Get avatar image by owner Returns the avatar image for a project, issue type
	 * or priority. This operation can be accessed anonymously.
	 * **[Permissions](#permissions) required:** * For system avatars, none. * For
	 * custom project avatars, *Browse projects* [project
	 * permission](https://confluence.atlassian.com/x/yodKLg) for the project the
	 * avatar belongs to. * For custom issue type avatars, *Browse projects*
	 ...
	 *                             API
	 */
	public void getAvatarImageByOwner(String type, String entityId, String size, String format)
			throws RestClientException {
	 ...
	 *                             API
	 */
	public ResponseEntity<Void> getAvatarImageByOwnerWithHttpInfo(String type, String entityId, String size,
			String format) throws RestClientException {
		Object postBody = null;
		// verify the required parameter 'type' is set
		if (type == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
		...
		if (entityId == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'entityId' when calling getAvatarImageByOwner");
		}
		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("type", type);
		uriVariables.put("entityId", entityId);
		String path = UriComponentsBuilder.fromPath("/rest/api/3/universal_avatar/view/type/{type}/owner/{entityId}")
				.buildAndExpand(uriVariables).toUriString();
	...
	/**
	 * Get avatar image by type Returns the default project, issue type or priority
	 * avatar image. This operation can be accessed anonymously.
	 ...
	 *                             API
	 */
	public ResponseEntity<Void> getAvatarImageByTypeWithHttpInfo(String type, String size, String format)
			throws RestClientException {
		Object postBody = null;
		// verify the required parameter 'type' is set
		if (type == null) {
		...
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("type", type);
		String path = UriComponentsBuilder.fromPath("/rest/api/3/universal_avatar/view/type/{type}")
				.buildAndExpand(uriVariables).toUriString();
	...
	/**
	 * Get avatars Returns the system and custom avatars for a project, issue type
	 * or priority. This operation can be accessed anonymously.
	 * **[Permissions](#permissions) required:** * for custom project avatars,
	 ...
	 * </p>
	 * <p>
	 * <b>404</b> - Returned if the avatar type is invalid, the associated item ID
	...
	public ResponseEntity<Avatars> getAvatarsWithHttpInfo(String type, String entityId) throws RestClientException {
		...
		if (entityId == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'entityId' when calling getAvatars");
		}
		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("type", type);
		uriVariables.put("entityId", entityId);
		String path = UriComponentsBuilder.fromPath("/rest/api/3/universal_avatar/type/{type}/owner/{entityId}")
				.buildAndExpand(uriVariables).toUriString();
	...
	/**
	 * Load avatar Loads a custom avatar for a project, issue type or priority.
	 * Specify the avatar's local file location in the body of the request. Also,
	 * include the following headers: X-Atlassian-Token: no-check To prevent XSRF
	 * protection blocking the request, for more information see [Special
	 * Headers](#special-request-headers). Content-Type: image/image type Valid
	 * image types are JPEG, GIF, or PNG. For example: `curl --request POST `
	 * `--user email@example.com: api_token ` `--header 'X-Atlassian-Token:
	 * no-check' ` `--header 'Content-Type: image/ image_type' ` `--data-binary
	 ...
	 * <p>
	 * <b>201</b> - Returned if the request is successful.
	 * </p>
	 * <p>
	 * <b>400</b> - Returned if: * an image isn't included in the request. * the
	 * image type is unsupported. * the crop parameters extend the crop area beyond
	 ...
	 * </p>
	 * <p>
	 * <b>403</b> - Returned if the user does not have the necessary permissions.
	 * </p>
	 * <p>
	 * <b>404</b> - Returned if the avatar type is invalid, the associated item ID
	 * is missing, or the item is not found.
	 ...
	 *                             API
	 */
	public Avatar storeAvatar(Object body, Integer size, String type, String entityId, Integer x, Integer y)
			throws RestClientException {
	 ...
	 * Load avatar Loads a custom avatar for a project, issue type or priority.
	 * Specify the avatar's local file location in the body of the request. Also,
	 * include the following headers: * `X-Atlassian-Token: no-check` To prevent
	 ...
	 *                             API
	 */
	public ResponseEntity<Avatar> storeAvatarWithHttpInfo(Object body, Integer size, String type, String entityId,
			Integer x, Integer y) throws RestClientException {
		...
		if (entityId == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'entityId' when calling storeAvatar");
		}
		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("type", type);
