...
import ai.gebo.jira.cloud.client.model.LicensedApplication;
 ...
 */
@Schema(description = "Details about a license for the Jira instance.")
...
public class License {
   ...
   * @return applications
  **/
  @Schema(required = true, description = "The applications under this license.")
