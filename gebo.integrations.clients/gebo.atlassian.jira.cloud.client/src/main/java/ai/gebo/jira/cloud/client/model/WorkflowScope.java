 ...
 */
@Schema(description = "The scope of the workflow.")
...
public class WorkflowScope {
  ...
  **/
   ...
   * @return type
  **/
  @Schema(description = "The scope of the workflow. `GLOBAL` for company-managed projects and `PROJECT` for team-managed projects.")
