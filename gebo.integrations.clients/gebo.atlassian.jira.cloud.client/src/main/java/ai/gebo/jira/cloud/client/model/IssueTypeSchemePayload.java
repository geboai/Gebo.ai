 ...
 */
@Schema(description = "The payload for creating issue type schemes")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2025-05-05T08:43:30.568333200+02:00[Europe/Rome]")

public class IssueTypeSchemePayload {
  @JsonProperty("defaultIssueTypeId")
  private ProjectCreateResourceIdentifier defaultIssueTypeId = null;

  @JsonProperty("description")
  private String description = null;

  @JsonProperty("issueTypeIds")
  private List<ProjectCreateResourceIdentifier> issueTypeIds = null;
  ...
  **/
   ...
   * @return issueTypeIds
  **/
  @Schema(example = "pcri:issueType:id:10001", description = "The issue type IDs for the issue type scheme")
   ...
   * @return name
  **/
  @Schema(description = "The name of the issue type scheme")
