 ...
 */
@Schema(description = "Details of changes to a priority scheme's projects that require suggested priority mappings.")
...
public class SuggestedMappingsForProjectsRequestBean {
   ...
   * @return add
  **/
  @Schema(description = "The ids of projects being added to the scheme.")
