...
import ai.gebo.jira.cloud.client.model.StatusUpdate;
 ...
 */
@Schema(description = "The list of statuses that will be updated.")
...
public class StatusUpdateRequest {
   ...
   * @return statuses
  **/
  @Schema(required = true, description = "The list of statuses that will be updated.")
