...
import ai.gebo.jira.cloud.client.model.StatusScope;
import ai.gebo.jira.cloud.client.model.WorkflowUsages;
...
public class JiraStatus {
  ...
  **/
   ...
   * @return usages
  **/
  @Schema(description = "Deprecated. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/changelog/#CHANGE-2298) for details.  Projects and issue types where the status is used. Only available if the `usages` expand is requested.")
  ...
  **/
  @Schema(description = "Deprecated. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/changelog/#CHANGE-2298) for details.  The workflows that use this status. Only available if the `workflowUsages` expand is requested.")
