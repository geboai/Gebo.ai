...
public class GetExclusionRulesResponse {
   ...
   * @return issueIds
  **/
  @Schema(description = "The IDs of the issues excluded from the plan.")
   ...
   * @return issueTypeIds
  **/
  @Schema(description = "The IDs of the issue types excluded from the plan.")
  ...
  **/
  @Schema(required = true, description = "Issues completed this number of days ago are excluded from the plan.")
   ...
   * @return releaseIds
  **/
  @Schema(description = "The IDs of the releases excluded from the plan.")
  ...
  **/
  @Schema(description = "The IDs of the work status categories excluded from the plan.")
  ...
  **/
  @Schema(description = "The IDs of the work statuses excluded from the plan.")
