 ...
 */
@Schema(description = "Details of changes to a priority scheme's priorities that require suggested priority mappings.")
...
public class SuggestedMappingsForPrioritiesRequestBean {
   ...
   * @return add
  **/
  @Schema(description = "The ids of priorities being removed from the scheme.")
