 ...
 * 
 * API client for interacting with Jira issue votes endpoints.
 * This class provides methods to manage votes for Jira issues, including adding, retrieving,
 * and removing votes.
 */
...
import ai.gebo.jira.cloud.client.model.Votes;
...
//@Component("ai.gebo.jira.cloud.client.api.IssueVotesApi")
public class IssueVotesApi {
    ...
    public Object addVote(String issueIdOrKey) throws RestClientException {
        return addVoteWithHttpInfo(issueIdOrKey).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Object> addVoteWithHttpInfo(String issueIdOrKey) throws RestClientException {
    ...
    public Votes getVotes(String issueIdOrKey) throws RestClientException {
        return getVotesWithHttpInfo(issueIdOrKey).getBody();
    }
     ...
     * <p><b>404</b> - Returned if:   *  voting is disabled.  *  the user does not have permission to view the issue.  *  the issue is not found.
     * @param issueIdOrKey The ID or key of the issue. (required)
     * @return ResponseEntity&lt;Votes&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Votes> getVotesWithHttpInfo(String issueIdOrKey) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'issueIdOrKey' is set
        if (issueIdOrKey == null) {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Void> removeVoteWithHttpInfo(String issueIdOrKey) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'issueIdOrKey' is set
        if (issueIdOrKey == null) {
