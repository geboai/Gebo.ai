...
public class UpdateProjectDetails {
  ...
  private List<String> releasedProjectKeys = null;
  ...
  **/
  @Schema(description = "Previous project keys to be released from the current project. Released keys must belong to the current project and not contain the current project key")
