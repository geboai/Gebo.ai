 ...
 * A client class for interacting with Jira Cloud API. This class handles HTTP requests, authentication,
 * and response processing for Jira Cloud API endpoints.
 */
...
import ai.gebo.jira.cloud.client.invoker.auth.Authentication;
import ai.gebo.jira.cloud.client.invoker.auth.HttpBasicAuth;
import ai.gebo.jira.cloud.client.invoker.auth.ApiKeyAuth;
import ai.gebo.jira.cloud.client.invoker.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2025-05-05T08:43:30.568333200+02:00[Europe/Rome]")
//@Component("ai.gebo.jira.cloud.client.invoker.ApiClient")
public class ApiClient {
	/**
	 * Array of authentication names supported by this client
	 */
	public static final String[] AUTH_NAMES = new String[] { "OAuth2", "basicAuth", "ApiKey" };

	/**
	 * Enum defining the collection formats for query parameters
	 */
	...
	private String basePath = "https://your-domain.atlassian.net";
	...
	/**
	 * Default constructor that creates a RestTemplate
	 */
	public ApiClient() {
	...
	/**
	 * Constructor that accepts a RestTemplate
	 * 
	...
	/**
	 * Initializes the API client with default settings
	 */
	protected void init() {
		...
		setApiKey(new ApiKeyAuth("header", "Authorization"));
	...
	/**
	 * Sets a specific ApiKeyAuth object as an authentication method
	 * 
	 * @param auth The ApiKeyAuth object to set
	 */
	void setApiKey(ApiKeyAuth auth) {
	 ...
	 * 
	 * @param str String representation of date
	 * @return Date object
	 */
	 ...
	 */
	public <T> ResponseEntity<T> invokeAPI(String path, HttpMethod method, MultiValueMap<String, String> queryParams,
			Object body, HttpHeaders headerParams, MultiValueMap<String, Object> formParams, List<MediaType> accept,
	...
	/**
	 * Gets an API response as a stream
	 * 
	 * @param url URL to request
	 * @param accept Accept header media types
	 * @param authNames Authentication names to apply
	 * @return InputStream of the response
	 * @throws IOException If there's an issue with the stream
	 * @throws RestClientException If there's an API error
	 */
	public InputStream getStreamApi(String url, List<MediaType> accept, String[] authNames)
		...
		HttpEntity<?> requestEntity = new HttpEntity<>(headerParams);

		ResponseEntity<Resource> response = restTemplate.exchange(builder.toUriString(), HttpMethod.GET, requestEntity,
				Resource.class);

		if (response.getStatusCode().is2xxSuccessful() && response.getBody() != null) {
			InputStream out = response.getBody().getInputStream();
			return out;
		} else {
	...
	/**
	 * HTTP request interceptor that logs request and response details when debugging is enabled
	 */
	private class ApiClientHttpRequestInterceptor implements ClientHttpRequestInterceptor {
		 ...
		 * @throws UnsupportedEncodingException If body encoding fails
		 */
		...
		/**
		 * Converts headers to a string for logging
		 * 
		...
		/**
		 * Converts response body to a string for logging
		 * 
		 * @param body Response body input stream
