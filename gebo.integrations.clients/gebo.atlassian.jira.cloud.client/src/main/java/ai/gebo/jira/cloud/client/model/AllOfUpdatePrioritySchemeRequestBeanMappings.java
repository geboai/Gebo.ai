...
/**
 * A class that extends PriorityMapping to handle the mappings for updating a priority scheme.
 * This class is used in the update priority scheme request to define how issue priorities
 * should be migrated when making changes to a priority scheme.
 */
public class AllOfUpdatePrioritySchemeRequestBeanMappings extends PriorityMapping {

  /**
   * Checks if this object is equal to another object.
   * Two AllOfUpdatePrioritySchemeRequestBeanMappings objects are considered equal if they
   * have the same properties defined in the parent PriorityMapping class.
   *
  ...
  /**
   * Returns a string representation of this object with indented formatting.
   *
  ...
  public String toString() {
    ...
    sb.append("class AllOfUpdatePrioritySchemeRequestBeanMappings {\n");
