...
import ai.gebo.jira.cloud.client.model.StatusProjectIssueTypeUsage;
 ...
 */
@Schema(description = "A page of issue types.")
...
public class StatusProjectIssueTypeUsagePage {
  ...
  @JsonProperty("values")
  private List<StatusProjectIssueTypeUsage> values = null;
  ...
  **/
   ...
   * @return values
  **/
  @Schema(description = "The list of issue types.")
