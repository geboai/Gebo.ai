 ...
 */
@Schema(description = "The details of the field configuration scheme.")
...
public class UpdateFieldConfigurationSchemeDetails {
  ...
  **/
   ...
   * @return name
  **/
  @Schema(required = true, description = "The name of the field configuration scheme. The name must be unique.")
