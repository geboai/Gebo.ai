...
//import ai.gebo.jira.cloud.client.api.WorkflowsApi;
 ...
 **workflowName** | [**List&lt;String&gt;**](String.md)| The name of a workflow to return. To include multiple workflows, provide an ampersand-separated list. For example, &#x60;workflowName&#x3D;name1&amp;workflowName&#x3D;name2&#x60;. | [optional]
...
# **readWorkflows**
> WorkflowReadResponse readWorkflows(body, expand, useApprovalConfiguration)
...
try {
    WorkflowReadResponse result = apiInstance.readWorkflows(body, expand, useApprovalConfiguration);
    System.out.println(result);
} catch (ApiException e) {
...
WorkflowsApi apiInstance = new WorkflowsApi();
Long startAt = 789L; // Long | The index of the first item to return in a page of results (page offset).
