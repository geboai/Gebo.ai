...
------------ | ------------- | ------------- | -------------
**classifications** | [**Map&lt;String, List&lt;String&gt;&gt;**](List.md) | An object with the key as the ID of the target classification and value with the list of the IDs of the current source classifications. | 
