...
/**
 * Provides an API client to interact with the Confluence Cloud spaces. AI
 * generated comments
 */
@AllArgsConstructor
public class CloudConfluenceSpaceApi {
	private static final String SPACE_API_RELATIVE_URL = "/wiki/rest/api/space";
	 ...
	 */
	public CloudConfluenceSpacesList getAllSpaces(Integer start, int limit, String type)
			throws GeboRestIntegrationException {
		String relative = SPACE_API_RELATIVE_URL;
	...
	public CloudConfluenceSpacesList getSpace(String key) throws GeboRestIntegrationException {
		String relative = SPACE_API_RELATIVE_URL + "?spaceKey=" + URLEncoder.encode(key)
