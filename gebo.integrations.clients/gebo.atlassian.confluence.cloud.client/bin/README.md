...
- API version: 1.0.0
  - Build date: 2024-10-29T11:19:19.194848600+01:00[Europe/Rome]
...
```java
import ai.gebo.atlassian.confluence.api.invoker.*;
import ai.gebo.atlassian.confluence.api.invoker.auth.*;
import ai.gebo.atlassian.confluence.api.model.*;
...
## Documentation for Models
 ...
 - [AddContentRestrictionRestrictionsGroup](docs/AddContentRestrictionRestrictionsGroup.md)
 ...
 - [AsyncContentBodyArray](docs/AsyncContentBodyArray.md)
 ...
 - [AsyncIdArray](docs/AsyncIdArray.md)
 ...
 - [ContentBodyConversionInputArray](docs/ContentBodyConversionInputArray.md)
