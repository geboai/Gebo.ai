...
**parentCommentId** | **String** | ID of the parent comment the child comment is in. |  [optional]
...
**properties** | [**InlineCommentProperties**](InlineCommentProperties.md) |  |  [optional]
