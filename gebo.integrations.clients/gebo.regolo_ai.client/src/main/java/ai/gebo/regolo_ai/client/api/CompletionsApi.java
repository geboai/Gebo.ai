...
public class CompletionsApi {
     ...
     */
    public Object completionCompletionsPost(Object model) throws ApiException {
     ...
     * @throws ApiException if fails to make API call
     */
    public Object completionEnginesModelCompletionsPost(Object model) throws ApiException {
        Object localVarPostBody = null;
        // verify the required parameter 'model' is set
        if (model == null) {
            throw new ApiException(400, "Missing the required parameter 'model' when calling completionEnginesModelCompletionsPost");
        }
        // create path and map variables
        String localVarPath = "/engines/{model}/completions"
     ...
     * @throws ApiException if fails to make API call
     */
    public Object completionOpenaiDeploymentsModelCompletionsPost(Object model) throws ApiException {
        Object localVarPostBody = null;
        // verify the required parameter 'model' is set
        if (model == null) {
            throw new ApiException(400, "Missing the required parameter 'model' when calling completionOpenaiDeploymentsModelCompletionsPost");
        }
        // create path and map variables
        String localVarPath = "/openai/deployments/{model}/completions"
                .replaceAll("\\{" + "model" + "\\}", apiClient.escapeString(model.toString()));
     ...
     * @throws ApiException if fails to make API call
     */
    public Object completionV1CompletionsPost(Object model) throws ApiException {
        Object localVarPostBody = null;
        // create path and map variables
