...
import ai.gebo.regolo_ai.client.invoker.auth.ApiKeyAuth;
import ai.gebo.regolo_ai.client.invoker.auth.Authentication;
import ai.gebo.regolo_ai.client.invoker.auth.HttpBasicAuth;
import ai.gebo.regolo_ai.client.invoker.auth.OAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://api.regolo.ai";
    ...
    public ApiClient() {
        ...
        authentications.put("APIKeyHeader", new ApiKeyAuth("header", "x-goog-api-key"));
