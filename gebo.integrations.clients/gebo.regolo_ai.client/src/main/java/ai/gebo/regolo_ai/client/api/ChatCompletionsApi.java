...
public class ChatCompletionsApi {
    ...
    public ChatCompletionsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ChatCompletionsApi(ApiClient apiClient) {
     ...
     */
    public Object chatCompletionChatCompletionsPost(Object model) throws ApiException {
     ...
     * @throws ApiException if fails to make API call
     */
    public Object chatCompletionEnginesModelChatCompletionsPost(Object model) throws ApiException {
        Object localVarPostBody = null;
        // verify the required parameter 'model' is set
        if (model == null) {
            throw new ApiException(400, "Missing the required parameter 'model' when calling chatCompletionEnginesModelChatCompletionsPost");
        }
        // create path and map variables
        String localVarPath = "/engines/{model}/chat/completions"
     ...
     * @throws ApiException if fails to make API call
     */
    public Object chatCompletionOpenaiDeploymentsModelChatCompletionsPost(Object model) throws ApiException {
        Object localVarPostBody = null;
        // verify the required parameter 'model' is set
        if (model == null) {
            throw new ApiException(400, "Missing the required parameter 'model' when calling chatCompletionOpenaiDeploymentsModelChatCompletionsPost");
        }
        // create path and map variables
        String localVarPath = "/openai/deployments/{model}/chat/completions"
                .replaceAll("\\{" + "model" + "\\}", apiClient.escapeString(model.toString()));
     ...
     * @throws ApiException if fails to make API call
     */
    public Object chatCompletionV1ChatCompletionsPost(Object model) throws ApiException {
        Object localVarPostBody = null;
        // create path and map variables
