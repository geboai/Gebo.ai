...
/**
 * Registers the default uploads content handler as a bean that a downstream
 * module can override by supplying its own bean of the corresponding
 * interface.
 */
@Configuration
public class GUploadsDefaultBeansConfig {

	@Bean
	@ConditionalOnMissingBean(IGUploadsContentManagementSystemHandler.class)
	public IGUploadsContentManagementSystemHandler uploadsContentManagementHandler(
		...
		return new GUploadsContentManagementSystemHandlerImpl(buildSystemHandlerRepository, contentHandler,
