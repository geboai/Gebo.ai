...
/**
 * The Uploads microservice's own instance of the job-launch receiver,
...
public class UploadsJobLaunchManager extends AbstractJobLaunchManager {

	public UploadsJobLaunchManager(IGGeboIngestionJobQueueService jobLauncherController,
		...
		super(jobLauncherController, persistentObjectManager, broker, jobStatusRepositoy,
				GStandardModulesConstraints.UPLOADS_MODULE);
	}
}
