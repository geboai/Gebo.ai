...
/**
 * The Uploads microservice's own instance of the job-status replicator,
...
public class UploadsJobStatusReplicatorService extends AbstractJobStatusReplicatorService {

	public UploadsJobStatusReplicatorService(GeboApplicationArchitecture architecture,
			IGReplicationsMap replicationsMap, IMessageEnvelopeFactory envelopeFactory, IGRuntimeBinder runtimeBinder) {
		super(GStandardModulesConstraints.UPLOADS_MODULE, architecture, replicationsMap, envelopeFactory, runtimeBinder);
	}
}
