...
/**
 * The Integration microservice's own instance of the job-launch receiver,
...
public class IntegrationJobLaunchManager extends AbstractJobLaunchManager {

	public IntegrationJobLaunchManager(IGGeboIngestionJobQueueService jobLauncherController,
		...
		super(jobLauncherController, persistentObjectManager, broker, jobStatusRepositoy,
				GStandardModulesConstraints.INTEGRATION_MODULE);
	}
}
