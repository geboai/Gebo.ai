...
/** Arguments the LLM fills when calling the Brave web-search tool. */
@Data
public class BraveSearchRequest {
	private String query = null;
	private String language = null;
	private Integer topN = null;
	/** Recency: "pd", "pw", "pm" or "py". Optional. */
	private String freshness = null;
	/** 2-letter country code. Optional. */
	private String country = null;
	/** "off", "moderate" or "strict". Optional. */
