...
/**
 * The Userspace microservice's own instance of the job-launch receiver,
...
public class UserspaceJobLaunchManager extends AbstractJobLaunchManager {

	public UserspaceJobLaunchManager(IGGeboIngestionJobQueueService jobLauncherController,
		...
		super(jobLauncherController, persistentObjectManager, broker, jobStatusRepositoy,
				GStandardModulesConstraints.USERSPACE_MODULE);
	}
}
