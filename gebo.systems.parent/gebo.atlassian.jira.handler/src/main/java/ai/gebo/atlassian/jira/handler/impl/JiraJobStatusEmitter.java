...
/**
 * The Jira microservice's own instance of the job-status broadcaster,
...
public class JiraJobStatusEmitter extends AbstractJobStatusEmitter {

	public JiraJobStatusEmitter(IGRuntimeBinder runtimeBinder, IMessageEnvelopeFactory envelopeFactory) {
		super(runtimeBinder, envelopeFactory, GStandardModulesConstraints.ATLASSIAN_JIRA_MODULE);
	}
}
