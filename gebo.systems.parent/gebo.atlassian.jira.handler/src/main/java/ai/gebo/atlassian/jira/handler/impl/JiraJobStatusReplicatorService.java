...
/**
 * The Jira microservice's own instance of the job-status replicator,
...
public class JiraJobStatusReplicatorService extends AbstractJobStatusReplicatorService {

	public JiraJobStatusReplicatorService(GeboApplicationArchitecture architecture,
			IGReplicationsMap replicationsMap, IMessageEnvelopeFactory envelopeFactory, IGRuntimeBinder runtimeBinder) {
		super(GStandardModulesConstraints.ATLASSIAN_JIRA_MODULE, architecture, replicationsMap, envelopeFactory, runtimeBinder);
	}
}
