...
/**
 * The McpClient microservice's own instance of the job-launch receiver,
...
public class McpClientJobLaunchManager extends AbstractJobLaunchManager {

	public McpClientJobLaunchManager(IGGeboIngestionJobQueueService jobLauncherController,
		...
		super(jobLauncherController, persistentObjectManager, broker, jobStatusRepositoy,
				GStandardModulesConstraints.MCP_CLIENT_MODULE);
	}
}
