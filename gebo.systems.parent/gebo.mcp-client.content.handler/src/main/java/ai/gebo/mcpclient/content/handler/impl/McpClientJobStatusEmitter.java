...
/**
 * The McpClient microservice's own instance of the job-status broadcaster,
...
public class McpClientJobStatusEmitter extends AbstractJobStatusEmitter {

	public McpClientJobStatusEmitter(IGRuntimeBinder runtimeBinder, IMessageEnvelopeFactory envelopeFactory) {
		super(runtimeBinder, envelopeFactory, GStandardModulesConstraints.MCP_CLIENT_MODULE);
	}
}
