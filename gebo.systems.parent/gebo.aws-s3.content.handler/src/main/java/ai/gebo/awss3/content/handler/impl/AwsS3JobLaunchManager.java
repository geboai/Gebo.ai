...
/**
 * The AwsS3 microservice's own instance of the job-launch receiver,
...
public class AwsS3JobLaunchManager extends AbstractJobLaunchManager {

	public AwsS3JobLaunchManager(IGGeboIngestionJobQueueService jobLauncherController,
		...
		super(jobLauncherController, persistentObjectManager, broker, jobStatusRepositoy,
				GStandardModulesConstraints.AWS_S3_MODULE);
	}
}
