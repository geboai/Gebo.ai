...
/**
 * The AwsS3 microservice's own instance of the job-status replicator,
...
public class AwsS3JobStatusReplicatorService extends AbstractJobStatusReplicatorService {

	public AwsS3JobStatusReplicatorService(GeboApplicationArchitecture architecture,
			IGReplicationsMap replicationsMap, IMessageEnvelopeFactory envelopeFactory, IGRuntimeBinder runtimeBinder) {
		super(GStandardModulesConstraints.AWS_S3_MODULE, architecture, replicationsMap, envelopeFactory, runtimeBinder);
	}
}
