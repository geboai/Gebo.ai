...
package ai.gebo.sharepoint.handler.controller;
...
import ai.gebo.sharepoint.handler.impl.GMicrosoftGraphSearchService;
...
/**
 * REST surface for the SharePoint (Microsoft Graph) native search service, exposed
 * to USERS and ADMIN. Backed by {@link GMicrosoftGraphSearchService}; mirrored by
 * the topology-aware {@code SharePointSearchServiceRestClient} on brain.
 */
@RestController
@PreAuthorize("hasAnyRole('ADMIN','USER')")
@RequestMapping("api/users/SharePointSearchServiceController")
public class SharePointSearchServiceController
		extends BaseNativeSearchController<MicrosoftResultsExtractionData, SharePointSearchFilter> {

	public SharePointSearchServiceController(GMicrosoftGraphSearchService sharePointSearchService) {
		super(sharePointSearchService);
	}
