...
/**
 * The Sharepoint microservice's own instance of the job-status replicator,
 * registered under Sharepoint's own already-owned
 * {@link GStandardModulesConstraints#SHAREPOINT_MODULE}, so it is uniquely
...
public class SharepointJobStatusReplicatorService extends AbstractJobStatusReplicatorService {

	public SharepointJobStatusReplicatorService(GeboApplicationArchitecture architecture,
			IGReplicationsMap replicationsMap, IMessageEnvelopeFactory envelopeFactory, IGRuntimeBinder runtimeBinder) {
		super(GStandardModulesConstraints.SHAREPOINT_MODULE, architecture, replicationsMap, envelopeFactory, runtimeBinder);
	}
}
