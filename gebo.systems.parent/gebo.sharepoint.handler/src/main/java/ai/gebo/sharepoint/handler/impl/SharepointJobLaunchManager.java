...
/**
 * The Sharepoint microservice's own instance of the job-launch receiver,
...
public class SharepointJobLaunchManager extends AbstractJobLaunchManager {

	public SharepointJobLaunchManager(IGGeboIngestionJobQueueService jobLauncherController,
		...
		super(jobLauncherController, persistentObjectManager, broker, jobStatusRepositoy,
				GStandardModulesConstraints.SHAREPOINT_MODULE);
	}
}
