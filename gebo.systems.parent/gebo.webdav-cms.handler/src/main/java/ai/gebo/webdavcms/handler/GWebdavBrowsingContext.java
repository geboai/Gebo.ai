...
/**
 * A context implementation for browsing webdav resources through the virtual
 * file system abstraction layer.
 */
public class GWebdavBrowsingContext implements IGVirtualFileSystemContext {
	/** The system code identifier for the webdav remote system instance */
	...
	/**
	 * Factory method that creates and initializes a SharepointBrowsingContext with
	 * the given system code.
	 * 
	 * @param systemCode The system code to initialize the context with
	 * @return A new SharepointBrowsingContext instance
	 */
	public static GWebdavBrowsingContext of(String systemCode) {
		GWebdavBrowsingContext context = new GWebdavBrowsingContext();
