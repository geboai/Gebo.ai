...
/**
 * Registers the default Git content handler as a bean that a downstream
 * module can override by supplying its own bean of the corresponding
 * interface.
 */
@Configuration
public class GGitDefaultBeansConfig {

	@Bean
	@ConditionalOnMissingBean(IGBaseGitContentManagementSystemHandler.class)
	public IGBaseGitContentManagementSystemHandler gitContentManagementHandler(
		...
		return new GDefaultGitContentManagementSystemHandler(buildSystemHandlerRepository, contentHandler,
				configurationsDao, endpointDao, secretsAccessService, localFolderDiscoveryService,
