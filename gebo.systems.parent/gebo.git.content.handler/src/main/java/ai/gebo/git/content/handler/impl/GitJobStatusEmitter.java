...
/**
 * The Git microservice's own instance of the job-status broadcaster,
...
public class GitJobStatusEmitter extends AbstractJobStatusEmitter {

	public GitJobStatusEmitter(IGRuntimeBinder runtimeBinder, IMessageEnvelopeFactory envelopeFactory) {
		super(runtimeBinder, envelopeFactory, GStandardModulesConstraints.GIT_MODULE);
	}
}
