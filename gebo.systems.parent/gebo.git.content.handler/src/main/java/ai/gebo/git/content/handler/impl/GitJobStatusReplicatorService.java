...
/**
 * The Git microservice's own instance of the job-status replicator,
...
public class GitJobStatusReplicatorService extends AbstractJobStatusReplicatorService {

	public GitJobStatusReplicatorService(GeboApplicationArchitecture architecture,
			IGReplicationsMap replicationsMap, IMessageEnvelopeFactory envelopeFactory, IGRuntimeBinder runtimeBinder) {
		super(GStandardModulesConstraints.GIT_MODULE, architecture, replicationsMap, envelopeFactory, runtimeBinder);
	}
}
