...
/**
 * The Confluence microservice's own instance of the job-launch receiver,
...
public class ConfluenceJobLaunchManager extends AbstractJobLaunchManager {

	public ConfluenceJobLaunchManager(IGGeboIngestionJobQueueService jobLauncherController,
		...
		super(jobLauncherController, persistentObjectManager, broker, jobStatusRepositoy,
				GStandardModulesConstraints.ATLASSIAN_CONFLUENCE_MODULE);
	}
}
