...
/**
 * The Confluence microservice's own instance of the job-status replicator,
 * registered under Confluence's own already-owned
 * {@link GStandardModulesConstraints#ATLASSIAN_CONFLUENCE_MODULE}, so it is uniquely
...
public class ConfluenceJobStatusReplicatorService extends AbstractJobStatusReplicatorService {

	public ConfluenceJobStatusReplicatorService(GeboApplicationArchitecture architecture,
			IGReplicationsMap replicationsMap, IMessageEnvelopeFactory envelopeFactory, IGRuntimeBinder runtimeBinder) {
		super(GStandardModulesConstraints.ATLASSIAN_CONFLUENCE_MODULE, architecture, replicationsMap, envelopeFactory, runtimeBinder);
	}
}
