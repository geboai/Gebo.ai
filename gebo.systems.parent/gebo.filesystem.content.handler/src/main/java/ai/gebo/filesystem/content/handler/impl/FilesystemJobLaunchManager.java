...
/**
 * The Filesystem microservice's own instance of the job-launch receiver,
...
public class FilesystemJobLaunchManager extends AbstractJobLaunchManager {

	public FilesystemJobLaunchManager(IGGeboIngestionJobQueueService jobLauncherController,
		...
		super(jobLauncherController, persistentObjectManager, broker, jobStatusRepositoy,
				GStandardModulesConstraints.SHARED_FILESYSTEM_MODULE);
	}
}
