...
/**
 * The GoogleDrive microservice's own instance of the job-launch receiver,
...
public class GoogleDriveJobLaunchManager extends AbstractJobLaunchManager {

	public GoogleDriveJobLaunchManager(IGGeboIngestionJobQueueService jobLauncherController,
		...
		super(jobLauncherController, persistentObjectManager, broker, jobStatusRepositoy,
				GStandardModulesConstraints.GOOGLE_DRIVE_MODULE);
	}
}
