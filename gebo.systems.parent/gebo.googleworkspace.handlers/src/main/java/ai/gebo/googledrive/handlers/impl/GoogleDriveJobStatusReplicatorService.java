...
/**
 * The GoogleDrive microservice's own instance of the job-status replicator,
 * registered under GoogleDrive's own already-owned
 * {@link GStandardModulesConstraints#GOOGLE_DRIVE_MODULE}, so it is uniquely
...
public class GoogleDriveJobStatusReplicatorService extends AbstractJobStatusReplicatorService {

	public GoogleDriveJobStatusReplicatorService(GeboApplicationArchitecture architecture,
			IGReplicationsMap replicationsMap, IMessageEnvelopeFactory envelopeFactory, IGRuntimeBinder runtimeBinder) {
		super(GStandardModulesConstraints.GOOGLE_DRIVE_MODULE, architecture, replicationsMap, envelopeFactory, runtimeBinder);
	}
}
