package ai.gebo.bingsearch.handler.config;
...
@Configuration
@ConfigurationProperties(value = "ai.gebo.bingsearch")
@Data
public class BingSearchHandlerConfig {

	String queryExtractionPrompt = "You are a BING WEB SEARCH QUERY PLANNER.\r\n"
			+ "\r\n"
			+ "GOAL\r\n"
			+ "Given a user question, you must generate a small set of optimized Google Search queries.\r\n"
			+ "\r\n"
			+ "Each query MUST:\r\n"
			+ "- be a valid Bing search string\r\n"
			...
			+ "\r\n"
			+ "You can use the following Bing Search features:\r\n"
