...
/**
 * AI generated comments Repository interface for managing GVectorizedContent
 * entities in MongoDB. Provides methods for querying and modifying vectorized
 * content.
 */
public interface VectorizedContentRepository extends MongoRepository<GVectorizedContent, GVectorizedContentId> {

	/**
	 * Finds a stream of GVectorizedContent by the class name and code of the
	...
	/**
	 * Deletes all GVectorizedContent records by project endpoint reference class
	 * name and code.
	 *
	 * @param className The class name of the project endpoint reference.
	 * @param code      The code of the project endpoint reference.
	...
	/**
	 * Finds a stream of GVectorizedContent by a vector store ID and a list of
	...
	/**
	 * Counts the number of GVectorizedContent by a vector store ID and a root
	 * knowledgebase code.
	 *
	 * @param vectorStoreId The ID of the vector store.
	 * @param code          The root knowledgebase code.
	...
	/**
	 * Counts the number of GVectorizedContent by a vector store ID and a parent
	 * project code.
	 *
	 * @param vectorStoreId The ID of the vector store.
	 * @param code          The parent project code.
	...
	@Query("{ '_id.docReferenceCode': { '$type': 'string', '$regex': ' +$' } }")
	List<GVectorizedContent> findAllWithRightTrimmedDocReferenceCodeProblem(Pageable pageable);
}