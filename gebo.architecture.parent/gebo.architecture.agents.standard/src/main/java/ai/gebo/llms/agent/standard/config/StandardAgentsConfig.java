...
import ai.gebo.llms.agent.standard.InternalKnowledgeBaseSearchNetworkAgentService;
...
public class StandardAgentsConfig {
	...
	public StandardAgentsConfig(ISearchServiceRepositoryPattern searchServicesRepositoryPattern,
