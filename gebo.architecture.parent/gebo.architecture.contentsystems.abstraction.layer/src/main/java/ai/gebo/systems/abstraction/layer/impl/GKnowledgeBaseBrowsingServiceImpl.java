...
public class GKnowledgeBaseBrowsingServiceImpl implements IGKnowledgeBaseBrowsingService {
	 ...
	 * @throws VirtualFilesystemBrowsingException if any issue occurs during the
	 *                                            operation.
	 */
	@Override
	...
	/**
	 * Browse the project identified by the given code and return its sub-projects
	 * and endpoints.
	 *
	...
	/**
	 * TODO: Provide an implementation for getting the parent of a given filesystem
	 * reference.
	 *
	 ...
	 * @return KnowledgeBaseBrowsingServiceSelectedReferences containing the
	 *         references.
	 * @throws VirtualFilesystemBrowsingException if any issue occurs during the
	 *                                            operation.
	...
	/**
	 * TODO: Provide an implementation for getting a list of filesystem reference
	 * representations.
	 *
	...
	/**
	 * Converts a list of virtual filesystem objects into a collection of filesystem
	 * references.
	 *
