...
public class GraphEventAliasObjectDao extends
	...
	@Transactional
	@Override
	public GraphEventAliasObject findOrCreateMatching(EventAliasObject alias, Map<String, Object> cache,
			boolean insertIfNotFound) {
		GraphEventObject referenceObject = eventDao.findOrCreateMatching(alias.getReferenceObject(), cache,
				insertIfNotFound);
		GraphEventObject aliasObject = eventDao.findOrCreateMatching(alias.getAliasObject(), cache, insertIfNotFound);
