 ...
 * The MimeTypes class provides constants for various common MIME types and
 * methods for registering and looking up MIME types and their corresponding file
 * extensions.
 */
public class MimeTypes {
    // Constants for various MIME types
    ...
    // HashMap to store MIME type to file extension mappings
    private static HashMap<String, String> mimeTypeMapping;
    // HashMap to store file extension to MIME type mappings
    private static HashMap<String, String> extMapping;

    // Static block to initialize mimeTypeMapping
    static {
        mimeTypeMapping = new HashMap<String, String>(200) {
            // Method to add MIME type mapping with duplicate check
    ...
    // Static block to initialize extMapping
    static {
        extMapping = new HashMap<String, String>(200) {
            // Method to add extension mapping with duplicate check
            private void put1(String key, String value) {
                if (put(key, value) != null) {
     ...
     * @return the associated file extension as a String, or null
     */
