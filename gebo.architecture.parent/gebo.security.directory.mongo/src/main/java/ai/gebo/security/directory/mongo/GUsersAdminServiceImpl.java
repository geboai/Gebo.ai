...
public class GUsersAdminServiceImpl implements IGUsersAdminService {
	 ...
	 * {@code RestUsersAdminService} calls it. Audited here (rather than at
	 * {@code insertUser}, which already carries its own admin-UI audit trail at
	 * {@code UsersAdminController}) so the auto-provisioning decision is traceable
	 * regardless of which service/path triggered it, without double-logging
