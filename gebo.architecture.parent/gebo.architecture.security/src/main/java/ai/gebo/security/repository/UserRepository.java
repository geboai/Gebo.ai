 ...
 * UserRepository interface for accessing User data in a MongoDB database.
 * Extends MongoRepository to provide basic CRUD operations on User collection.
 */
@Repository
public interface UserRepository extends MongoRepository<User, String> {
	
	/**
	 * Interface representing a subset of User information.
