...
/**
 * This class represents a user entity in the security model.
 * It includes user details such as name, username, password, provider, roles, etc.
 * Each user is uniquely identified by their username in the MongoDB document.
 * 
...
public class User {
     ...
     * Note: This field is ignored during JSON serialization.
     * 
    ...
    /**
     * Gets the provider ID associated with the user.
     * 
    ...
    /**
     * Sets the provider ID for the user.
     * 
    ...
    /**
     * This inner class represents a user's granted authority.
    ...
    public static class GAuth implements GrantedAuthority {
        ...
        /**
         * Converts a list of strings to a list of GAuth objects.
         * Each string in the input list is converted into a GAuth object.
         * 
    ...
    /**
     * Assigns values from an EditableUser to this User object.
     * Ensures the username is consistent between the two.
     * 
    ...
    public void assignValues(EditableUser u) {
        if (this.username == null)
            ...
            if (this.username != null
                    && ((u.getUsername() == null || u.getUsername().trim().length() == 0) || (!u.getUsername().equals(username)))) {
