...
/**
 * Service implementation for security-related functionalities.
...
public class GSecurityServiceImpl implements IGSecurityService {
    ...
    public UserInfos getCurrentUser() {
        ...
        if (context == null || context.getAuthentication() == null)
            throw new RuntimeException("No security context set");
     ...
     * @param adminCanDoAll  Whether admins can access all objects regardless of other settings.
    ...
    /**
     * Filters a collection of objects, returning only those accessible by the current user.
     *
     * @param objects        The collection of objects to filter.
     * @param adminCanDoAll  Whether admins can access all objects.
     * @param <T>            The type of objects in the collection, must implement IGObjectWithSecurity.
    ...
    /**
     * Implementation of IGUserSecurityProfile that holds security details of the user.
     */
