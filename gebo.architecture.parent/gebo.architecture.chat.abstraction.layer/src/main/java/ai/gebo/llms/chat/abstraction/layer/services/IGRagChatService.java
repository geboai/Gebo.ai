 ...
 *
 * Interface representing a RagChat service providing functionalities related to
 * chat profiles. Extends the IGGenericalChatService to inherit basic
...
public interface IGRagChatService extends IGGenericalChatService {
	...
	/**
	 * Retrieves metadata information for a specific chat profile model based on the
	 * chat profile code.
	 *
	 * @param chatProfileCode Unique code identifying the chat profile.
	 * @return GBaseChatModelChoice representing metadata information for the model
	 *         associated with the chat profile.
	 */
	 ...
	 *
	 * @param modelCode Code identifying the model whose provider capabilities need
	 *                  to be retrieved.
	 * @return ModelProviderCapabilities describing the capabilities of the model
	 *         provider.
	...
	/**
	 * Retrieves user information for a chat model based on a given chat profile
	 * code.
	 *
	 * @param chatProfileCode Code identifying the chat profile.
	 * @return GeboChatUserInfo containing user information related to the specific
	 *         chat model.
	 * @throws GeboPersistenceException if there is an issue with data persistence.
	 * @throws LLMConfigException       if there is an issue with the model
	 *                                  configuration.
	 */
