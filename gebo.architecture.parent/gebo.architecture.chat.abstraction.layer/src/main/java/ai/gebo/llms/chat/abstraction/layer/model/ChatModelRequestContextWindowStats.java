 ...
 * 
 * The ChatModelRequestContextWindowStats class holds statistics regarding the tokenized context window of a chat model request.
 * It provides metrics for analyzing how tokens are distributed among different components of the request.
 */
public class ChatModelRequestContextWindowStats {
    ...
    /** Number of tokens used for any documents involved in the context window. */
    public double documentsNTokens = 0.0;
    
    /** Percentage of the context window's available tokens relative to its total length. */
    public double availableSharePerc = 0.0;
    
    /** Percentage of the context window's tokens allocated for history relative to its total length. */
    public double historySharePerc = 0.0;
    
    /** Percentage of the context window's tokens allocated for documents relative to its total length. */
