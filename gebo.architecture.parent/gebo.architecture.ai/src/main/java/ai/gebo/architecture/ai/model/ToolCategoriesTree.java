...
/**
 * Gebo.ai comment agent This class represents a tree structure that contains
 * tools categorized under a specific category. It holds a reference to a
 * category and a list of tool references associated with that category.
 */
public final class ToolCategoriesTree implements IJsonClonable<ToolCategoriesTree> {
	...
	public ToolCategoriesTree unmutableClone() {
		ToolCategoriesTree clone = jsonClone();
		clone.setToolsReference(List.copyOf(clone.toolsReference));
		return clone;
	}
}