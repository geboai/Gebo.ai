 ...
 * 
 * @see IGExternalMessageReceiverProviderSource
 * @see IGImplementationsRepositoryPattern
 */
public interface IGExternalMessageReceiverProviderSourceRepositoryPattern
        extends IGImplementationsRepositoryPattern<IGExternalMessageReceiverProviderSource> {
