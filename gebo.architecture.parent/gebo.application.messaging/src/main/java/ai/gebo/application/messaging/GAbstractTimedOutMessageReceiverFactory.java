 ...
 * Abstract factory class for creating message receivers with a timeout mechanism.
 */
public abstract class GAbstractTimedOutMessageReceiverFactory extends GAbstractMessageReceiverFactory
		implements IGTimedOutMessageReceiverFactory {
    ...
    /**
     * Receiver class that aggregates messages in batches and supports nested receivers.
     */
