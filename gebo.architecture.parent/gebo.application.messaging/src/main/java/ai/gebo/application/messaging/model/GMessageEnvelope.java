 ...
 * Represents a generic message envelope for the messaging system.
 * 
 * @param <PayloadType> The type of the payload contained in the message envelope.
 */
@Document
public class GMessageEnvelope<PayloadType extends IGMessagePayloadType> {
     ...
     * @return A new instance of GMessageEnvelope with the same properties as the provided one.
     */
     ...
     */
    public static <T extends IGMessagePayloadType> GMessageEnvelope<T> newMessageFrom(IGMessageEmitter system, T payload) {
        GMessageEnvelope<T> dest = new GMessageEnvelope<T>();
     ...
     * @return A new instance of GMessageEnvelope.
     */
    public static <T extends IGMessagePayloadType> GMessageEnvelope<T> newMessageFrom(IGMessageEmitter system, T payload, String user) {
        GMessageEnvelope<T> dest = new GMessageEnvelope<T>();
        dest.setUserId(user);
        dest.sourceComponent = system.getMessagingSystemId();
        dest.sourceModule = system.getMessagingModuleId();
