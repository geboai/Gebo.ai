 ...
 * 
 * Implementation of the IGMongoRepositoriesImplementationRepositoryPattern
 * interface. This class extends the GAbstractImplementationsRepositoryPattern
 * and provides methods to interact with MongoDB repositories.
 */
@Service
public class GMongoRepositoriesImplementationRepositoryPatternImpl
	...
	public List<IGBaseMongoDBRepository> findByAssignableBy(Class<? extends GBaseObject> referencedType) {
		...
		return this.findImplementations(x -> referencedType.isAssignableFrom(x.getManagedType()));
	}
