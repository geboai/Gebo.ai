...
/**
 * Entry point of the Gebo.ai <b>AWS S3</b> content-handler microservice.
 *
 * <p>
 ...
 * client) and hosts the {@code gebo.aws-s3.content.handler} content system. The
...
public class AwsS3Application {
	...
	private static final Logger LOG = LoggerFactory.getLogger(AwsS3Application.class);

	public static void main(String[] args) {
		LOG.info("STARTING THE GEBO.AI AWS S3 CONTENT MICROSERVICE");
		...
		LOG.info("GEBO.AI AWS S3 CONTENT MICROSERVICE FINISHED");
	}
}
