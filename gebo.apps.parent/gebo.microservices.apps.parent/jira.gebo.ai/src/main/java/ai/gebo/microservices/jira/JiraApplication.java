...
/**
 * Entry point of the Gebo.ai <b>Jira</b> content-handler microservice.
 *
 * <p>
 ...
 * client) and hosts the {@code gebo.atlassian.jira.handler} content system. The
...
public class JiraApplication {
	...
	public static void main(String[] args) {
		LOG.info("STARTING THE GEBO.AI JIRA CONTENT MICROSERVICE");
		...
		LOG.info("GEBO.AI JIRA CONTENT MICROSERVICE FINISHED");
	}
}
