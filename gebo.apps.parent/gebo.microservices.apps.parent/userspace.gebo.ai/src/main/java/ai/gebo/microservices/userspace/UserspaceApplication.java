...
/**
 * Entry point of the Gebo.ai <b>userspace</b> content-handler microservice.
 *
 * <p>
 ...
 * client) and hosts the {@code gebo.userspace.handler} content system. The whole
...
public class UserspaceApplication {
	...
	private static final Logger LOG = LoggerFactory.getLogger(UserspaceApplication.class);

	public static void main(String[] args) {
		LOG.info("STARTING THE GEBO.AI USERSPACE CONTENT MICROSERVICE");
		...
		LOG.info("GEBO.AI USERSPACE CONTENT MICROSERVICE FINISHED");
	}
}
