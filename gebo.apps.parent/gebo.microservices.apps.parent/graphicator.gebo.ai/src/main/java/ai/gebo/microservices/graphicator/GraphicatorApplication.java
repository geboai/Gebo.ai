...
/**
 * Entry point of the Gebo.ai <b>graphicator</b> LLMs microservice (the renamed
 * graphsearch service, host of the knowledge-graph module).
 *
 * <p>
 * Built on the {@code gebo.microservices.llms.starter} stack: it hosts the LLM
 * abstraction layer, participates in the models-replication Hazelcast cache (its
 * {@code spring.application.name} {@code graphicator.gebo.ai} is in the shared
...
public class GraphicatorApplication {

	private static final String ERROR_MESSAGE = "The java property or environment variable GEBO_HOME must be set";
	private static final Logger LOG = LoggerFactory.getLogger(GraphicatorApplication.class);

	public static void main(String[] args) {
		LOG.info("STARTING THE GEBO.AI GRAPHICATOR MICROSERVICE");
		...
		SpringApplication.run(GraphicatorApplication.class, args);
		LOG.info("GEBO.AI GRAPHICATOR MICROSERVICE FINISHED");
	}
}
