...
/**
 * Entry point of the Gebo.ai <b>Google Drive</b> content-handler microservice.
 *
 * <p>
 ...
 * client) and hosts the {@code gebo.googleworkspace.handlers} content system. The
...
public class GoogleDriveApplication {
	...
	private static final Logger LOG = LoggerFactory.getLogger(GoogleDriveApplication.class);

	public static void main(String[] args) {
		LOG.info("STARTING THE GEBO.AI GOOGLE DRIVE CONTENT MICROSERVICE");
		...
		LOG.info("GEBO.AI GOOGLE DRIVE CONTENT MICROSERVICE FINISHED");
	}
}
