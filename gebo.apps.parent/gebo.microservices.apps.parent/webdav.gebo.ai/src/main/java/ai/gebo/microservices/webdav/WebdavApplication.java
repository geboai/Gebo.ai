...
/**
 * Entry point of the Gebo.ai <b>WebDAV</b> content-handler microservice.
 *
 * <p>
 ...
 * client) and hosts the {@code gebo.webdav-cms.handler} content system. The whole
 * {@code ai.gebo} component tree is scanned so the handler beans, controllers and
 * Mongo repositories are wired.
 * </p>
 */
@SpringBootApplication
// basePackages is widened to "ai.gebo" (webdav's own production beans live
...
public class WebdavApplication {
	...
	private static final Logger LOG = LoggerFactory.getLogger(WebdavApplication.class);

	public static void main(String[] args) {
		LOG.info("STARTING THE GEBO.AI WEBDAV CONTENT MICROSERVICE");
		...
		LOG.info("GEBO.AI WEBDAV CONTENT MICROSERVICE FINISHED");
	}
}
