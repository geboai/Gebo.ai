...
/**
 * Entry point of the Gebo.ai <b>SharePoint</b> content-handler microservice.
 *
 * <p>
 ...
 * client) and hosts the {@code gebo.sharepoint.handler} content system. The whole
...
public class SharepointApplication {
	...
	private static final Logger LOG = LoggerFactory.getLogger(SharepointApplication.class);

	public static void main(String[] args) {
		LOG.info("STARTING THE GEBO.AI SHAREPOINT CONTENT MICROSERVICE");
		...
		LOG.info("GEBO.AI SHAREPOINT CONTENT MICROSERVICE FINISHED");
	}
}
