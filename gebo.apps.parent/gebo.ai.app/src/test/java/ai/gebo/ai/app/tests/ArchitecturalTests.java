...
/**
 * Class representing a series of architectural tests for testing content reading and embedding services.
 * This class extends AbstractBaseTestLLmsIntegrationTests.
 * 
...
public class ArchitecturalTests extends AbstractBaseTestLLmsIntegrationTests {
     ...
     * @throws GeboJobServiceException if a job service error occurs
     * @throws GeboPersistenceException if a persistence error occurs
     * @throws GeboContentHandlerSystemException if a content handler system error occurs
    ...
    /**
     * Test integration involving reading and embedding contents with a single erroneous file.
     * 
     * @throws InstantiationException if instantiation of a class fails
     * @throws IllegalAccessException if access to a class or its methods fails
     * @throws GeboJobServiceException if a job service error occurs
     ...
     */
    @Test
    public void runContentsWithErrorFile() throws InstantiationException, IllegalAccessException, GeboJobServiceException, GeboPersistenceException, GeboContentHandlerSystemException, IOException, InterruptedException {
        List<String> files = ALL_DATA_FILES;
        runContentsIngestionTest(files,
                "Running contents reading & embedding with a single error file", files.size() - 1);
    }
}