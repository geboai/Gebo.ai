...
/**
 * Supplies the bearer token the secrets client forwards to the security
 * microservice, so that heimdall sees the <b>original caller's</b> identity
 * rather than an anonymous service-to-service call.
 *
 * <p>
 ...
 */
public interface IGeboSecretsCallerTokenPropagator {
