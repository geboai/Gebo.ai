...
/**
 * Topology-aware REST client for the Confluence native search service hosted on
 * confluence.gebo.ai. Implements
 * {@code INativeSearchService<ConfluenceResultsExtractionData, ConfluenceContentSearchFilter>}.
 */
public class ConfluenceSearchServiceRestClient
		extends AbstractNativeSearchServiceRestClient<ConfluenceResultsExtractionData, ConfluenceContentSearchFilter> {
